...
UserDisplayContext userDisplayContext = new UserDisplayContext(request, initDisplayContext);
      ...
      _jspx_th_liferay$1ui_error_0.setException( NoSuchOrganizationException.class );
      _jspx_th_liferay$1ui_error_0.setMessage("the-organization-could-not-be-found");
      ...
      _jspx_th_liferay$1ui_error_1.setException( NoSuchRoleException.class );
      _jspx_th_liferay$1ui_error_1.setMessage("the-role-could-not-be-found");
      ...
      _jspx_th_liferay$1ui_error_2.setMessage("the-user-could-not-be-found");
