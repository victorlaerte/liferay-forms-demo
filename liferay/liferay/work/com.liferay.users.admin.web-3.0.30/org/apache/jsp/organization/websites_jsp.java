...
public final class websites_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/common/websites.jsp");
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody.release();
...
if (Validator.isNotNull(websitesIndexesParam)) {
	...
	if (websitesIndexes == null) {
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("websites");
      ...
      _jspx_th_liferay$1ui_error_0.setKey( NoSuchListTypeException.class.getName() + className + ListTypeConstants.WEBSITE );
      ...
      _jspx_th_liferay$1ui_error_1.setException( WebsiteURLException.class );
      _jspx_th_liferay$1ui_error_1.setMessage("please-enter-a-valid-url");
      ...
      _jspx_th_aui_fieldset_0.setId( renderResponse.getNamespace() + "websites" );
	...
	for (int i = 0; i < websitesIndexes.length; i++) {
        ...
        _jspx_th_aui_model$1context_0.setBean( website );
        _jspx_th_aui_model$1context_0.setModel( Website.class );
        ...
        _jspx_th_aui_input_0.setName( "websiteId" + websitesIndex );
        _jspx_th_aui_input_0.setType("hidden");
        _jspx_th_aui_input_0.setValue( website.getWebsiteId() );
        ...
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_1 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_1.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_1.setCssClass("url-field");
        _jspx_th_aui_input_1.setFieldParam( "websiteUrl" + websitesIndex );
        _jspx_th_aui_input_1.setId( "websiteUrl" + websitesIndex );
        _jspx_th_aui_input_1.setInlineField( true );
        _jspx_th_aui_input_1.setName("url");
        int _jspx_eval_aui_input_1 = _jspx_th_aui_input_1.doStartTag();
        if (_jspx_th_aui_input_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody.reuse(_jspx_th_aui_input_1);
          return;
        }
        _jspx_tagPool_aui_input_name_inlineField_id_fieldParam_cssClass_nobody.reuse(_jspx_th_aui_input_1);
        out.write("\n\t\t\t</div>\n\n\t\t\t<div class=\"form-group-item\">\n\t\t\t\t");
        ...
        _jspx_th_aui_select_0.setListType( className + ListTypeConstants.WEBSITE );
        _jspx_th_aui_select_0.setName( "websiteTypeId" + websitesIndex );
        ...
        _jspx_th_aui_input_2.setChecked( website.isPrimary() );
        _jspx_th_aui_input_2.setCssClass("primary-ctrl");
        _jspx_th_aui_input_2.setId( "websitePrimary" + websitesIndex );
        _jspx_th_aui_input_2.setInlineField( true );
        _jspx_th_aui_input_2.setLabel("primary");
        _jspx_th_aui_input_2.setName("websitePrimary");
        _jspx_th_aui_input_2.setType("radio");
        _jspx_th_aui_input_2.setValue( websitesIndex );
        ...
        _jspx_th_aui_input_3.setName("websitesIndexes");
        _jspx_th_aui_input_3.setType("hidden");
        _jspx_th_aui_input_3.setValue( StringUtil.merge(websitesIndexes) );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("url-and-type-are-required-fields.-websites-must-start-with-http-or-https");
