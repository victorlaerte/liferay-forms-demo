...
Format timeFormat = FastDateFormatFactoryUtil.getSimpleDateFormat("HH:mm", locale);
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("services");
      ...
      _jspx_th_liferay$1ui_error_0.setKey( NoSuchListTypeException.class.getName() + Organization.class.getName() + ListTypeConstants.ORGANIZATION_SERVICE );
      ...
      _jspx_th_aui_fieldset_0.setId( renderResponse.getNamespace() + "services" );
	...
	for (int i = 0; i < orgLaborsIndexes.length; i++) {
        ...
        _jspx_th_aui_model$1context_0.setBean( orgLabor );
        _jspx_th_aui_model$1context_0.setModel( OrgLabor.class );
        ...
        _jspx_th_aui_input_0.setName( "orgLaborId" + orgLaborsIndex );
        ...
        out.write("\n\n\t\t\t\t");
        //  aui:select
        com.liferay.taglib.aui.SelectTag _jspx_th_aui_select_0 = (com.liferay.taglib.aui.SelectTag) _jspx_tagPool_aui_select_name_listType_label_nobody.get(com.liferay.taglib.aui.SelectTag.class);
        ...
        _jspx_th_aui_select_0.setListType( ListTypeConstants.ORGANIZATION_SERVICE );
        _jspx_th_aui_select_0.setName( "orgLaborTypeId" + orgLaborsIndex );
        int _jspx_eval_aui_select_0 = _jspx_th_aui_select_0.doStartTag();
        if (_jspx_th_aui_select_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_select_name_listType_label_nobody.reuse(_jspx_th_aui_select_0);
          return;
        }
        _jspx_tagPool_aui_select_name_listType_label_nobody.reuse(_jspx_th_aui_select_0);
        out.write("\n\n\t\t\t\t");
        ...
        _jspx_th_aui_select_1.setLabel("Open");
        _jspx_th_aui_select_1.setName( paramPrefix + "Open" + orgLaborsIndex );
        ...
        if (_jspx_eval_aui_select_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n\t\t\t\t\t\t\t");
            if (_jspx_meth_aui_option_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_select_1, _jspx_page_context))
              return;
            out.write("\n\n\t\t\t\t\t\t\t");
            ...
            _jspx_th_aui_option_1.setLabel( timeOfDayDisplay );
            _jspx_th_aui_option_1.setSelected( open == timeOfDayValue );
            _jspx_th_aui_option_1.setValue( timeOfDayValue );
        ...
        _jspx_th_aui_select_2.setLabel("close");
        _jspx_th_aui_select_2.setName( paramPrefix + "Close" + orgLaborsIndex );
        ...
        if (_jspx_eval_aui_select_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n\t\t\t\t\t\t\t");
            if (_jspx_meth_aui_option_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_select_2, _jspx_page_context))
              return;
            out.write("\n\n\t\t\t\t\t\t\t");
            ...
            _jspx_th_aui_option_3.setLabel( timeOfDayDisplay );
            _jspx_th_aui_option_3.setSelected( close == timeOfDayValue );
            _jspx_th_aui_option_3.setValue( timeOfDayValue );
        ...
        _jspx_th_aui_input_1.setName("orgLaborsIndexes");
        _jspx_th_aui_input_1.setType("hidden");
        _jspx_th_aui_input_1.setValue( StringUtil.merge(orgLaborsIndexes) );
  ...
  private boolean _jspx_meth_aui_option_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_1, PageContext _jspx_page_context)
          throws Throwable {
  ...
  private boolean _jspx_meth_aui_option_2(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_select_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:option
    ...
    _jspx_th_aui_option_2.setValue(new String("-1"));
