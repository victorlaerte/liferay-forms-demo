...
public final class add_005fsite_005fnavigation_005fmenu_005fitem_005fredirect_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Portlet selPortlet = PortletLocalServiceUtil.getPortletById(company.getCompanyId(), portletResource);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\tLiferay.fire(\n\t\t'closeWindow',\n\t\t{\n\t\t\tid: '_");
          out.print( HtmlUtil.escapeJS(selPortlet.getPortletId()) );
          out.write("_addMenuItem',\n\t\t\tportletAjaxable: ");
          out.print( selPortlet.isAjaxable() );
          out.write(",\n\t\t\trefresh: '");
          out.print( HtmlUtil.escapeJS(selPortlet.getPortletId()) );
          out.write("'\n\t\t}\n\t);\n");
