package org.apache.jsp.remote_005foptions;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/remote_options/init.jsp");
...
UnicodeProperties liveGroupTypeSettings = liveGroup.getTypeSettingsProperties();
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_0 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.get(com.liferay.taglib.aui.InputTag.class);
        ...
        _jspx_th_aui_input_0.setLabel("remote-host-ip");
        _jspx_th_aui_input_0.setName("remoteAddress");
        _jspx_th_aui_input_0.setDynamicAttribute(null, "size", new String("20"));
        _jspx_th_aui_input_0.setType("text");
        _jspx_th_aui_input_0.setValue( MapUtil.getString(settingsMap, "remoteAddress", liveGroupTypeSettings.getProperty("remoteAddress")) );
        int _jspx_eval_aui_input_0 = _jspx_th_aui_input_0.doStartTag();
        if (_jspx_th_aui_input_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_0);
          return;
        }
        _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_0);
        out.write("\n\n\t\t");
        ...
        _jspx_th_aui_input_1.setLabel("remote-port");
        _jspx_th_aui_input_1.setName("remotePort");
        _jspx_th_aui_input_1.setDynamicAttribute(null, "size", new String("10"));
        _jspx_th_aui_input_1.setType("text");
        _jspx_th_aui_input_1.setValue( MapUtil.getString(settingsMap, "remotePort", liveGroupTypeSettings.getProperty("remotePort")) );
        ...
        out.write("\n\n\t\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_2 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_2.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_2.setDisabled( disableInputs );
        _jspx_th_aui_input_2.setLabel("remote-path-context");
        _jspx_th_aui_input_2.setName("remotePathContext");
        _jspx_th_aui_input_2.setDynamicAttribute(null, "size", new String("10"));
        _jspx_th_aui_input_2.setType("text");
        _jspx_th_aui_input_2.setValue( MapUtil.getString(settingsMap, "remotePathContext", liveGroupTypeSettings.getProperty("remotePathContext")) );
        int _jspx_eval_aui_input_2 = _jspx_th_aui_input_2.doStartTag();
        if (_jspx_th_aui_input_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_2);
          return;
        }
        _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_2);
        out.write("\n\n\t\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_3 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_3.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_3.setDisabled( disableInputs );
        _jspx_th_aui_input_3.setLabel("remote-site-id");
        _jspx_th_aui_input_3.setName("remoteGroupId");
        _jspx_th_aui_input_3.setDynamicAttribute(null, "size", new String("10"));
        _jspx_th_aui_input_3.setType("text");
        _jspx_th_aui_input_3.setValue( MapUtil.getString(settingsMap, "targetGroupId", liveGroupTypeSettings.getProperty("remoteGroupId")) );
        int _jspx_eval_aui_input_3 = _jspx_th_aui_input_3.doStartTag();
        if (_jspx_th_aui_input_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_3);
          return;
        }
        _jspx_tagPool_aui_input_value_type_size_name_label_disabled_nobody.reuse(_jspx_th_aui_input_3);
        out.write("\n\n\t\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_disabled_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_4.setDisabled( disableInputs );
        _jspx_th_aui_input_4.setName("remotePrivateLayout");
        _jspx_th_aui_input_4.setType("hidden");
        _jspx_th_aui_input_4.setValue( MapUtil.getBoolean(settingsMap, "remotePrivateLayout", privateLayout) );
        int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
        if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_disabled_nobody.reuse(_jspx_th_aui_input_4);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_disabled_nobody.reuse(_jspx_th_aui_input_4);
        out.write('\n');
      ...
      if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_5 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_disabled_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_5.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
        _jspx_th_aui_input_5.setDisabled( disableInputs );
        _jspx_th_aui_input_5.setLabel("use-a-secure-network-connection");
        _jspx_th_aui_input_5.setName("secureConnection");
        _jspx_th_aui_input_5.setType("checkbox");
        _jspx_th_aui_input_5.setValue( MapUtil.getString(settingsMap, "secureConnection", liveGroupTypeSettings.getProperty("secureConnection")) );
        int _jspx_eval_aui_input_5 = _jspx_th_aui_input_5.doStartTag();
        if (_jspx_th_aui_input_5.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_disabled_nobody.reuse(_jspx_th_aui_input_5);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_disabled_nobody.reuse(_jspx_th_aui_input_5);
        out.write('\n');
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("export-the-selected-data-to-the-site-of-a-remote-portal-or-to-another-site-in-the-same-portal");
