...
public final class render_005fcontrols_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody;
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    ...
    _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody.release();
    _jspx_tagPool_liferay$1staging_defineObjects_nobody.release();
    _jspx_tagPool_c_if_test.release();
    _jspx_tagPool_aui_input_value_type_name_nobody.release();
    _jspx_tagPool_aui_script.release();
    _jspx_tagPool_portlet_defineObjects_nobody.release();
    _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody.release();
...
for (int i = 0; i < controls.length; i++) {
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( controls[i] instanceof PortletDataHandlerBoolean );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setName( controlName );
          _jspx_th_aui_input_0.setType("hidden");
          _jspx_th_aui_input_0.setValue( MapUtil.getBoolean(parameterMap, controlName, control.getDefaultState()) || MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.PORTLET_DATA_ALL) );
          ...
          out.write("\n\n\t\t\t\t");
          //  aui:input
          com.liferay.taglib.aui.InputTag _jspx_th_aui_input_1 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody.get(com.liferay.taglib.aui.InputTag.class);
          _jspx_th_aui_input_1.setPageContext(_jspx_page_context);
          _jspx_th_aui_input_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_0);
          _jspx_th_aui_input_1.setChecked( MapUtil.getBoolean(parameterMap, controlName, control.getDefaultState()) || MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.PORTLET_DATA_ALL) );
          _jspx_th_aui_input_1.setData( data );
          _jspx_th_aui_input_1.setDisabled( disabled );
          _jspx_th_aui_input_1.setHelpMessage( control.getHelpMessage(locale, action) );
          _jspx_th_aui_input_1.setIgnoreRequestValue( disabled );
          _jspx_th_aui_input_1.setLabel( controlLabel );
          _jspx_th_aui_input_1.setName( controlInputName );
          _jspx_th_aui_input_1.setType("checkbox");
          int _jspx_eval_aui_input_1 = _jspx_th_aui_input_1.doStartTag();
          if (_jspx_th_aui_input_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody.reuse(_jspx_th_aui_input_1);
            return;
          }
          _jspx_tagPool_aui_input_type_name_label_ignoreRequestValue_helpMessage_disabled_data_checked_nobody.reuse(_jspx_th_aui_input_1);
          out.write("\n\n\t\t\t\t");
          ...
          _jspx_th_c_if_0.setTest( children != null );
        ...
        _jspx_th_c_when_1.setTest( controls[i] instanceof PortletDataHandlerChoice );
        int _jspx_eval_c_when_1 = _jspx_th_c_when_1.doStartTag();
        if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t\t<label>\n\t\t\t\t\t");
          out.print( LanguageUtil.get(request, resourceBundle, controls[i].getControlLabel()) );
          out.write("\n\n\t\t\t\t\t");
          ...
          out.write("\n\n\t\t\t\t\t\t");
          //  aui:input
          com.liferay.taglib.aui.InputTag _jspx_th_aui_input_2 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody.get(com.liferay.taglib.aui.InputTag.class);
          _jspx_th_aui_input_2.setPageContext(_jspx_page_context);
          _jspx_th_aui_input_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_1);
          _jspx_th_aui_input_2.setChecked( controlValue.equals(choices[j]) );
          _jspx_th_aui_input_2.setData( data );
          _jspx_th_aui_input_2.setDisabled( disableInputs );
          _jspx_th_aui_input_2.setHelpMessage( control.getHelpMessage(locale, action) );
          _jspx_th_aui_input_2.setLabel( choice );
          _jspx_th_aui_input_2.setName( control.getNamespacedControlName() );
          _jspx_th_aui_input_2.setType("radio");
          _jspx_th_aui_input_2.setValue( choices[j] );
          int _jspx_eval_aui_input_2 = _jspx_th_aui_input_2.doStartTag();
          if (_jspx_th_aui_input_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody.reuse(_jspx_th_aui_input_2);
            return;
          }
          _jspx_tagPool_aui_input_value_type_name_label_helpMessage_disabled_data_checked_nobody.reuse(_jspx_th_aui_input_2);
          out.write("\n\n\t\t\t\t\t");
