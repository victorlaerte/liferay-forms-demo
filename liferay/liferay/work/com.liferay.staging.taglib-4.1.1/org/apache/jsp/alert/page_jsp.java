...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/alert/init.jsp");
...
String type = GetterUtil.getString(request.getAttribute("liferay-staging:alert:type"));
      ...
      _jspx_th_liferay$1util_buffer_0.setVar("icon");
      ...
      if (_jspx_eval_liferay$1util_buffer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_when_0.setTest( type == AlertType.ERROR.getAlertCode() );
            int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
            if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t<svg aria-hidden=\"true\" class=\"lexicon-icon lexicon-icon-exclamation-full\">\n\t\t\t\t<use xlink:href=\"");
              out.print( themeDisplayPath );
              out.write("/lexicon/icons.svg#exclamation-full\" />\n\t\t\t</svg>\n\n\t\t\t<strong class=\"lead\">");
              out.print( LanguageUtil.get(request, "alert-helper-error") );
              out.write(": </strong>\n\t\t");
            }
            ...
            _jspx_th_c_when_1.setTest( type == AlertType.INFO.getAlertCode() );
            int _jspx_eval_c_when_1 = _jspx_th_c_when_1.doStartTag();
            if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t<svg aria-hidden=\"true\" class=\"lexicon-icon lexicon-icon-info-circle\">\n\t\t\t\t<use xlink:href=\"");
              out.print( themeDisplayPath );
              out.write("/lexicon/icons.svg#info-circle\" />\n\t\t\t</svg>\n\n\t\t\t<strong class=\"lead\">");
              out.print( LanguageUtil.get(request, "alert-helper-info") );
              out.write(": </strong>\n\t\t");
            }
            ...
            _jspx_th_c_when_2.setTest( type == AlertType.SUCCESS.getAlertCode() );
            int _jspx_eval_c_when_2 = _jspx_th_c_when_2.doStartTag();
            if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t<i class=\"icon-ok-sign\"></i>\n\t\t\t<strong class=\"lead\">");
              out.print( LanguageUtil.get(request, "alert-helper-success") );
              out.write(": </strong>\n\t\t");
            }
            ...
            _jspx_th_c_when_3.setTest( type == AlertType.WARNING.getAlertCode() );
            int _jspx_eval_c_when_3 = _jspx_th_c_when_3.doStartTag();
            if (_jspx_eval_c_when_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t<i class=\"icon-warning-sign\"></i>\n\t\t\t<strong class=\"lead\">");
              out.print( LanguageUtil.get(request, "alert-helper-warning") );
              out.write(": </strong>\n\t\t");
            }
      ...
      icon = (java.lang.String) _jspx_page_context.findAttribute("icon");
      out.write('\n');
      out.write('\n');
      //  liferay-util:buffer
      ...
      _jspx_th_liferay$1util_buffer_1.setVar("close");
	...
	if (dismissible) {
          ...
          out.print( themeDisplayPath );
          out.write("/lexicon/icons.svg#times\" />\n\t\t\t</svg>\n\n\t\t\t<span class=\"sr-only\">");
      ...
      _jspx_tagPool_liferay$1util_buffer_var.reuse(_jspx_th_liferay$1util_buffer_1);
      java.lang.String close = null;
      close = (java.lang.String) _jspx_page_context.findAttribute("close");
      out.write("\n\n<div class=\"alert alert-");
      out.print( type );
      out.print( dismissible ? " alert-dismissible" : "" );
      out.print( fluid ? " alert-fluid" : "" );
      out.write("\">\n\t<div class=\"container\">\n\t\t");
      out.print( icon );
      out.write("\n\n\t\t<span>");
