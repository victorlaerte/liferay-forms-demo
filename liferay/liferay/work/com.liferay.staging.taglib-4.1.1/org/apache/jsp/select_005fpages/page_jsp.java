...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody;
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_button_value_id_nobody;
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_fieldset_markupView_id_cssClass;
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _jspx_tagPool_aui_button_value_id_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _jspx_tagPool_aui_fieldset_markupView_id_cssClass = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    ...
    _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody.release();
    _jspx_tagPool_aui_button_value_id_nobody.release();
    _jspx_tagPool_aui_fieldset_markupView_id_cssClass.release();
    ...
    _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.release();
...
String selectedLayoutIds = StringUtil.merge(selectedLayoutIdsArray);
      ...
      _jspx_th_aui_input_0.setName("layoutIds");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( ExportImportHelperUtil.getSelectedLayoutsJSON(selectPagesGroupId, selectPagesPrivteLayout, selectedLayoutIds) );
      ...
      out.write('\n');
      //  aui:fieldset
      com.liferay.taglib.aui.FieldsetTag _jspx_th_aui_fieldset_0 = (com.liferay.taglib.aui.FieldsetTag) _jspx_tagPool_aui_fieldset_markupView_id_cssClass.get(com.liferay.taglib.aui.FieldsetTag.class);
      _jspx_th_aui_fieldset_0.setPageContext(_jspx_page_context);
      _jspx_th_aui_fieldset_0.setParent(null);
      _jspx_th_aui_fieldset_0.setCssClass("options-group");
      _jspx_th_aui_fieldset_0.setId("pages-fieldset");
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_if_0.setTest( !disableInputs || LayoutStagingUtil.isBranchingLayoutSet(selectPagesGroup, selectPagesPrivteLayout) );
        ...
        if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_fieldset_1.setLabel("pages-options");
          ...
          if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_if_1.setTest( !disableInputs );
            ...
            if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_c_when_0.setTest( selectPagesPrivteLayout );
            ...
            _jspx_th_c_if_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
            _jspx_th_c_if_2.setTest( LayoutStagingUtil.isBranchingLayoutSet(selectPagesGroup, selectPagesPrivteLayout) );
            ...
            if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_aui_select_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_2);
              _jspx_th_aui_select_0.setDisabled( disableInputs );
              _jspx_th_aui_select_0.setLabel("site-pages-variation");
              _jspx_th_aui_select_0.setName("layoutSetBranchId");
              ...
              if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("\n\n\t\t\t\t\t\t\t\t\t");
                  //  aui:option
                  com.liferay.taglib.aui.OptionTag _jspx_th_aui_option_0 = (com.liferay.taglib.aui.OptionTag) _jspx_tagPool_aui_option_value_selected_localizeLabel_label_nobody.get(com.liferay.taglib.aui.OptionTag.class);
                  _jspx_th_aui_option_0.setPageContext(_jspx_page_context);
                  _jspx_th_aui_option_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_select_0);
                  _jspx_th_aui_option_0.setLabel( HtmlUtil.escape(layoutSetBranch.getName()) );
                  _jspx_th_aui_option_0.setLocalizeLabel( translateLayoutSetBranchName );
                  _jspx_th_aui_option_0.setSelected( selected );
                  _jspx_th_aui_option_0.setValue( layoutSetBranch.getLayoutSetBranchId() );
                  int _jspx_eval_aui_option_0 = _jspx_th_aui_option_0.doStartTag();
                  if (_jspx_th_aui_option_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
                    _jspx_tagPool_aui_option_value_selected_localizeLabel_label_nobody.reuse(_jspx_th_aui_option_0);
                    return;
                  }
                  _jspx_tagPool_aui_option_value_selected_localizeLabel_label_nobody.reuse(_jspx_th_aui_option_0);
                  out.write("\n\n\t\t\t\t\t\t\t\t");
        ...
        _jspx_th_aui_fieldset_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_fieldset_2.setLabel( "pages-to-" + action );
        ...
        if (_jspx_eval_aui_fieldset_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_choose_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_2);
          ...
          if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_when_1.setTest( disableInputs );
            ...
            if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_liferay$1util_buffer_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_1);
              ...
              if (_jspx_eval_liferay$1util_buffer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_c_choose_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1util_buffer_0);
                  ...
                  if (_jspx_eval_c_choose_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_c_when_2.setTest( totalLayoutsCount == 0 );
                    ...
                    if (_jspx_eval_c_otherwise_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      _jspx_th_liferay$1ui_message_2.setArguments( new String[] {"<strong>" + String.valueOf(messageKeyLayoutsCount) + "</strong>", String.valueOf(totalLayoutsCount)} );
                      _jspx_th_liferay$1ui_message_2.setKey("x-of-x");
              ...
              _jspx_th_liferay$1ui_message_3.setArguments( badgeHTML );
              _jspx_th_liferay$1ui_message_3.setKey("pages-x");
            ...
            if (_jspx_eval_c_otherwise_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              com.liferay.layout.taglib.servlet.taglib.LayoutsTreeTag _jspx_th_liferay$1layout_layouts$1tree_0 = (com.liferay.layout.taglib.servlet.taglib.LayoutsTreeTag) _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody.get(com.liferay.layout.taglib.servlet.taglib.LayoutsTreeTag.class);
              _jspx_th_liferay$1layout_layouts$1tree_0.setPageContext(_jspx_page_context);
              _jspx_th_liferay$1layout_layouts$1tree_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_2);
              _jspx_th_liferay$1layout_layouts$1tree_0.setDefaultStateChecked( true );
              _jspx_th_liferay$1layout_layouts$1tree_0.setDraggableTree( false );
              _jspx_th_liferay$1layout_layouts$1tree_0.setGroupId( selectPagesGroupId );
              _jspx_th_liferay$1layout_layouts$1tree_0.setIncomplete( false );
              _jspx_th_liferay$1layout_layouts$1tree_0.setPortletURL( renderResponse.createRenderURL() );
              _jspx_th_liferay$1layout_layouts$1tree_0.setPrivateLayout( selectPagesPrivteLayout );
              _jspx_th_liferay$1layout_layouts$1tree_0.setRootNodeName( selectPagesGroup.getLayoutRootNodeName(selectPagesPrivteLayout, locale) );
              _jspx_th_liferay$1layout_layouts$1tree_0.setSelectableTree( true );
              _jspx_th_liferay$1layout_layouts$1tree_0.setSelectedLayoutIds( selectedLayoutIds );
              _jspx_th_liferay$1layout_layouts$1tree_0.setSelPlid( selPlid );
              _jspx_th_liferay$1layout_layouts$1tree_0.setTreeId( treeId );
              ...
              if (_jspx_th_liferay$1layout_layouts$1tree_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
                _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody.reuse(_jspx_th_liferay$1layout_layouts$1tree_0);
                return;
              }
              _jspx_tagPool_liferay$1layout_layouts$1tree_treeId_selectedLayoutIds_selectableTree_selPlid_rootNodeName_privateLayout_portletURL_incomplete_groupId_draggableTree_defaultStateChecked_nobody.reuse(_jspx_th_liferay$1layout_layouts$1tree_0);
              out.write("\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t");
        ...
        _jspx_th_aui_fieldset_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_fieldset_3.setLabel("look-and-feel");
        ...
        if (_jspx_eval_aui_fieldset_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          com.liferay.staging.taglib.servlet.taglib.CheckboxTag _jspx_th_liferay$1staging_checkbox_0 = (com.liferay.staging.taglib.servlet.taglib.CheckboxTag) _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.get(com.liferay.staging.taglib.servlet.taglib.CheckboxTag.class);
          _jspx_th_liferay$1staging_checkbox_0.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1staging_checkbox_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
          _jspx_th_liferay$1staging_checkbox_0.setChecked( MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.THEME_REFERENCE, ParamUtil.getBoolean(request, PortletDataHandlerKeys.THEME_REFERENCE, true)) );
          _jspx_th_liferay$1staging_checkbox_0.setDisabled( disableInputs );
          _jspx_th_liferay$1staging_checkbox_0.setLabel("theme-settings");
          _jspx_th_liferay$1staging_checkbox_0.setName( PortletDataHandlerKeys.THEME_REFERENCE );
          _jspx_th_liferay$1staging_checkbox_0.setPopover("export-import-theme-settings-help");
          ...
          if (_jspx_th_liferay$1staging_checkbox_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_0);
            return;
          }
          _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_0);
          out.write("\n\n\t\t\t\t\t");
          //  liferay-staging:checkbox
          com.liferay.staging.taglib.servlet.taglib.CheckboxTag _jspx_th_liferay$1staging_checkbox_1 = (com.liferay.staging.taglib.servlet.taglib.CheckboxTag) _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.get(com.liferay.staging.taglib.servlet.taglib.CheckboxTag.class);
          _jspx_th_liferay$1staging_checkbox_1.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1staging_checkbox_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
          _jspx_th_liferay$1staging_checkbox_1.setChecked( MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.LOGO, ParamUtil.getBoolean(request, PortletDataHandlerKeys.LOGO, true)) );
          _jspx_th_liferay$1staging_checkbox_1.setDisabled( disableInputs );
          _jspx_th_liferay$1staging_checkbox_1.setLabel("logo");
          _jspx_th_liferay$1staging_checkbox_1.setName( PortletDataHandlerKeys.LOGO );
          ...
          if (_jspx_th_liferay$1staging_checkbox_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_1);
            return;
          }
          _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_1);
          out.write("\n\n\t\t\t\t\t");
          //  liferay-staging:checkbox
          com.liferay.staging.taglib.servlet.taglib.CheckboxTag _jspx_th_liferay$1staging_checkbox_2 = (com.liferay.staging.taglib.servlet.taglib.CheckboxTag) _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.get(com.liferay.staging.taglib.servlet.taglib.CheckboxTag.class);
          _jspx_th_liferay$1staging_checkbox_2.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1staging_checkbox_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
          _jspx_th_liferay$1staging_checkbox_2.setChecked( MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.LAYOUT_SET_SETTINGS, ParamUtil.getBoolean(request, PortletDataHandlerKeys.LAYOUT_SET_SETTINGS, true)) );
          _jspx_th_liferay$1staging_checkbox_2.setDisabled( disableInputs );
          _jspx_th_liferay$1staging_checkbox_2.setLabel("site-pages-settings");
          _jspx_th_liferay$1staging_checkbox_2.setName( PortletDataHandlerKeys.LAYOUT_SET_SETTINGS );
          ...
          if (_jspx_th_liferay$1staging_checkbox_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_2);
            return;
          }
          _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_2);
          out.write("\n\n\t\t\t\t\t");
          //  liferay-staging:checkbox
          com.liferay.staging.taglib.servlet.taglib.CheckboxTag _jspx_th_liferay$1staging_checkbox_3 = (com.liferay.staging.taglib.servlet.taglib.CheckboxTag) _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.get(com.liferay.staging.taglib.servlet.taglib.CheckboxTag.class);
          _jspx_th_liferay$1staging_checkbox_3.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1staging_checkbox_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
          _jspx_th_liferay$1staging_checkbox_3.setChecked( MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.LAYOUT_SET_PROTOTYPE_SETTINGS, ParamUtil.getBoolean(request, PortletDataHandlerKeys.LAYOUT_SET_PROTOTYPE_SETTINGS, true)) );
          _jspx_th_liferay$1staging_checkbox_3.setDisabled( disableInputs );
          _jspx_th_liferay$1staging_checkbox_3.setLabel("site-template-settings");
          _jspx_th_liferay$1staging_checkbox_3.setName( PortletDataHandlerKeys.LAYOUT_SET_PROTOTYPE_SETTINGS );
          ...
          if (_jspx_th_liferay$1staging_checkbox_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_3);
            return;
          }
          _jspx_tagPool_liferay$1staging_checkbox_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_3);
          out.write("\n\n\t\t\t\t\t");
          ...
          _jspx_th_c_if_3.setTest( action.equals(Constants.PUBLISH) );
          int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
          if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t\t\t\t");
            //  liferay-staging:checkbox
            com.liferay.staging.taglib.servlet.taglib.CheckboxTag _jspx_th_liferay$1staging_checkbox_4 = (com.liferay.staging.taglib.servlet.taglib.CheckboxTag) _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.get(com.liferay.staging.taglib.servlet.taglib.CheckboxTag.class);
            _jspx_th_liferay$1staging_checkbox_4.setPageContext(_jspx_page_context);
            _jspx_th_liferay$1staging_checkbox_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_3);
            _jspx_th_liferay$1staging_checkbox_4.setChecked( MapUtil.getBoolean(parameterMap, PortletDataHandlerKeys.DELETE_MISSING_LAYOUTS, ParamUtil.getBoolean(request, PortletDataHandlerKeys.DELETE_MISSING_LAYOUTS, false)) );
            _jspx_th_liferay$1staging_checkbox_4.setDisabled( disableInputs );
            _jspx_th_liferay$1staging_checkbox_4.setLabel("delete-missing-layouts");
            _jspx_th_liferay$1staging_checkbox_4.setName( PortletDataHandlerKeys.DELETE_MISSING_LAYOUTS );
            _jspx_th_liferay$1staging_checkbox_4.setPopover("delete-missing-layouts-staging-help");
            ...
            if (_jspx_th_liferay$1staging_checkbox_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_4);
              return;
            }
            _jspx_tagPool_liferay$1staging_checkbox_popover_name_label_disabled_checked_nobody.reuse(_jspx_th_liferay$1staging_checkbox_4);
            out.write("\n\t\t\t\t\t");
      ...
      if (_jspx_th_aui_fieldset_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        _jspx_tagPool_aui_fieldset_markupView_id_cssClass.reuse(_jspx_th_aui_fieldset_0);
        return;
      }
      _jspx_tagPool_aui_fieldset_markupView_id_cssClass.reuse(_jspx_th_aui_fieldset_0);
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_aui_button_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setId("changeToPublicLayoutsButton");
    _jspx_th_aui_button_0.setValue("change-to-public-pages");
  ...
  private boolean _jspx_meth_aui_button_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_1.setId("changeToPrivateLayoutsButton");
    _jspx_th_aui_button_1.setValue("change-to-private-pages");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_2, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("none");
