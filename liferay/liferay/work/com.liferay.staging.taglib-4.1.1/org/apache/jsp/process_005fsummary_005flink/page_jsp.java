package org.apache.jsp.process_005fsummary_005flink;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/process_summary_link/init.jsp");
...
BackgroundTask backgroundTask = BackgroundTaskManagerUtil.fetchBackgroundTask(backgroundTaskId);
      ...
      _jspx_th_liferay$1portlet_renderURL_0.setPortletName( ExportImportPortletKeys.EXPORT_IMPORT );
      _jspx_th_liferay$1portlet_renderURL_0.setVar("processSummaryURL");
      ...
      if (_jspx_eval_liferay$1portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_param_1.setValue( String.valueOf(backgroundTask.getBackgroundTaskId()) );
      ...
      _jspx_tagPool_liferay$1portlet_renderURL_windowState_var_portletName.reuse(_jspx_th_liferay$1portlet_renderURL_0);
      java.lang.String processSummaryURL = null;
      processSummaryURL = (java.lang.String) _jspx_page_context.findAttribute("processSummaryURL");
      out.write('\n');
      out.write('\n');
...
String taglibOnClick = liferayPortletResponse.getNamespace() + "showProcessSummary(" + String.valueOf(backgroundTask.getBackgroundTaskId()) + ", '" + HtmlUtil.escapeJS(backgroundTaskDisplay.getDisplayName(request)) + "', '" + HtmlUtil.escape(processSummaryURL) + "');";
      ...
      _jspx_th_liferay$1ui_icon_0.setMessage("summary");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("showProcessSummary");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("showProcessSummary(backgroundTaskId, backgroundTaskName, processSummaryURL) {\n\t\tLiferay.Util.openWindow(\n\t\t\t{\n\t\t\t\tdialog: {\n\t\t\t\t\tdestroyOnHide: true\n\t\t\t\t},\n\t\t\t\tid: '");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("showSummary_' + backgroundTaskId,\n\t\t\t\ttitle: backgroundTaskName,\n\t\t\t\turi: processSummaryURL + '&");
        if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("backgroundTaskId=' + backgroundTaskId\n\t\t\t}\n\t\t);\n\t}\n");
