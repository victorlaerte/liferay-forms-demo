package org.apache.jsp.process_005ftitle;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/process_title/init.jsp");
...
String domId = liferayPortletResponse.getNamespace() + "backgroundTaskName" + String.valueOf(backgroundTask.getBackgroundTaskId());
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( listView );
        int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t<strong class=\"process-title table-list-title\" id=\"");
          out.print( domId );
          out.write("\">\n\t\t\t");
          //  liferay-ui:message
          ...
          _jspx_th_liferay$1ui_message_0.setKey( HtmlUtil.escape(backgroundTaskName) );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_1.setKey( HtmlUtil.escape(backgroundTaskName) );
