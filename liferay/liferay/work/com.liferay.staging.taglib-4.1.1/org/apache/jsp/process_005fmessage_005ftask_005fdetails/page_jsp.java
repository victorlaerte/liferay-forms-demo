package org.apache.jsp.process_005fmessage_005ftask_005fdetails;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/process_message_task_details/init.jsp");
...
String linkClass = GetterUtil.getString(request.getAttribute("liferay-staging:process-message-task-details:linkClass"));
      ...
      _jspx_th_c_if_0.setTest( Validator.isNotNull(backgroundTaskStatusMessage) );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_when_0.setTest( jsonObject == null );
          int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
          if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t\t<div class=\"alert ");
            out.print( (backgroundTask.getStatus() == BackgroundTaskConstants.STATUS_FAILED) ? "alert-danger" : StringPool.BLANK );
            out.write(" publish-error\">\n\t\t\t\t\t");
            //  liferay-ui:message
            ...
            _jspx_th_liferay$1ui_message_1.setArguments( backgroundTaskStatusMessage );
            _jspx_th_liferay$1ui_message_1.setKey("unable-to-execute-process-x");
          ...
          if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_c_when_1.setTest( exported && !validated );
            ...
            out.print( HtmlUtil.escape(jsonObject.getString("message")) );
            out.write("</span>\n\n\t\t\t\t\t");
            ...
            _jspx_th_c_if_1.setTest( (messageListItemsJSONArray != null) && (messageListItemsJSONArray.length() > 0) );
            ...
            if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              out.write("\n\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t");
              out.print( messageListItemJSONArray.getString("type") );
              out.write("\n\n\t\t\t\t\t\t\t\t\t");
              out.print( messageListItemJSONArray.getString("site") );
              out.write(":\n\n\t\t\t\t\t\t\t\t\t<strong>");
              out.print( HtmlUtil.escape(messageListItemJSONArray.getString("name")) );
              out.write("</strong>\n\n\t\t\t\t\t\t\t\t\t");
              //  c:if
              com.liferay.taglib.core.IfTag _jspx_th_c_if_2 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
              _jspx_th_c_if_2.setPageContext(_jspx_page_context);
              _jspx_th_c_if_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_1);
              _jspx_th_c_if_2.setTest( Validator.isNotNull(info) );
              int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
              if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                out.write("\n\t\t\t\t\t\t\t\t\t\t<span class=\"error-info\">(");
                out.print( HtmlUtil.escape(messageListItemJSONArray.getString("info")) );
                out.write(")</span>\n\t\t\t\t\t\t\t\t\t");
              }
            ...
            _jspx_th_c_if_3.setTest( (warningMessagesJSONArray != null) && (warningMessagesJSONArray.length() > 0) );
            ...
            if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_liferay$1ui_message_4.setKey( ((messageListItemsJSONArray != null) && (messageListItemsJSONArray.length() > 0)) ? "consider-that-the-following-data-would-not-have-been-published-either" : "the-following-data-has-not-been-published" );
              ...
              out.write("\n\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t");
              out.print( warningMessageJSONArray.getString("type") );
              out.write(":\n\n\t\t\t\t\t\t\t\t\t<strong>");
              out.print( warningMessageJSONArray.getString("size") );
              out.write("</strong>\n\n\t\t\t\t\t\t\t\t\t");
              //  c:if
              com.liferay.taglib.core.IfTag _jspx_th_c_if_4 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
              _jspx_th_c_if_4.setPageContext(_jspx_page_context);
              _jspx_th_c_if_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_3);
              _jspx_th_c_if_4.setTest( Validator.isNotNull(info) );
              int _jspx_eval_c_if_4 = _jspx_th_c_if_4.doStartTag();
              if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                out.write("\n\t\t\t\t\t\t\t\t\t\t<span class=\"error-info\">(");
                out.print( HtmlUtil.escape(warningMessageJSONArray.getString("info")) );
                out.write(")</span>\n\t\t\t\t\t\t\t\t\t");
              }
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("see-more-details");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("the-publication-process-did-not-start-due-to-validation-errors");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("an-unexpected-error-occurred-with-the-publication-process.-please-check-your-portal-and-publishing-configuration");
