...
Group group = GroupLocalServiceUtil.getGroup(scopeGroupId);
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_1.setTest( GroupPermissionUtil.contains(permissionChecker, group.getGroupId(), ActionKeys.UPDATE) );
        ...
        if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_renderURL_0.setVar("inviteURL");
          ...
          _jspx_tagPool_portlet_renderURL_windowState_var.reuse(_jspx_th_portlet_renderURL_0);
          java.lang.String inviteURL = null;
          inviteURL = (java.lang.String) _jspx_page_context.findAttribute("inviteURL");
          out.write("\n\n\t\t");
          if (_jspx_meth_aui_a_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_when_1, _jspx_page_context))
            return;
          out.write("\n\n\t\t");
          //  aui:script
          ...
          if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
                return;
              out.write("inviteMembersButton = document.getElementById('");
              if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
                return;
              out.write("inviteMembersButton');\n\n\t\t\t");
              if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
                return;
              out.write("inviteMembersButton.addEventListener(\n\t\t\t\t'click',\n\t\t\t\tfunction(event) {\n\t\t\t\t\tLiferay.Util.openWindow(\n\t\t\t\t\t\t{\n\t\t\t\t\t\t\tdialog: {\n\t\t\t\t\t\t\t\tcssClass: 'so-portlet-invite-members',\n\t\t\t\t\t\t\t\tdestroyOnHide: true,\n\t\t\t\t\t\t\t\twidth: 700\n\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\tdialogIframe: {\n\t\t\t\t\t\t\t\tbodyCssClass: 'dialog-with-footer'\n\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\ttitle: '");
              out.print( portletDisplay.getTitle() );
              out.write("',\n\t\t\t\t\t\t\turi: '");
              out.print( HtmlUtil.escapeJS(inviteURL) );
              out.write("'\n\t\t\t\t\t\t}\n\t\t\t\t\t);\n\t\t\t\t}\n\t\t\t);\n\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("this-application-will-only-function-when-placed-on-a-site-page");
  ...
  private boolean _jspx_meth_aui_a_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:a
    ...
    _jspx_th_aui_a_0.setId("inviteMembersButton");
    _jspx_th_aui_a_0.setLabel("invite-members");
  ...
  private boolean _jspx_meth_aui_script_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n\t\t\tlet dom = metalDomSrcDom.default;\n\n\t\t\tvar portlet = document.getElementById('p_p_id");
