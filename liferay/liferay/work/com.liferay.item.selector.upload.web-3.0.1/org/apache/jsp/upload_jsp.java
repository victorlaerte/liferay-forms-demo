...
ItemSelectorUploadViewDisplayContext itemSelectorUploadViewDisplayContext = (ItemSelectorUploadViewDisplayContext)request.getAttribute(ItemSelectorUploadView.ITEM_SELECTOR_UPLOAD_VIEW_DISPLAY_CONTEXT);
      ...
      _jspx_th_c_if_0.setTest( !BrowserSnifferUtil.isMobile(request) );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_message_0.setArguments( itemSelectorUploadViewDisplayContext.getRepositoryName() );
        _jspx_th_liferay$1ui_message_0.setKey("drag-and-drop-to-upload-to-x-or");
      ...
      if (_jspx_meth_liferay$1ui_message_1(_jspx_page_context))
        return;
      out.write("</label>\n\n\t\t\t\t<input accept=\"");
      out.print( ArrayUtil.isEmpty(itemSelectorUploadViewDisplayContext.getExtensions()) ? "*" : StringUtil.merge(itemSelectorUploadViewDisplayContext.getExtensions()) );
	...
	if (Validator.isNotNull(namespace)) {
		uploadURL = HttpUtil.addParameter(uploadURL, namespace + "returnType", itemSelectorReturnTypeClass.getName());
          ...
          out.print( itemSelectorUploadViewDisplayContext.getTitle(locale) );
          out.write("',\n\t\t\tmaxFileSize: '");
          out.print( itemSelectorUploadViewDisplayContext.getMaxFileSize() );
          out.write("',\n\t\t\ton: {\n\t\t\t\tselectedItem: function(event) {\n\t\t\t\t\tLiferay.Util.getOpener().Liferay.fire('");
          out.print( itemSelectorUploadViewDisplayContext.getItemSelectedEventName() );
          out.write("', event);\n\t\t\t\t}\n\t\t\t},\n\t\t\trootNode: '#itemSelectorUploadContainer',\n\t\t\tuploadItemReturnType: '");
          out.print( HtmlUtil.escapeAttribute(itemSelectorReturnTypeClass.getName()) );
          out.write("',\n\t\t\tuploadItemURL: '");
