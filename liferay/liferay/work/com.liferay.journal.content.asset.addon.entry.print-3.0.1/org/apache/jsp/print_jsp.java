...
String viewMode = ParamUtil.getString(request, "viewMode");
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( viewMode.equals(Constants.PRINT) );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_renderURL_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_0);
          _jspx_th_portlet_renderURL_0.setVar("printPageURL");
          ...
          if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_2.setName("page");
            _jspx_th_portlet_param_2.setValue( String.valueOf(articleDisplay.getCurrentPage()) );
            ...
            _jspx_th_portlet_param_3.setName("viewMode");
            _jspx_th_portlet_param_3.setValue( Constants.PRINT );
          ...
          _jspx_th_liferay$1ui_icon_0.setMessage( LanguageUtil.format(request, "print-x-x", new Object[] {"hide-accessible", HtmlUtil.escape(articleDisplay.getTitle())}, false) );
          _jspx_th_liferay$1ui_icon_0.setUrl( "javascript:" + renderResponse.getNamespace() + "printPage();" );
