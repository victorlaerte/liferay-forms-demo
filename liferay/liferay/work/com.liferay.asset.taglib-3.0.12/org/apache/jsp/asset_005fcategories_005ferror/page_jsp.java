package org.apache.jsp.asset_005fcategories_005ferror;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/asset_categories_error/init.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_liferay$1ui_error_0.setException( AssetCategoryException.class );
	...
	if (vocabulary != null) {
		vocabularyTitle = vocabulary.getTitle(locale);
          ...
          out.write("\n\n\t<c:choose>\n\t\t<c:when test=\"");
          out.print( ace.getType() == AssetCategoryException.AT_LEAST_ONE_CATEGORY );
          out.write("\">\n\t\t\t");
          //  liferay-ui:message
          ...
          _jspx_th_liferay$1ui_message_0.setArguments( vocabularyTitle );
          _jspx_th_liferay$1ui_message_0.setKey("please-select-at-least-one-category-for-x");
          ...
          _jspx_tagPool_liferay$1ui_message_translateArguments_key_arguments_nobody.reuse(_jspx_th_liferay$1ui_message_0);
          out.write("\n\t\t</c:when>\n\t\t<c:when test=\"");
          out.print( ace.getType() == AssetCategoryException.TOO_MANY_CATEGORIES );
          out.write("\">\n\t\t\t");
          //  liferay-ui:message
          ...
          _jspx_th_liferay$1ui_message_1.setArguments( vocabularyTitle );
          _jspx_th_liferay$1ui_message_1.setKey("you-cannot-select-more-than-one-category-for-x");
