...
AssetRendererFactory assetRendererFactory = (AssetRendererFactory)request.getAttribute(WebKeys.ASSET_RENDERER_FACTORY);
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( Validator.isNotNull(assetRenderer.getThumbnailPath(renderRequest)) );
        int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t<div class=\"aspect-ratio aspect-ratio-bg-center aspect-ratio-bg-cover\" style=\"background-image: url('");
          out.print( assetRenderer.getThumbnailPath(renderRequest) );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t<div class=\"aspect-ratio aspect-ratio-bg-center aspect-ratio-bg-cover vertical-card-container\">\n\t\t\t\t<aui:icon cssClass=\"icon-vertical-card-image\" image=\"");
          out.print( assetRendererFactory.getIconCssClass() );
          out.write("\" markupView=\"lexicon\" />\n\t\t\t</div>\n\t\t");
        }
      ...
      out.print( HtmlUtil.escape(assetRendererFactory.getTypeName(locale)) );
      out.write("\n\t\t\t</span>\n\t\t</div>\n\t</div>\n</div>");
    } catch (Throwable t) {
