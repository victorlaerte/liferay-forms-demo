...
ProductMenuDisplayContext productMenuDisplayContext = new ProductMenuDisplayContext(liferayPortletRequest, liferayPortletResponse);
      ...
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.print( AUIUtil.normalizeId(userPanelCategory.getKey()) );
      out.write("Collapse\" aria-expanded=\"");
      out.print( Objects.equals(userPanelCategory.getKey(), productMenuDisplayContext.getRootPanelCategoryKey()) );
      out.write("\" class=\"collapse-icon collapse-icon-middle ");
      out.print( Objects.equals(userPanelCategory.getKey(), productMenuDisplayContext.getRootPanelCategoryKey()) ? StringPool.BLANK : "collapsed" );
      out.write(" panel-toggler\" data-parent=\"#");
      if (_jspx_meth_portlet_namespace_1(_jspx_page_context))
        return;
      out.write("Accordion\" data-qa-id=\"productMenuUserPanelCategory\" data-toggle=\"collapse\" href=\"#");
      ...
      out.print( HtmlUtil.escape(user.getFirstName()) );
      out.write("\n\n\t\t");
      //  c:if
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n\n\t\t\t<small class=\"impersonation-message\">(");
      ...
      _jspx_th_c_if_1.setTest( notificationsCount > 0 );
