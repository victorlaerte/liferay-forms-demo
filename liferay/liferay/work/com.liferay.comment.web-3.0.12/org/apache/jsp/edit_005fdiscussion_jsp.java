...
public final class edit_005fdiscussion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody.release();
...
if (comment instanceof WorkflowableComment) {
	...
	pending = workflowableComment.getStatus() == WorkflowConstants.STATUS_PENDING;
      ...
      _jspx_th_liferay$1ui_header_0.setTitle( (comment == null) ? "new-message" : "edit-message" );
      ...
      _jspx_th_portlet_actionURL_0.setName("invokeTaglibDiscussion");
      _jspx_th_portlet_actionURL_0.setVar("editCommentURL");
      ...
      _jspx_tagPool_portlet_actionURL_var_name_nobody.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String editCommentURL = null;
      editCommentURL = (java.lang.String) _jspx_page_context.findAttribute("editCommentURL");
      ...
      _jspx_th_aui_form_0.setAction( editCommentURL );
      _jspx_th_aui_form_0.setDynamicAttribute(null, "enctype", new String("multipart/form-data"));
      _jspx_th_aui_form_0.setMethod("post");
      _jspx_th_aui_form_0.setName("fm");
      _jspx_th_aui_form_0.setOnSubmit( "event.preventDefault(); " + renderResponse.getNamespace() + "saveComment();" );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_3.setName("commentId");
        _jspx_th_aui_input_3.setType("hidden");
        _jspx_th_aui_input_3.setValue( commentId );
        ...
        _jspx_th_aui_input_4.setName("parentCommentId");
        _jspx_th_aui_input_4.setType("hidden");
        _jspx_th_aui_input_4.setValue( parentCommentId );
        ...
        _jspx_th_aui_input_5.setValue( String.valueOf(pending ? WorkflowConstants.ACTION_SAVE_DRAFT : WorkflowConstants.ACTION_PUBLISH) );
        ...
        _jspx_th_aui_input_6.setName("ajax");
        ...
        _jspx_th_liferay$1ui_error_2.setException( DiscussionMaxCommentsException.class );
        _jspx_th_liferay$1ui_error_2.setMessage("maximum-number-of-comments-has-been-reached");
        ...
        _jspx_th_liferay$1ui_error_3.setException( MessageBodyException.class );
        _jspx_th_liferay$1ui_error_3.setMessage("please-enter-a-valid-message");
        ...
        _jspx_th_aui_model$1context_0.setBean( comment );
        _jspx_th_aui_model$1context_0.setModel( comment.getModelClass() );
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_if_0.setTest( workflowableComment != null );
          ...
          com.liferay.taglib.ui.InputEditorTag _jspx_th_liferay$1ui_input$1editor_0 = (com.liferay.taglib.ui.InputEditorTag) _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody.get(com.liferay.taglib.ui.InputEditorTag.class);
          ...
          _jspx_th_liferay$1ui_input$1editor_0.setContents( comment.getBody() );
          ...
          if (_jspx_th_liferay$1ui_input$1editor_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody.reuse(_jspx_th_liferay$1ui_input$1editor_0);
            return;
          }
          _jspx_tagPool_liferay$1ui_input$1editor_showSource_name_editorName_contents_configKey_nobody.reuse(_jspx_th_liferay$1ui_input$1editor_0);
          out.write("\n\n\t\t\t");
          ...
          _jspx_th_aui_input_7.setName("body");
          _jspx_th_aui_input_7.setType("hidden");
          _jspx_th_aui_input_7.setValue( comment.getBody() );
        ...
        _jspx_th_c_if_1.setTest( parentComment != null );
        ...
        if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\n\n\t\t\t");
          if (_jspx_meth_liferay$1util_include_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_1, _jspx_page_context))
            return;
          out.write("\n\t\t");
        }
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_if_3.setTest( (comment == null) || !approved );
          ...
          _jspx_th_c_if_4.setTest( (workflowableComment != null) && approved && WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(workflowableComment.getCompanyId(), workflowableComment.getGroupId(), CommentConstants.getDiscussionClassName()) );
          ...
          if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_2.setArguments( ResourceActionsUtil.getModelResource(locale, comment.getModelClassName()) );
            _jspx_th_liferay$1ui_message_2.setKey("this-x-is-approved.-publishing-these-changes-will-cause-it-to-be-unpublished-and-go-through-the-approval-process-again");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("replying-to");
  ...
  private boolean _jspx_meth_liferay$1util_include_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    ...
    _jspx_th_liferay$1util_include_0.setPage("/asset/discussion_full_content.jsp");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("there-is-a-publication-workflow-in-process");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("saveComment() {\n\t\tvar form = AUI.$(document.");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("fm);\n\n\t\tform.fm('body').val(window.");
