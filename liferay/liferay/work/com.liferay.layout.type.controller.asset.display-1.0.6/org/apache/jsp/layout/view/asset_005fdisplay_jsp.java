...
public final class asset_005fdisplay_jsp extends org.apache.jasper.runtime.HttpJspBase
...
AssetDisplayLayoutTypeControllerDisplayContext assetDisplayLayoutTypeControllerDisplayContext = new AssetDisplayLayoutTypeControllerDisplayContext(request);
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( ListUtil.isNotEmpty(fragmentEntryLinks) );
        ...
        _jspx_th_c_when_1.setTest( assetEntry != null );
        int _jspx_eval_c_when_1 = _jspx_th_c_when_1.doStartTag();
        if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t<div class=\"sheet\">\n\t\t\t<div class=\"sheet-header\">\n\t\t\t\t<h2 class=\"sheet-title\">\n\t\t\t\t\t");
          out.print( assetEntry.getTitle(locale) );
          out.write("\n\t\t\t\t</h2>\n\n\t\t\t\t<div class=\"sheet-text\">\n\t\t\t\t\t");
          out.print( assetEntry.getDescription(locale) );
          out.write("\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t");
        }
