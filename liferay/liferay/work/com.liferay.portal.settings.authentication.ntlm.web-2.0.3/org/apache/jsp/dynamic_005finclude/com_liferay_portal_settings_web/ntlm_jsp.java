...
public final class ntlm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (Validator.isNotNull(servicePassword)) {
	servicePassword = Portal.TEMP_OBFUSCATION_VALUE;
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setId( PortalUtil.generateRandomKey(request, "portal_settings_authentication_ntlm") );
        _jspx_th_aui_input_0.setName( ActionRequest.ACTION_NAME );
        _jspx_th_aui_input_0.setType("hidden");
        _jspx_th_aui_input_0.setValue(new String("/portal_settings/ntlm"));
        ...
        _jspx_th_aui_input_1.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "enabled" );
        ...
        _jspx_th_aui_input_2.setLabel("domain-controller");
        _jspx_th_aui_input_2.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domainController" );
        _jspx_th_aui_input_2.setType("text");
        _jspx_th_aui_input_2.setValue( domainController );
        ...
        _jspx_th_aui_input_3.setHelpMessage("domain-controller-name-help");
        _jspx_th_aui_input_3.setLabel("domain-controller-name");
        _jspx_th_aui_input_3.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domainControllerName" );
        _jspx_th_aui_input_3.setType("text");
        _jspx_th_aui_input_3.setValue( domainControllerName );
        ...
        _jspx_th_aui_input_4.setLabel("domain");
        _jspx_th_aui_input_4.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domain" );
        _jspx_th_aui_input_4.setType("text");
        _jspx_th_aui_input_4.setValue( domain );
        ...
        _jspx_th_aui_input_5.setLabel("service-account");
        _jspx_th_aui_input_5.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "serviceAccount" );
        _jspx_th_aui_input_5.setType("text");
        _jspx_th_aui_input_5.setValue( serviceAccount );
        ...
        _jspx_th_aui_input_6.setLabel("service-password");
        _jspx_th_aui_input_6.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "servicePassword" );
        _jspx_th_aui_input_6.setType("password");
        _jspx_th_aui_input_6.setValue( servicePassword );
        ...
        _jspx_th_aui_input_7.setLabel("negotiate-flags");
        _jspx_th_aui_input_7.setName( PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "negotiateFlags" );
        _jspx_th_aui_input_7.setType("text");
        _jspx_th_aui_input_7.setValue( negotiateFlags );
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_actionURL_0.setName("/portal_settings/ntlm_delete");
		...
		String taglibOnClick = "if (confirm('" + UnicodeLanguageUtil.get(request, "are-you-sure-you-want-to-reset-the-configured-values") + "')) {submitForm(document.hrefFm, '" + resetValuesURL.toString() + "');}";
          ...
          _jspx_th_aui_button_0.setValue("reset-values");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("ntlm");
