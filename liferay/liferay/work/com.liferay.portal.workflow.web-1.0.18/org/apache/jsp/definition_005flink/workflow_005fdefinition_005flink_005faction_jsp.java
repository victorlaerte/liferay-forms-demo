...
public final class workflow_005fdefinition_005flink_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String randomNamespace = (String)row.getParameter("randomNamespace");
      ...
      out.write("\n\n<div class=\"btn-group btn-group-nowrap\" hidden=\"true\" id=\"");
      out.print( randomNamespace );
      out.write("saveCancelGroup\">\n\t<div class=\"btn-group-item\">\n\t\t<button class=\"btn btn-primary btn-sm\" id=\"");
      out.print( randomNamespace );
      out.write("saveButton\" type=\"button\")>");
      out.print( LanguageUtil.get(request, "save") );
      out.write("</button>\n\t</div>\n\n\t<div class=\"btn-group-item\">\n\t\t<button class=\"btn btn-secondary btn-sm\" id=\"");
      out.print( randomNamespace );
      out.write("cancelButton\" type=\"button\">");
      out.print( LanguageUtil.get(request, "cancel") );
      out.write("</button>\n\t</div>\n</div>\n\n<button class=\"btn btn-secondary btn-sm\" id=\"");
      out.print( randomNamespace );
      out.write("editButton\" type=\"button\">");
      out.print( LanguageUtil.get(request, "edit") );
      out.write("</button>\n\n");
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\tvar saveWorkflowDefinitionLink = A.rbind('saveWorkflowDefinitionLink', Liferay.WorkflowWeb, '");
          out.print( randomNamespace );
          out.write("');\n\n\tLiferay.delegateClick('");
          out.print( randomNamespace );
          out.write("saveButton', saveWorkflowDefinitionLink);\n\n\tvar toggleDefinitionLinkEditionMode = A.rbind('toggleDefinitionLinkEditionMode', Liferay.WorkflowWeb, '");
          out.print( randomNamespace );
          out.write("');\n\n\tLiferay.delegateClick('");
          out.print( randomNamespace );
          out.write("editButton', toggleDefinitionLinkEditionMode);\n\n\tLiferay.delegateClick('");
          out.print( randomNamespace );
          out.write("cancelButton', toggleDefinitionLinkEditionMode);\n");
