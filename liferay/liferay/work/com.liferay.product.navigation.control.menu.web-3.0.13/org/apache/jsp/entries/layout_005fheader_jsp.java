...
public final class layout_005fheader_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResourceBundle layoutTypeResourceBundle = ResourceBundleUtil.getBundle("content.Language", locale, layoutTypeController.getClass());
      ...
      out.write("\n\n<li class=\"align-items-center control-menu-nav-item control-menu-nav-item-content\">\n\t<span class=\"control-menu-level-1-heading truncate-text\" data-qa-id=\"headerTitle\">");
      out.print( HtmlUtil.escape(layout.getName(locale)) );
      out.write("</span>&nbsp;<span class=\"text-muted truncate-text\">(");
      out.print( LanguageUtil.get(request, layoutTypeResourceBundle, "layout.types." + layout.getType()) );
      out.write(")</span>\n</li>");
    } catch (Throwable t) {
