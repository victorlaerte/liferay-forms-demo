...
public final class add_005fcontent_005ficon_jsp extends org.apache.jasper.runtime.HttpJspBase
...
addPanelURL.setWindowState(LiferayWindowState.EXCLUSIVE);
      ...
      out.print( LanguageUtil.get(request, "add") );
      out.write("\" class=\"control-menu-icon lfr-portal-tooltip product-menu-toggle sidenav-toggler\" data-content=\"body\" data-open-class=\"open-admin-panel\" data-qa-id=\"add\" data-target=\"#");
      out.print( portletNamespace );
      out.write("addPanelId\" data-title=\"");
      out.print( LanguageUtil.get(request, "add") );
      out.write("\" data-toggle=\"sidenav\" data-type=\"fixed-push\" data-type-mobile=\"fixed\" data-url=\"");
      out.print( addPanelURL.toString() );
