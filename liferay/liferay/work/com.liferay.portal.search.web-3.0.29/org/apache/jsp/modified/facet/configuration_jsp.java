...
JSONArray rangesJSONArray = modifiedFacetPortletPreferences.getRangesJSONArray();
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_aui_fieldset_0.setId( renderResponse.getNamespace() + "rangesId" );
            ...
            if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_aui_input_2.setCssClass("label-input");
              _jspx_th_aui_input_2.setLabel("label");
              _jspx_th_aui_input_2.setName( "label_" + i );
              _jspx_th_aui_input_2.setValue( jsonObject.getString("label") );
              ...
              _jspx_th_aui_input_3.setCssClass("range-input");
              _jspx_th_aui_input_3.setLabel("range");
              _jspx_th_aui_input_3.setName( "range_" + i );
              _jspx_th_aui_input_3.setValue( jsonObject.getString("range") );
              ...
              out.write("\n\n\t\t\t\t");
              //  aui:input
              com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
              _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
              _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
              _jspx_th_aui_input_4.setCssClass("ranges-input");
              _jspx_th_aui_input_4.setName( PortletPreferencesJspUtil.getInputName(ModifiedFacetPortletPreferences.PREFERENCE_KEY_RANGES) );
              _jspx_th_aui_input_4.setType("hidden");
              _jspx_th_aui_input_4.setValue( modifiedFacetPortletPreferences.getRangesString() );
              int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
              if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
                _jspx_tagPool_aui_input_value_type_name_cssClass_nobody.reuse(_jspx_th_aui_input_4);
                return;
              }
              _jspx_tagPool_aui_input_value_type_name_cssClass_nobody.reuse(_jspx_th_aui_input_4);
              out.write("\n\n\t\t\t\t");
              ...
              _jspx_th_aui_input_5.setName( "rangesIndexes" );
              _jspx_th_aui_input_5.setType("hidden");
              _jspx_th_aui_input_5.setValue( StringUtil.merge(rangesIndexes) );
  ...
  private boolean _jspx_meth_aui_button_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_edit$1form$1footer_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  aui:button
    com.liferay.taglib.aui.ButtonTag _jspx_th_aui_button_0 = (com.liferay.taglib.aui.ButtonTag) _jspx_tagPool_aui_button_type_cssClass_nobody.get(com.liferay.taglib.aui.ButtonTag.class);
    _jspx_th_aui_button_0.setPageContext(_jspx_page_context);
    _jspx_th_aui_button_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_edit$1form$1footer_0);
    _jspx_th_aui_button_0.setCssClass("btn-lg");
    _jspx_th_aui_button_0.setType("submit");
    int _jspx_eval_aui_button_0 = _jspx_th_aui_button_0.doStartTag();
    if (_jspx_th_aui_button_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_aui_button_type_cssClass_nobody.reuse(_jspx_th_aui_button_0);
      return true;
    }
    _jspx_tagPool_aui_button_type_cssClass_nobody.reuse(_jspx_th_aui_button_0);
    return false;
  ...
  private boolean _jspx_meth_aui_script_1(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_script_1.setUse("liferay-search-modified-facet-configuration");
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n\tnew Liferay.Search.ModifiedFacetConfiguration(A.one(document.");
