...
FolderSearchFacetDisplayContext folderSearchFacetDisplayContext = (FolderSearchFacetDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT));
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( folderSearchFacetDisplayContext.isRenderNothing() );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setName( HtmlUtil.escapeAttribute(folderSearchFacetDisplayContext.getParameterName()) );
          _jspx_th_aui_input_0.setType("hidden");
          _jspx_th_aui_input_0.setValue( folderSearchFacetDisplayContext.getParameterValue() );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_panel$1container_0.setId( renderResponse.getNamespace() + "facetFolderPanelContainer" );
          ...
          if (_jspx_eval_liferay$1ui_panel$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_liferay$1ui_panel_0.setId( renderResponse.getNamespace() + "facetFolderPanel" );
              _jspx_th_liferay$1ui_panel_0.setMarkupView("lexicon");
              _jspx_th_liferay$1ui_panel_0.setPersistState( true );
              _jspx_th_liferay$1ui_panel_0.setTitle("folder");
              ...
              if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_aui_form_0.setName("folderFacetForm");
                ...
                if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_aui_input_1.setName( HtmlUtil.escapeAttribute(folderSearchFacetDisplayContext.getParameterName()) );
                  _jspx_th_aui_input_1.setType("hidden");
                  _jspx_th_aui_input_1.setValue( folderSearchFacetDisplayContext.getParameterValue() );
                  ...
                  _jspx_th_aui_input_2.setValue( folderSearchFacetDisplayContext.getParameterName() );
                  ...
                  if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    out.print( folderSearchFacetTermDisplayContext.getFolderId() );
                    out.write("\" id=\"");
                    ...
                    out.print( folderSearchFacetTermDisplayContext.isSelected() ? "checked" : StringPool.BLANK );
                    out.write(" />\n\n\t\t\t\t\t\t\t\t\t\t<span class=\"term-name ");
                    out.print( folderSearchFacetTermDisplayContext.isSelected() ? "facet-term-selected" : "facet-term-unselected" );
                    out.write("\">\n\t\t\t\t\t\t\t\t\t\t\t");
                    out.print( HtmlUtil.escape(folderSearchFacetTermDisplayContext.getDisplayName()) );
                    out.write("\n\t\t\t\t\t\t\t\t\t\t</span>\n\n\t\t\t\t\t\t\t\t\t\t");
                    //  c:if
                    com.liferay.taglib.core.IfTag _jspx_th_c_if_0 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
                    _jspx_th_c_if_0.setPageContext(_jspx_page_context);
                    _jspx_th_c_if_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
                    _jspx_th_c_if_0.setTest( folderSearchFacetTermDisplayContext.isFrequencyVisible() );
                    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
                    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      out.write("\n\t\t\t\t\t\t\t\t\t\t\t<small class=\"term-count\">\n\t\t\t\t\t\t\t\t\t\t\t\t(");
                      out.print( folderSearchFacetTermDisplayContext.getFrequency() );
                      out.write(")\n\t\t\t\t\t\t\t\t\t\t\t</small>\n\t\t\t\t\t\t\t\t\t\t");
                    }
                  ...
                  _jspx_th_c_if_1.setTest( !folderSearchFacetDisplayContext.isNothingSelected() );
                  int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
                  if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    out.write("\n\t\t\t\t\t\t");
                    if (_jspx_meth_aui_a_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_1, _jspx_page_context))
                      return;
                    out.write("\n\t\t\t\t\t");
                  }
  ...
  private boolean _jspx_meth_aui_a_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:a
    ...
    _jspx_th_aui_a_0.setCssClass("text-default");
    _jspx_th_aui_a_0.setHref("javascript:;");
    _jspx_th_aui_a_0.setOnClick("Liferay.Search.FacetUtil.clearSelections(event);");
