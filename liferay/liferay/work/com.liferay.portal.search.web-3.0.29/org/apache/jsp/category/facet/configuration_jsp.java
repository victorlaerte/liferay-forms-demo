      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_aui_input_2.setLabel("category-parameter-name");
            _jspx_th_aui_input_2.setName( PortletPreferencesJspUtil.getInputName(CategoryFacetPortletPreferences.PREFERENCE_KEY_PARAMETER_NAME) );
            _jspx_th_aui_input_2.setValue( categoryFacetPortletPreferences.getParameterName() );
            ...
            _jspx_th_aui_select_0.setName( PortletPreferencesJspUtil.getInputName(CategoryFacetPortletPreferences.PREFERENCE_KEY_DISPLAY_STYLE) );
            ...
            if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                _jspx_th_aui_option_0.setLabel(new String("cloud"));
                _jspx_th_aui_option_0.setSelected( categoryFacetPortletPreferences.isDisplayStyleCloud() );
                ...
                _jspx_th_aui_option_1.setLabel(new String("list"));
                _jspx_th_aui_option_1.setSelected( categoryFacetPortletPreferences.isDisplayStyleList() );
            ...
            _jspx_th_aui_input_3.setLabel("max-terms");
            _jspx_th_aui_input_3.setName( PortletPreferencesJspUtil.getInputName(CategoryFacetPortletPreferences.PREFERENCE_KEY_MAX_TERMS) );
            _jspx_th_aui_input_3.setValue( categoryFacetPortletPreferences.getMaxTerms() );
            ...
            out.write("\n\n\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_name_label_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset$1group_0);
            _jspx_th_aui_input_4.setLabel("frequency-threshold");
            _jspx_th_aui_input_4.setName( PortletPreferencesJspUtil.getInputName(CategoryFacetPortletPreferences.PREFERENCE_KEY_FREQUENCY_THRESHOLD) );
            _jspx_th_aui_input_4.setValue( categoryFacetPortletPreferences.getFrequencyThreshold() );
            int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
            if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_value_name_label_nobody.reuse(_jspx_th_aui_input_4);
              return;
            }
            _jspx_tagPool_aui_input_value_name_label_nobody.reuse(_jspx_th_aui_input_4);
            out.write("\n\n\t\t\t");
            ...
            _jspx_th_aui_input_5.setLabel("display-frequencies");
            _jspx_th_aui_input_5.setName( PortletPreferencesJspUtil.getInputName(CategoryFacetPortletPreferences.PREFERENCE_KEY_FREQUENCIES_VISIBLE) );
            _jspx_th_aui_input_5.setType("checkbox");
            _jspx_th_aui_input_5.setValue( categoryFacetPortletPreferences.isFrequenciesVisible() );
