...
AssetEntriesSearchFacetDisplayContext assetEntriesSearchFacetDisplayContext = (AssetEntriesSearchFacetDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT));
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( assetEntriesSearchFacetDisplayContext.isRenderNothing() );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setName( HtmlUtil.escapeAttribute(assetEntriesSearchFacetDisplayContext.getParameterName()) );
          _jspx_th_aui_input_0.setType("hidden");
          _jspx_th_aui_input_0.setValue( assetEntriesSearchFacetDisplayContext.getParameterValue() );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_panel$1container_0.setId( renderResponse.getNamespace() + "facetAssetEntriesPanelContainer" );
          ...
          if (_jspx_eval_liferay$1ui_panel$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_liferay$1ui_panel_0.setId( renderResponse.getNamespace() + "facetAssetEntriesPanel" );
              _jspx_th_liferay$1ui_panel_0.setMarkupView("lexicon");
              _jspx_th_liferay$1ui_panel_0.setPersistState( true );
              _jspx_th_liferay$1ui_panel_0.setTitle("type");
              ...
              if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_aui_form_0.setName("assetEntriesFacetForm");
                ...
                if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_aui_input_1.setName( HtmlUtil.escapeAttribute(assetEntriesSearchFacetDisplayContext.getParameterName()) );
                  _jspx_th_aui_input_1.setType("hidden");
                  _jspx_th_aui_input_1.setValue( assetEntriesSearchFacetDisplayContext.getParameterValue() );
                  ...
                  _jspx_th_aui_input_2.setValue( assetEntriesSearchFacetDisplayContext.getParameterName() );
                  ...
                  if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    out.print( assetEntriesSearchFacetTermDisplayContext.getAssetType() );
                    out.write("\" id=\"");
                    ...
                    out.print( assetEntriesSearchFacetTermDisplayContext.isSelected() ? "checked" : StringPool.BLANK );
                    out.write(" />\n\n\t\t\t\t\t\t\t\t\t\t<span class=\"term-name ");
                    out.print( assetEntriesSearchFacetTermDisplayContext.isSelected() ? "facet-term-selected" : "facet-term-unselected" );
                    out.write("\">\n\t\t\t\t\t\t\t\t\t\t\t");
                    out.print( HtmlUtil.escape(assetEntriesSearchFacetTermDisplayContext.getTypeName()) );
                    out.write("\n\t\t\t\t\t\t\t\t\t\t</span>\n\n\t\t\t\t\t\t\t\t\t\t");
                    //  c:if
                  ...
                  _jspx_th_c_if_1.setTest( !assetEntriesSearchFacetDisplayContext.isNothingSelected() );
