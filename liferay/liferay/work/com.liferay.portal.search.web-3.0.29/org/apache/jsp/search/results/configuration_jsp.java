      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_aui_input_2.setLabel("enable-highlighting");
            _jspx_th_aui_input_2.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_HIGHLIGHT_ENABLED) );
            _jspx_th_aui_input_2.setType("checkbox");
            _jspx_th_aui_input_2.setValue( searchResultsPortletPreferences.isHighlightEnabled() );
            ...
            _jspx_th_aui_input_3.setHelpMessage("display-selected-result-in-context-help");
            _jspx_th_aui_input_3.setLabel("display-selected-result-in-context");
            _jspx_th_aui_input_3.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_VIEW_IN_CONTEXT) );
            _jspx_th_aui_input_3.setType("checkbox");
            _jspx_th_aui_input_3.setValue( searchResultsPortletPreferences.isViewInContext() );
            ...
            _jspx_th_aui_input_4.setHelpMessage("display-results-in-document-form-help");
            _jspx_th_aui_input_4.setLabel("display-results-in-document-form");
            _jspx_th_aui_input_4.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_DISPLAY_IN_DOCUMENT_FORM) );
            _jspx_th_aui_input_4.setType("checkbox");
            _jspx_th_aui_input_4.setValue( searchResultsPortletPreferences.isDisplayInDocumentForm() );
            ...
            _jspx_th_aui_input_5.setLabel("pagination-start-parameter-name");
            _jspx_th_aui_input_5.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_PAGINATION_START_PARAMETER_NAME) );
            _jspx_th_aui_input_5.setValue( searchResultsPortletPreferences.getPaginationStartParameterName() );
            ...
            _jspx_th_aui_input_6.setLabel("pagination-delta");
            _jspx_th_aui_input_6.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_PAGINATION_DELTA) );
            _jspx_th_aui_input_6.setType("text");
            _jspx_th_aui_input_6.setValue( searchResultsPortletPreferences.getPaginationDelta() );
            ...
            _jspx_th_aui_input_7.setLabel("pagination-delta-parameter-name");
            _jspx_th_aui_input_7.setName( PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_PAGINATION_DELTA_PARAMETER_NAME) );
            _jspx_th_aui_input_7.setType("text");
            _jspx_th_aui_input_7.setValue( searchResultsPortletPreferences.getPaginationDeltaParameterName() );
