        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_aui_input_2.setLabel("keywords-parameter-name");
              _jspx_th_aui_input_2.setName( PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_KEYWORDS_PARAMETER_NAME) );
              _jspx_th_aui_input_2.setValue( searchBarPortletPreferences.getKeywordsParameterName() );
              ...
              _jspx_th_aui_select_0.setName( PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_SEARCH_SCOPE) );
              _jspx_th_aui_select_0.setValue( searchBarPortletPreferences.getSearchScopePreferenceString() );
              ...
              _jspx_th_aui_input_3.setLabel("scope-parameter-name");
              _jspx_th_aui_input_3.setName( PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_SCOPE_PARAMETER_NAME) );
              _jspx_th_aui_input_3.setValue( searchBarPortletPreferences.getScopeParameterName() );
              ...
              _jspx_th_aui_input_4.setLabel("destination-page");
              _jspx_th_aui_input_4.setName( PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_DESTINATION) );
              _jspx_th_aui_input_4.setValue( searchBarPortletPreferences.getDestinationString() );
              ...
              _jspx_th_aui_input_5.setHelpMessage("use-advanced-search-syntax-help");
              _jspx_th_aui_input_5.setName( PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_USE_ADVANCED_SEARCH_SYNTAX) );
              _jspx_th_aui_input_5.setType("checkbox");
              _jspx_th_aui_input_5.setValue( searchBarPortletPreferences.isUseAdvancedSearchSyntax() );
