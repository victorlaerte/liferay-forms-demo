package org.apache.jsp.search.options;
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_aui_input_2.setHelpMessage("allow-empty-searches-help");
              _jspx_th_aui_input_2.setLabel("allow-empty-searches");
              _jspx_th_aui_input_2.setName( PortletPreferencesJspUtil.getInputName(SearchOptionsPortletPreferences.PREFERENCE_KEY_ALLOW_EMPTY_SEARCHES) );
              _jspx_th_aui_input_2.setType("checkbox");
              _jspx_th_aui_input_2.setValue( searchOptionsPortletPreferences.isAllowEmptySearches() );
              ...
              _jspx_th_aui_input_3.setHelpMessage("basic-facet-selection-help");
              _jspx_th_aui_input_3.setLabel("basic-facet-selection");
              _jspx_th_aui_input_3.setName( PortletPreferencesJspUtil.getInputName(SearchOptionsPortletPreferences.PREFERENCE_KEY_BASIC_FACET_SELECTION) );
              _jspx_th_aui_input_3.setType("checkbox");
              _jspx_th_aui_input_3.setValue( searchOptionsPortletPreferences.isBasicFacetSelection() );
