package org.apache.jsp.site.facet;
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_aui_input_2.setLabel("site-parameter-name");
            _jspx_th_aui_input_2.setName( PortletPreferencesJspUtil.getInputName(SiteFacetPortletPreferences.PREFERENCE_KEY_PARAMETER_NAME) );
            _jspx_th_aui_input_2.setValue( siteFacetPortletPreferences.getParameterName() );
            ...
            _jspx_th_aui_input_3.setName( PortletPreferencesJspUtil.getInputName(SiteFacetPortletPreferences.PREFERENCE_KEY_MAX_TERMS) );
            _jspx_th_aui_input_3.setValue( siteFacetPortletPreferences.getMaxTerms() );
            ...
            _jspx_th_aui_input_4.setName( PortletPreferencesJspUtil.getInputName(SiteFacetPortletPreferences.PREFERENCE_KEY_FREQUENCY_THRESHOLD) );
            _jspx_th_aui_input_4.setValue( siteFacetPortletPreferences.getFrequencyThreshold() );
            ...
            _jspx_th_aui_input_5.setName( PortletPreferencesJspUtil.getInputName(SiteFacetPortletPreferences.PREFERENCE_KEY_FREQUENCIES_VISIBLE) );
            _jspx_th_aui_input_5.setType("checkbox");
            _jspx_th_aui_input_5.setValue( siteFacetPortletPreferences.isFrequenciesVisible() );
