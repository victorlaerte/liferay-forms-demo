...
ScopeSearchFacetDisplayContext scopeSearchFacetDisplayContext = (ScopeSearchFacetDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT));
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( scopeSearchFacetDisplayContext.isRenderNothing() );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setName( HtmlUtil.escapeAttribute(scopeSearchFacetDisplayContext.getParameterName()) );
          _jspx_th_aui_input_0.setType("hidden");
          _jspx_th_aui_input_0.setValue( scopeSearchFacetDisplayContext.getParameterValue() );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_panel$1container_0.setId( renderResponse.getNamespace() + "facetScopePanelContainer" );
          ...
          if (_jspx_eval_liferay$1ui_panel$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_liferay$1ui_panel_0.setId( renderResponse.getNamespace() + "facetScopePanel" );
              _jspx_th_liferay$1ui_panel_0.setMarkupView("lexicon");
              _jspx_th_liferay$1ui_panel_0.setPersistState( true );
              _jspx_th_liferay$1ui_panel_0.setTitle("site");
              ...
              if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_aui_form_0.setName("siteFacetForm");
                ...
                if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_aui_input_1.setName( HtmlUtil.escapeAttribute(scopeSearchFacetDisplayContext.getParameterName()) );
                  _jspx_th_aui_input_1.setType("hidden");
                  _jspx_th_aui_input_1.setValue( scopeSearchFacetDisplayContext.getParameterValue() );
                  ...
                  _jspx_th_aui_input_2.setValue( scopeSearchFacetDisplayContext.getParameterName() );
                  ...
                  if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    out.print( scopeSearchFacetTermDisplayContext.getGroupId() );
                    out.write("\" id=\"");
                    ...
                    out.print( scopeSearchFacetTermDisplayContext.isSelected() ? "checked" : StringPool.BLANK );
                    out.write(" />\n\n\t\t\t\t\t\t\t\t\t\t<span class=\"term-name ");
                    out.print( scopeSearchFacetTermDisplayContext.isSelected() ? "facet-term-selected" : "facet-term-unselected" );
                    out.write("\">\n\t\t\t\t\t\t\t\t\t\t\t");
                    out.print( HtmlUtil.escape(scopeSearchFacetTermDisplayContext.getDescriptiveName()) );
                    out.write("\n\t\t\t\t\t\t\t\t\t\t</span>\n\n\t\t\t\t\t\t\t\t\t\t");
                    //  c:if
                    com.liferay.taglib.core.IfTag _jspx_th_c_if_0 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
                    _jspx_th_c_if_0.setPageContext(_jspx_page_context);
                    _jspx_th_c_if_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
                    _jspx_th_c_if_0.setTest( scopeSearchFacetTermDisplayContext.isShowCount() );
                    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
                    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      out.write("\n\t\t\t\t\t\t\t\t\t\t\t<small class=\"term-count\">\n\t\t\t\t\t\t\t\t\t\t\t\t(");
                      out.print( scopeSearchFacetTermDisplayContext.getCount() );
                      out.write(")\n\t\t\t\t\t\t\t\t\t\t\t</small>\n\t\t\t\t\t\t\t\t\t\t");
                    }
                  ...
                  _jspx_th_c_if_1.setTest( !scopeSearchFacetDisplayContext.isNothingSelected() );
