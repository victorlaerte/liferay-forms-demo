...
String rowHREF = (String)row.getParameter("rowHREF");
      ...
      _jspx_th_c_if_0.setTest( Validator.isNotNull(rowHREF) );
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( template.isSmallImage() );
        int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t<img alt=\"");
          out.print( HtmlUtil.escape(template.getName(locale)) );
          out.write("\" class=\"lfr-ddm-small-image-view\" src=\"");
      ...
      _jspx_th_c_if_1.setTest( Validator.isNotNull(rowHREF) );
