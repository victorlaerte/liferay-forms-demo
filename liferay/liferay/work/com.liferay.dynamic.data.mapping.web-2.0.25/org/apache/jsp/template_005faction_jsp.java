...
DDMTemplate template = (DDMTemplate)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.UPDATE) );
          ...
          if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_1.setValue( String.valueOf(template.getGroupId()) );
              ...
              _jspx_th_portlet_param_2.setName("templateId");
              _jspx_th_portlet_param_2.setValue( String.valueOf(template.getTemplateId()) );
              ...
              _jspx_th_portlet_param_3.setValue( template.getType() );
              ...
              _jspx_th_portlet_param_4.setName("structureAvailableFields");
              _jspx_th_portlet_param_4.setValue( renderResponse.getNamespace() + "getAvailableFields" );
          ...
          _jspx_th_c_if_1.setTest( DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.PERMISSIONS) );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1security_permissionsURL_0.setModelResource( DDMTemplatePermission.getTemplateModelResourceName(template.getResourceClassNameId()) );
            _jspx_th_liferay$1security_permissionsURL_0.setModelResourceDescription( template.getName(locale) );
            _jspx_th_liferay$1security_permissionsURL_0.setResourcePrimKey( String.valueOf(template.getTemplateId()) );
          ...
          _jspx_th_c_if_2.setTest( ddmDisplay.isShowAddButton(themeDisplay.getScopeGroup()) && DDMTemplatePermission.containsAddTemplatePermission(permissionChecker, scopeGroupId, template.getClassNameId(), template.getResourceClassNameId()) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_renderURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_6.setName("templateId");
              _jspx_th_portlet_param_6.setValue( String.valueOf(template.getTemplateId()) );
              ...
              _jspx_th_portlet_param_7.setName("classNameId");
              _jspx_th_portlet_param_7.setValue( String.valueOf(template.getClassNameId()) );
              ...
              _jspx_th_portlet_param_8.setName("classPK");
              _jspx_th_portlet_param_8.setValue( String.valueOf(template.getClassPK()) );
              ...
              _jspx_th_portlet_param_9.setValue( String.valueOf(template.getResourceClassNameId()) );
            ...
            _jspx_th_liferay$1ui_icon_2.setUrl( copyURL );
          ...
          _jspx_th_c_if_3.setTest( DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.DELETE) );
          ...
          if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_actionURL_0.setName("deleteTemplate");
            _jspx_th_portlet_actionURL_0.setVar("deleteURL");
            int _jspx_eval_portlet_actionURL_0 = _jspx_th_portlet_actionURL_0.doStartTag();
            if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t");
              if (_jspx_meth_portlet_param_10((javax.servlet.jsp.tagext.JspTag) _jspx_th_portlet_actionURL_0, _jspx_page_context))
                return;
              out.write("\n\t\t\t");
              //  portlet:param
              ...
              _jspx_th_portlet_param_11.setName("templateId");
              _jspx_th_portlet_param_11.setValue( String.valueOf(template.getTemplateId()) );
              ...
              _jspx_th_portlet_param_12.setName("classNameId");
              _jspx_th_portlet_param_12.setValue( String.valueOf(classNameId) );
              ...
              _jspx_th_portlet_param_13.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_portlet_actionURL_0);
              _jspx_th_portlet_param_13.setName("classPK");
              _jspx_th_portlet_param_13.setValue( String.valueOf(classPK) );
              ...
              _jspx_th_portlet_param_14.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_portlet_actionURL_0);
              _jspx_th_portlet_param_14.setName("resourceClassNameId");
              _jspx_th_portlet_param_14.setValue( String.valueOf(resourceClassNameId) );
  ...
  private boolean _jspx_meth_portlet_param_5(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_5.setValue("/copy_template.jsp");
  ...
  private boolean _jspx_meth_portlet_param_10(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:param
    ...
    _jspx_th_portlet_param_10.setValue("/view_template.jsp");
