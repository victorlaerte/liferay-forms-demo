...
if (scopeTemplateType.equals(DDMTemplateConstants.TEMPLATE_TYPE_DISPLAY)) {
	...
	templateTypeValue = DDMTemplateConstants.TEMPLATE_TYPE_FORM;
      ...
      _jspx_th_liferay$1ui_error_0.setException( NoSuchStructureException.class );
      _jspx_th_liferay$1ui_error_0.setMessage("the-structure-could-not-be-found");
      ...
      _jspx_th_liferay$1ui_error_1.setException( PortletPreferencesException.MustBeStrict.class );
      _jspx_th_liferay$1ui_error_1.setMessage("portlet-preferences-are-not-configured-properly");
