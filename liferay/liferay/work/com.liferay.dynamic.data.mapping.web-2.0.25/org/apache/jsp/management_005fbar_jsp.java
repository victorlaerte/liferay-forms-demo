...
if (scopeTemplateType.equals(DDMTemplateConstants.TEMPLATE_TYPE_DISPLAY)) {
	...
	templateTypeValue = DDMTemplateConstants.TEMPLATE_TYPE_FORM;
      ...
      _jspx_th_clay_management$1toolbar_0.setActionDropdownItems( ddmDisplayContext.getActionItemsDropdownItems("deleteStructures") );
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( ddmDisplayContext.getClearResultsURL() );
      _jspx_th_clay_management$1toolbar_0.setComponentId("ddmStructureManagementToolbar");
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( ddmDisplayContext.getStructureCreationMenu() );
      ...
      _jspx_th_clay_management$1toolbar_0.setSearchActionURL( ddmDisplayContext.getStructureSearchActionURL() );
      ...
      _jspx_th_clay_management$1toolbar_0.setSelectable( !user.isDefaultUser() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("entriesContainer', form);\n\n\t\t\tform.attr('method', 'post');\n\t\t\tform.fm('deleteStructureIds').val(Liferay.Util.listCheckedExcept(searchContainer, '");
