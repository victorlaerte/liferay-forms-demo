...
public final class sites_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String groupId = String.valueOf(group.getGroupId());
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_when_0.setTest( GetterUtil.getBoolean(group.getTypeSettingsProperty("syncEnabled"), !group.isCompany()) );
			...
			String editDefaultFilePermissionsDialogURL = "javascript:" + renderResponse.getNamespace() + "editDefaultFilePermissions(" + groupId + ");";
              ...
              _jspx_th_liferay$1ui_icon_0.setMessage("default-file-permissions");
              _jspx_th_liferay$1ui_icon_0.setUrl( editDefaultFilePermissionsDialogURL );
              ...
              _jspx_th_portlet_actionURL_0.setName("updateSites");
              _jspx_th_portlet_actionURL_0.setVar("disableSiteURL");
              ...
              if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_portlet_param_1.setName("enabled");
                _jspx_th_portlet_param_1.setValue( Boolean.FALSE.toString() );
                ...
                _jspx_th_portlet_param_2.setName("groupIds");
                _jspx_th_portlet_param_2.setValue( groupId );
              ...
              _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
              java.lang.String disableSiteURL = null;
              disableSiteURL = (java.lang.String) _jspx_page_context.findAttribute("disableSiteURL");
              out.write("\n\n\t\t\t");
              ...
              _jspx_th_liferay$1ui_icon$1delete_0.setConfirmation("disabling-a-sync-site-will-delete-all-associated-files-from-all-clients");
              _jspx_th_liferay$1ui_icon$1delete_0.setLabel( true );
              _jspx_th_liferay$1ui_icon$1delete_0.setMessage("disable-sync-site");
              _jspx_th_liferay$1ui_icon$1delete_0.setUrl( disableSiteURL );
            ...
            if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_actionURL_1.setName("updateSites");
              _jspx_th_portlet_actionURL_1.setVar("enableSiteURL");
              ...
              if (_jspx_eval_portlet_actionURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_portlet_param_4.setName("enabled");
                ...
                _jspx_th_portlet_param_5.setName("groupIds");
                _jspx_th_portlet_param_5.setValue( groupId );
              ...
              _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_1);
              java.lang.String enableSiteURL = null;
              enableSiteURL = (java.lang.String) _jspx_page_context.findAttribute("enableSiteURL");
              out.write("\n\n\t\t\t");
              //  liferay-ui:icon
              ...
              _jspx_th_liferay$1ui_icon_1.setMessage("enable-sync-site");
              _jspx_th_liferay$1ui_icon_1.setUrl( enableSiteURL );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("editDefaultFilePermissions(groupId) {\n\t\tvar A = AUI();\n\n\t\tLiferay.Util.openWindow(\n\t\t\t{\n\t\t\t\tdialog: {\n\t\t\t\t\tdestroyOnHide: true,\n\t\t\t\t\ton: {\n\t\t\t\t\t\tdestroy: function() {\n\t\t\t\t\t\t\tLiferay.Portlet.refresh('#p_p_id");
          ...
          _jspx_th_portlet_renderURL_0.setVar("editDefaultFilePermissionsURL");
          ...
          _jspx_tagPool_portlet_renderURL_windowState_var.reuse(_jspx_th_portlet_renderURL_0);
          java.lang.String editDefaultFilePermissionsURL = null;
          editDefaultFilePermissionsURL = (java.lang.String) _jspx_page_context.findAttribute("editDefaultFilePermissionsURL");
          out.write("\n\n\t\t\t\turi: A.Lang.sub(\n\t\t\t\t\tdecodeURIComponent('");
          out.print( editDefaultFilePermissionsURL );
          out.write("'),\n\t\t\t\t\t{\n\t\t\t\t\t\tgroupId: groupId\n\t\t\t\t\t}\n\t\t\t\t)\n\t\t\t}\n\t\t);\n\t}\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("default-file-permissions");
  ...
  private boolean _jspx_meth_portlet_param_6(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_6.setName("groupIds");
    _jspx_th_portlet_param_6.setValue("{groupId}");
  ...
  private boolean _jspx_meth_portlet_param_7(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_7.setValue("/edit_default_file_permissions.jsp");
