...
public final class documents_005fand_005fmedia_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean directoryIndexingEnabled = PropertiesParamUtil.getBoolean(typeSettingsProperties, request, "directoryIndexingEnabled");
      ...
      _jspx_th_aui_input_0.setHelpMessage( LanguageUtil.format(request, "directory-indexing-help", new Object[] {HtmlUtil.escape(group.getDescriptiveName(themeDisplay.getLocale())), themeDisplay.getPortalURL() + "/documents" + group.getFriendlyURL()}, false) );
      _jspx_th_aui_input_0.setLabel("enable-directory-indexing");
      _jspx_th_aui_input_0.setName("TypeSettingsProperties--directoryIndexingEnabled--");
      _jspx_th_aui_input_0.setType("toggle-switch");
      _jspx_th_aui_input_0.setValue( directoryIndexingEnabled );
