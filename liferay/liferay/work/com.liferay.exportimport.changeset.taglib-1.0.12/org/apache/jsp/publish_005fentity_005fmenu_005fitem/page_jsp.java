package org.apache.jsp.publish_005fentity_005fmenu_005fitem;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/publish_entity_menu_item/init.jsp");
...
if (entityGroupId != 0) {
	...
	showMenuItem = ChangesetTaglibDisplayContext.isShowPublishMenuItem(group, portletDisplay.getId(), className, uuid);
      ...
      _jspx_th_c_if_0.setTest( GroupPermissionUtil.contains(permissionChecker, themeDisplay.getScopeGroup(), ActionKeys.EXPORT_IMPORT_PORTLET_INFO) && showMenuItem );
	...
	portletURL.setParameter("portletId", portletDisplay.getId());
        ...
        _jspx_th_liferay$1ui_icon$1delete_0.setConfirmation("are-you-sure-you-want-to-publish-to-live");
        _jspx_th_liferay$1ui_icon$1delete_0.setMessage("publish-to-live");
        _jspx_th_liferay$1ui_icon$1delete_0.setUrl( portletURL.toString() );
