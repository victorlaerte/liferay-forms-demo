...
public final class google_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.release();
...
String googleClientSecret = googleAuthorizationConfiguration.clientSecret();
      ...
      _jspx_th_liferay$1ui_error_0.setKey("googleClientIdInvalid");
      _jspx_th_liferay$1ui_error_0.setMessage("the-google-client-id-is-invalid");
      ...
      _jspx_th_liferay$1ui_error_1.setKey("googleClientSecretInvalid");
      _jspx_th_liferay$1ui_error_1.setMessage("the-google-client-secret-is-invalid");
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setId( PortalUtil.generateRandomKey(request, "portal_settings_authentication_google") );
        _jspx_th_aui_input_0.setName( ActionRequest.ACTION_NAME );
        _jspx_th_aui_input_0.setType("hidden");
        _jspx_th_aui_input_0.setValue(new String("/portal_settings/google"));
        ...
        _jspx_th_aui_input_1.setName( PortalSettingsGoogleConstants.FORM_PARAMETER_NAMESPACE + "enabled" );
        _jspx_th_aui_input_1.setType("checkbox");
        _jspx_th_aui_input_1.setValue( googleAuthEnabled );
        ...
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_2 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_2.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_2.setLabel("google-client-id");
        _jspx_th_aui_input_2.setName( PortalSettingsGoogleConstants.FORM_PARAMETER_NAMESPACE + "clientId" );
        _jspx_th_aui_input_2.setType("text");
        _jspx_th_aui_input_2.setValue( googleClientId );
        _jspx_th_aui_input_2.setWrapperCssClass("lfr-input-text-container");
        int _jspx_eval_aui_input_2 = _jspx_th_aui_input_2.doStartTag();
        if (_jspx_th_aui_input_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.reuse(_jspx_th_aui_input_2);
          return;
        }
        _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.reuse(_jspx_th_aui_input_2);
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_3 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_3.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_3.setLabel("google-client-secret");
        _jspx_th_aui_input_3.setName( PortalSettingsGoogleConstants.FORM_PARAMETER_NAMESPACE + "clientSecret" );
        _jspx_th_aui_input_3.setType("text");
        _jspx_th_aui_input_3.setValue( googleClientSecret );
        _jspx_th_aui_input_3.setWrapperCssClass("lfr-input-text-container");
        int _jspx_eval_aui_input_3 = _jspx_th_aui_input_3.doStartTag();
        if (_jspx_th_aui_input_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.reuse(_jspx_th_aui_input_3);
          return;
        }
        _jspx_tagPool_aui_input_wrapperCssClass_value_type_name_label_nobody.reuse(_jspx_th_aui_input_3);
        out.write("\n\n\t");
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_actionURL_0.setName("/portal_settings/google_delete");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("google");
