...
String fullName = namespace.concat(HtmlUtil.escapeAttribute(name));
      ...
      out.write("\" class=\"container container-no-gutters-sm-down container-view form ");
      out.print( cssClass );
      out.write(' ');
      ...
      _jspx_th_c_if_0.setTest( !themeDisplay.isStatePopUp() );
      int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t\t<div class=\"sheet ");
        out.print( fluid ? StringPool.BLANK : "sheet-lg" );
        out.write("\">\n\t");
      }
      ...
      _jspx_th_aui_input_0.setName("formDate");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( System.currentTimeMillis() );
