...
String userInitials = (String)request.getAttribute("liferay-frontend:card:userInitials");
      ...
      if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_2.setTest( Validator.isNotNull(portraitURL) );
        ...
        if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_a_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_2);
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.print( colorCssClass );
          out.write("\">\n\t\t\t<span class=\"icon-xl user-vertical-card-initials\">");
          out.print( userInitials );
          out.write("</span>\n\t\t</div>\n\t");
        }
      ...
      _jspx_th_c_if_1.setTest( Validator.isNotNull(actionJsp) || Validator.isNotNull(footer) || Validator.isNotNull(header) || Validator.isNotNull(subtitle) || Validator.isNotNull(title) );
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_if_2.setTest( Validator.isNotNull(header) );
        ...
        _jspx_th_c_if_3.setTest( Validator.isNotNull(title) );
        ...
        if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_a_1.setTitle( HtmlUtil.escapeAttribute(title) );
        ...
        _jspx_th_c_if_4.setTest( Validator.isNotNull(subtitle) );
        ...
        _jspx_th_c_if_5.setTest( Validator.isNotNull(footer) );
        ...
        _jspx_th_c_if_6.setTest( Validator.isNotNull(actionJspBuffer) );
      ...
      if (_jspx_eval_c_choose_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_3.setTest( (rowChecker != null) && (resultRow != null) );
        ...
        if (_jspx_eval_c_when_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1util_buffer_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_3);
          ...
          _jspx_th_c_if_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_3);
          _jspx_th_c_if_7.setTest( Validator.isNotNull(checkboxInput) );
        ...
        _jspx_th_c_when_4.setTest( showCheckbox );
