package org.apache.jsp.card.image_005fcard;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/card/image_card/init.jsp");
...
String imageUrl = (String)request.getAttribute("liferay-frontend:image-card:imageUrl");
      ...
      out.write(">\n\t<div>\n\t\t<div class=\"card\">\n\t\t\t<div class=\"aspect-ratio aspect-ratio-bg-center aspect-ratio-bg-cover\" style=\"");
      out.print( "background-image: url('" + imageUrl + "')" );
      out.write("\">\n\t\t\t\t<img alt=\"\" class=\"");
      out.print( imageCSSClass );
      out.write(" sr-only\" src=\"");
      out.print( imageUrl );
      out.write("\" />\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>");
    } catch (Throwable t) {
