package org.apache.jsp.sidebar_005fpanel;
...
public final class end_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/sidebar_panel/init.jsp");
...
String searchContainerId = (String)request.getAttribute("liferay-frontend:sidebar-panel:searchContainerId");
      ...
      _jspx_th_c_if_0.setTest( (resourceURL != null) && Validator.isNotNull(searchContainerId) );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_script_0.setUse("liferay-sidebar-panel");
        ...
        if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.print( namespace );
            out.write("',\n\t\t\t\tresourceUrl: '");
            out.print( resourceURL );
            out.write("',\n\t\t\t\tsearchContainerId: '");
            out.print( namespace + searchContainerId );
            out.write("',\n\t\t\t\ttargetNode: '#");
            out.print( namespace );
            out.write("sidebarPanel'\n\t\t\t}\n\t\t);\n\t");
