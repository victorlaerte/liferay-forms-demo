package org.apache.jsp.management_005fbar_005ffilter;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/management_bar_filter/init.jsp");
...
String value = (String)request.getAttribute("liferay-frontend:management-bar-filter:value");
      ...
      _jspx_th_c_if_0.setTest( managementBarFilterItems.size() > 0 );
      int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t<li class=\"dropdown ");
        out.print( disabled ? "disabled" : StringPool.BLANK );
        out.write("\">\n\t\t<a aria-expanded=\"true\" class=\"dropdown-toggle\" data-qa-id=\"filter");
        out.print( Validator.isNotNull(label) ? label : StringPool.BLANK );
        out.write("\" data-toggle=\"");
        out.print( disabled ? StringPool.BLANK : "dropdown" );
        out.write("\" href=\"javascript:;\">\n\t\t\t<span class=\"management-bar-item-title\">\n\t\t\t\t");
        //  c:if
        com.liferay.taglib.core.IfTag _jspx_th_c_if_1 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
        _jspx_th_c_if_1.setPageContext(_jspx_page_context);
        _jspx_th_c_if_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        _jspx_th_c_if_1.setTest( Validator.isNotNull(label) );
        ...
        _jspx_th_liferay$1ui_message_1.setKey( HtmlUtil.escape(value) );
        ...
        if (_jspx_meth_aui_icon_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_0, _jspx_page_context))
          return;
        out.write("\n\t\t</a>\n\n\t\t<ul class=\"dropdown-menu\" data-qa-id=\"filter");
        out.print( Validator.isNotNull(label) ? label : StringPool.BLANK );
        out.write("Values\">\n\n\t\t\t");
        ...
        out.write("\n\n\t\t\t\t<li class=\"");
        out.print( managementBarFilterItem.isActive() ? "active" : StringPool.BLANK );
        out.write("\">\n\t\t\t\t\t");
        //  aui:a
        ...
        _jspx_th_aui_a_0.setHref( managementBarFilterItem.getUrl() );
        _jspx_th_aui_a_0.setId( Validator.isNotNull(managementBarFilterItem.getId()) ? managementBarFilterItem.getId() : StringPool.BLANK );
        _jspx_th_aui_a_0.setLabel( managementBarFilterItem.getLabel() );
