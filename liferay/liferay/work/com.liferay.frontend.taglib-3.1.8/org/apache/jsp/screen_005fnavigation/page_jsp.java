...
List<ScreenNavigationEntry> screenNavigationEntries = (List<ScreenNavigationEntry>)request.getAttribute("liferay-frontend:screen-navigation:screenNavigationEntries");
      ...
      _jspx_th_c_if_0.setTest( screenNavigationCategories.size() > 1 );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n\n\t\t\t\t\t\t<li class=\"nav-item\">\n\t\t\t\t\t\t\t<a class=\"nav-link ");
        out.print( Objects.equals(selectedScreenNavigationCategory.getCategoryKey(), screenNavigationCategory.getCategoryKey()) ? "active" : StringPool.BLANK );
        out.write("\" href=\"");
        out.print( screenNavigationCategoryURL.toString() );
        out.write('"');
        out.write('>');
        out.print( screenNavigationCategory.getLabel(themeDisplay.getLocale()) );
        out.write("</a>\n\t\t\t\t\t\t</li>\n\n\t\t\t\t\t");
      ...
      _jspx_th_c_if_1.setTest( screenNavigationEntries.size() > 1 );
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_message_0.setKey( selectedScreenNavigationEntry.getEntryKey() );
        ...
        out.write("\" href=\"");
        out.print( screenNavigationEntryURL );
        out.write('"');
        out.write('>');
