...
private static String _processColumn(String changedLine) {
  ...
  static {
    ...
    _jspx_dependants.add("/diff/init.jsp");
...
List<DiffResult> targetResults = diffResults[1];
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( !sourceResults.isEmpty() );
        int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t<table class=\"table table-bordered table-hover table-striped\" id=\"taglib-diff-results\">\n\t\t\t\t<tr>\n\t\t\t\t\t<td>\n\t\t\t\t\t\t");
          out.print( HtmlUtil.escape(sourceName) );
          out.write("\n\t\t\t\t\t</td>\n\t\t\t\t\t<td>\n\t\t\t\t\t\t");
          out.print( HtmlUtil.escape(targetName) );
          out.write("\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\n\t\t\t\t");
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_2.setArguments( new Object[] {HtmlUtil.escape(sourceName), HtmlUtil.escape(targetName)} );
          _jspx_th_liferay$1ui_message_2.setKey("there-are-no-differences-between-x-and-x");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("line");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("line");
