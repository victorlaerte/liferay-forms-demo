...
import com.liferay.layout.type.controller.link.to.page.internal.display.context.LinkToPageLayoutTypeControllerDisplayContext;
...
public final class link_005fto_005flayout_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/layout/edit/init.jsp");
...
LinkToPageLayoutTypeControllerDisplayContext linkToPageLayoutTypeControllerDisplayContext = new LinkToPageLayoutTypeControllerDisplayContext(liferayPortletRequest, liferayPortletResponse);
      ...
      _jspx_th_aui_input_0.setName("TypeSettingsProperties--groupId--");
      _jspx_th_aui_input_0.setType("hidden");
      _jspx_th_aui_input_0.setValue( (selLayout == null) ? StringPool.BLANK : selLayout.getGroupId() );
      ...
      _jspx_th_aui_input_1.setName("TypeSettingsProperties--privateLayout--");
      _jspx_th_aui_input_1.setType("hidden");
      _jspx_th_aui_input_1.setValue( (selLayout == null) ? StringPool.BLANK : selLayout.isPrivateLayout() );
      ...
      _jspx_th_aui_input_2.setLabel("link-to-layout");
      _jspx_th_aui_input_2.setName("linkToLayoutName");
      _jspx_th_aui_input_2.setType("resource");
      _jspx_th_aui_input_2.setValue( linkToPageLayoutTypeControllerDisplayContext.getLinkToLayoutName() );
      ...
      _jspx_th_aui_input_3.setName("linkToLayoutUuid");
      _jspx_th_aui_input_3.setType("hidden");
      _jspx_th_aui_input_3.setValue( linkToPageLayoutTypeControllerDisplayContext.getLinkToLayoutUuid() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectLayoutButton').on(\n\t\t\t'click',\n\t\t\tfunction(event) {\n\t\t\t\tevent.preventDefault();\n\n\t\t\t\tvar itemSelectorDialog = new A.LiferayItemSelectorDialog(\n\t\t\t\t\t{\n\t\t\t\t\t\teventName: '");
          out.print( linkToPageLayoutTypeControllerDisplayContext.getEventName() );
          out.write("',\n\t\t\t\t\t\ton: {\n\t\t\t\t\t\t\tselectedItemChange: function(event) {\n\t\t\t\t\t\t\t\tvar selectedItem = event.newVal;\n\n\t\t\t\t\t\t\t\tvar linkToLayoutName = A.one('#");
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("linkToLayoutName');\n\t\t\t\t\t\t\t\tvar linkToLayoutUuid = A.one('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("linkToLayoutUuid');\n\n\t\t\t\t\t\t\t\tif (selectedItem) {\n\t\t\t\t\t\t\t\t\tlinkToLayoutName.val(selectedItem.name);\n\t\t\t\t\t\t\t\t\tlinkToLayoutUuid.val(selectedItem.id);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t},\n\t\t\t\t\t\t'strings.add': '");
          ...
          if (_jspx_meth_liferay$1ui_message_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n\t\t\t\t\t\turl: '");
          out.print( linkToPageLayoutTypeControllerDisplayContext.getItemSelectorURL() );
  ...
  private boolean _jspx_meth_aui_button_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setName("selectLayoutButton");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("select-layout");
