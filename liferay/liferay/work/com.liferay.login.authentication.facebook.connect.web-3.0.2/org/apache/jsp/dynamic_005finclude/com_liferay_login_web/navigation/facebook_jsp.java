...
public final class facebook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_portlet_renderURL_0.setVar("loginRedirectURL");
...
String taglibOpenFacebookConnectLoginWindow = "javascript:var facebookConnectLoginWindow = window.open('" + URLCodec.encodeURL(facebookAuthURL) + "', 'facebook', 'align=center,directories=no,height=560,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,toolbar=no,width=1000'); void(''); facebookConnectLoginWindow.focus();";
      ...
      _jspx_th_liferay$1ui_icon_0.setIconCssClass("icon-facebook");
      _jspx_th_liferay$1ui_icon_0.setMessage("facebook");
      _jspx_th_liferay$1ui_icon_0.setUrl( taglibOpenFacebookConnectLoginWindow );
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("/login/login_redirect");
