...
if (selLayout != null) {
	selectedPortletId = GetterUtil.getString(selLayout.getTypeSettingsProperty("fullPageApplicationPortlet"));
      ...
      _jspx_th_aui_select_0.setLabel( LanguageUtil.get(resourceBundle, "full-page-application") );
      _jspx_th_aui_select_0.setName("TypeSettingsProperties--fullPageApplicationPortlet--");
	...
	for (Portlet portlet : portlets) {
          ...
          _jspx_th_aui_option_0.setLabel( PortalUtil.getPortletLongTitle(portlet, application, locale) );
          _jspx_th_aui_option_0.setSelected( Objects.equals(selectedPortletId, portlet.getPortletId()) );
          _jspx_th_aui_option_0.setValue( portlet.getPortletId() );
