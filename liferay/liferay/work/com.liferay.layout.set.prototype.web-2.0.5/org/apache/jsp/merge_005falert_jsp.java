...
int mergeFailCount = SitesUtil.getMergeFailCount(layoutSetPrototype);
	...
	String randomNamespace = PortalUtil.generateRandomKey(request, "portlet_layout_set_prototypes_merge_alert") + StringPool.UNDERLINE;
        ...
        _jspx_th_portlet_actionURL_0.setName("resetMergeFailCount");
        ...
        if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_param_0.setName("layoutSetPrototypeId");
          _jspx_th_portlet_param_0.setValue( String.valueOf(layoutSetPrototype.getLayoutSetPrototypeId()) );
