...
Group group = layoutSetPrototype.getGroup();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( LayoutSetPrototypePermissionUtil.contains(permissionChecker, layoutSetPrototypeId, ActionKeys.UPDATE) );
		...
		if (Validator.isNotNull(portletId)) {
            ...
            _jspx_th_c_if_1.setTest( Validator.isNotNull(siteAdministrationURL) );
            ...
            if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_liferay$1ui_icon_0.setMessage("manage");
              _jspx_th_liferay$1ui_icon_0.setMethod("get");
              _jspx_th_liferay$1ui_icon_0.setUrl( siteAdministrationURL.toString() );
          ...
          _jspx_th_c_if_2.setTest( LayoutSetPrototypePermissionUtil.contains(permissionChecker, layoutSetPrototypeId, ActionKeys.PERMISSIONS) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1security_permissionsURL_0.setModelResource( LayoutSetPrototype.class.getName() );
            _jspx_th_liferay$1security_permissionsURL_0.setModelResourceDescription( layoutSetPrototype.getName(locale) );
            _jspx_th_liferay$1security_permissionsURL_0.setResourcePrimKey( String.valueOf(layoutSetPrototypeId) );
          ...
          _jspx_th_c_if_3.setTest( LayoutSetPrototypePermissionUtil.contains(permissionChecker, layoutSetPrototypeId, ActionKeys.DELETE) );
          ...
          if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_1.setValue( String.valueOf(layoutSetPrototypeId) );
            ...
            _jspx_th_liferay$1ui_icon$1delete_0.setUrl( deleteLayoutSetPrototypesURL );
