...
IFramePortletInstanceConfiguration iFramePortletInstanceConfiguration = iFrameDisplayContext.getIFramePortletInstanceConfiguration();
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( iFramePortletInstanceConfiguration.auth() && Validator.isNull(iFrameDisplayContext.getUserName()) && !themeDisplay.isSignedIn() );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.alt()) );
          out.write("\" border=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.border()) );
          out.write("\" bordercolor=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.bordercolor()) );
          out.write("\" frameborder=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.frameborder()) );
          out.write("\" height=\"");
          out.print( iFramePortletInstanceConfiguration.resizeAutomatically() ? StringPool.BLANK : HtmlUtil.escapeAttribute(iFrameDisplayContext.getHeight()) );
          out.write("\" hspace=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.hspace()) );
          out.write("\" id=\"");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_otherwise_0, _jspx_page_context))
            return;
          out.write("iframe\" longdesc=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.longdesc()) );
          out.write("\" name=\"");
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_otherwise_0, _jspx_page_context))
            return;
          out.write("iframe\" onload=\"");
          out.print( iFramePortletInstanceConfiguration.dynamicUrlEnabled() ? renderResponse.getNamespace() + "monitorIframe();" : StringPool.BLANK );
          out.write("\" scrolling=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.scrolling()) );
          out.write("\" src=\"");
          out.print( HtmlUtil.escapeHREF(iFrameDisplayContext.getIframeSrc()) );
          out.write("\" title=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.title()) );
          out.write("\" vspace=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.vspace()) );
          out.write("\" width=\"");
          out.print( HtmlUtil.escapeAttribute(iFramePortletInstanceConfiguration.width()) );
          out.write("\">\n\t\t\t\t");
          //  liferay-ui:message
          ...
          _jspx_th_liferay$1ui_message_1.setArguments( HtmlUtil.escape(iFrameDisplayContext.getIframeSrc()) );
          _jspx_th_liferay$1ui_message_1.setKey("your-browser-does-not-support-inline-frames-or-is-currently-configured-not-to-display-inline-frames.-content-can-be-viewed-at-actual-source-page-x");
      ...
      _jspx_th_c_if_0.setTest( iFramePortletInstanceConfiguration.dynamicUrlEnabled() );
        ...
        if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
              return;
            out.write("'];\n\n\t\t\t\tif (hash) {\n\t\t\t\t\tvar src = '';\n\n\t\t\t\t\tvar baseSrc = '");
            out.print( HtmlUtil.escapeJS(iFrameDisplayContext.getIframeBaseSrc()) );
      ...
      _jspx_th_aui_script_1.setUse("aui-autosize-iframe");
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.print( iFramePortletInstanceConfiguration.resizeAutomatically() );
          out.write("\n\t\t\t}\n\t\t);\n\n\t\tiframe.on(\n\t\t\t'load',\n\t\t\tfunction() {\n\t\t\t\tvar height = A.Plugin.AutosizeIframe.getContentHeight(iframe);\n\n\t\t\t\tif (height == null) {\n\t\t\t\t\theight = '");
          out.print( HtmlUtil.escapeJS(iFramePortletInstanceConfiguration.heightNormal()) );
          out.write("';\n\n\t\t\t\t\tif (themeDisplay.isStateMaximized()) {\n\t\t\t\t\t\theight = '");
          out.print( HtmlUtil.escapeJS(iFramePortletInstanceConfiguration.heightMaximized()) );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("please-sign-in-to-access-this-application");
  ...
  private boolean _jspx_meth_portlet_namespace_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_0);
