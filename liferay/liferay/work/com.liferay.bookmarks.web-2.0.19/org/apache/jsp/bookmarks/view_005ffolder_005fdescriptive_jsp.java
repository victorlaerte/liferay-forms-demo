...
public final class view_005ffolder_005fdescriptive_jsp extends org.apache.jasper.runtime.HttpJspBase
...
rowURL.setParameter("folderId", String.valueOf(folder.getFolderId()));
      ...
      out.print( folder.getDescription() );
      out.write("\n</h5>\n\n");
...
int entriesCount = BookmarksEntryServiceUtil.getEntriesCount(scopeGroupId, folder.getFolderId());
      ...
      _jspx_th_liferay$1ui_message_0.setArguments( foldersCount );
      _jspx_th_liferay$1ui_message_0.setKey( (foldersCount == 1) ? "x-folder" : "x-folders" );
      ...
      _jspx_th_liferay$1ui_message_1.setArguments( entriesCount );
      _jspx_th_liferay$1ui_message_1.setKey( (entriesCount == 1) ? "x-bookmark" : "x-bookmarks" );
