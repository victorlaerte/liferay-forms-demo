...
public final class content_005fsharing_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int contentSharingWithChildrenEnabled = PrefsPropsUtil.getInteger(company.getCompanyId(), PropsKeys.SITES_CONTENT_SHARING_WITH_CHILDREN_ENABLED);
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setLabel("allow-site-administrators-to-display-content-from-other-sites-they-administer");
        _jspx_th_aui_input_0.setName( "settings--" + PropsKeys.SITES_CONTENT_SHARING_THROUGH_ADMINISTRATORS_ENABLED + "--" );
        _jspx_th_aui_input_0.setType("checkbox");
        _jspx_th_aui_input_0.setValue( contentSharingWithSiteAdministratorsEnabled );
        ...
        _jspx_th_aui_select_0.setLabel("allow-subsites-to-display-content-from-parent-sites");
        _jspx_th_aui_select_0.setName( "settings--" + PropsKeys.SITES_CONTENT_SHARING_WITH_CHILDREN_ENABLED + "--" );
        _jspx_th_aui_select_0.setValue( contentSharingWithChildrenEnabled );
        ...
        if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_aui_option_0.setLabel(new String("enabled-by-default"));
            _jspx_th_aui_option_0.setValue( Sites.CONTENT_SHARING_WITH_CHILDREN_ENABLED_BY_DEFAULT );
            ...
            _jspx_th_aui_option_1.setLabel(new String("disabled-by-default"));
            _jspx_th_aui_option_1.setValue( Sites.CONTENT_SHARING_WITH_CHILDREN_DISABLED_BY_DEFAULT );
            ...
            _jspx_th_aui_option_2.setLabel(new String("disabled"));
            _jspx_th_aui_option_2.setValue( Sites.CONTENT_SHARING_WITH_CHILDREN_DISABLED );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("content-sharing");
