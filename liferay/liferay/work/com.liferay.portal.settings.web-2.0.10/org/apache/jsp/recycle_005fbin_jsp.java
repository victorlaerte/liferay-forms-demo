...
public final class recycle_005fbin_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean trashEnabled = PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.TRASH_ENABLED);
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setHelpMessage("enable-recycle-bin-default");
        _jspx_th_aui_input_0.setId("trashEnabled");
        _jspx_th_aui_input_0.setLabel("enable-recycle-bin");
        _jspx_th_aui_input_0.setName( "settings--" + PropsKeys.TRASH_ENABLED + "--" );
        _jspx_th_aui_input_0.setType("checkbox");
        _jspx_th_aui_input_0.setValue( trashEnabled );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.print( HtmlUtil.escapeJS(LanguageUtil.get(request, "disabling-the-recycle-bin-prevents-the-restoring-of-content-that-has-been-moved-to-the-recycle-bin")) );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("recycle-bin");
