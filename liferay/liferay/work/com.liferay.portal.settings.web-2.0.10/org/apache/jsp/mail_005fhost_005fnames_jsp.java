...
String adminMailHostNames = PrefsPropsUtil.getString(company.getCompanyId(), PropsKeys.ADMIN_MAIL_HOST_NAMES);
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setLabel( LanguageUtil.format(request, "enter-one-mail-host-name-per-line-for-all-additional-mail-host-names-besides-x", company.getMx(), false) );
        _jspx_th_aui_input_0.setName( "settings--" + PropsKeys.ADMIN_MAIL_HOST_NAMES + "--" );
        _jspx_th_aui_input_0.setType("textarea");
        _jspx_th_aui_input_0.setValue( adminMailHostNames );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("mail-host-names");
