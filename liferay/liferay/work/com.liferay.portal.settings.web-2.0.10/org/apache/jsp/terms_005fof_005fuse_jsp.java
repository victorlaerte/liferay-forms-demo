...
TermsOfUseContentProvider termsOfUseContentProvider = TermsOfUseContentProviderRegistryUtil.getTermsOfUseContentProvider();
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setLabel("require-terms-of-use");
        _jspx_th_aui_input_0.setName( "settings--" + PropsKeys.TERMS_OF_USE_REQUIRED + "--" );
        _jspx_th_aui_input_0.setType("checkbox");
        _jspx_th_aui_input_0.setValue( termsOfUseRequired );
        ...
        _jspx_th_c_if_0.setTest( termsOfUseContentProvider != null );
