...
CompanyPortletRatingsDefinitionDisplayContext companyPortletRatingsDefinitionDisplayContext = new CompanyPortletRatingsDefinitionDisplayContext(companyPortletPreferences, request);
	...
	for (String portletId : companyRatingsTypeMaps.keySet()) {
        ...
        _jspx_th_aui_select_0.setLabel( (classNames.size() > 1) ? ResourceActionsUtil.getModelResource(locale, className) : StringPool.BLANK );
        _jspx_th_aui_select_0.setName( "settings--" + propertyKey + "--" );
        ...
        if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_aui_option_0.setLabel( LanguageUtil.get(request, curRatingsType.getValue()) );
            _jspx_th_aui_option_0.setSelected( Objects.equals(ratingsType, curRatingsType) );
            _jspx_th_aui_option_0.setValue( curRatingsType.getValue() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("ratings");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("select-the-default-ratings-type-for-the-following-applications");
