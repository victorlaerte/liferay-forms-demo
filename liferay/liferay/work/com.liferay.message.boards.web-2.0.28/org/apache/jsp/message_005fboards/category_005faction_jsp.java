...
if (!defaultParentCategory) {
	...
	showPermissionsURL = MBResourcePermission.contains(permissionChecker, scopeGroupId, ActionKeys.PERMISSIONS);
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( !defaultParentCategory && MBCategoryPermission.contains(permissionChecker, category, ActionKeys.UPDATE) );
          ...
          if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_2.setValue( String.valueOf(category.getCategoryId()) );
          ...
          _jspx_th_c_if_1.setTest( portletName.equals(MBPortletKeys.MESSAGE_BOARDS) && enableRSS );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1rss_rss_0.setUrl( MBRSSUtil.getRSSURL(plid, category.getCategoryId(), 0, 0, themeDisplay) );
	...
	if (!defaultParentCategory) {
		...
		hasSubscriptionPermission = MBResourcePermission.contains(permissionChecker, scopeGroupId, ActionKeys.SUBSCRIBE);
          ...
          _jspx_th_c_if_2.setTest( hasSubscriptionPermission && (mbGroupServiceSettings.isEmailMessageAddedEnabled() || mbGroupServiceSettings.isEmailMessageUpdatedEnabled()) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_c_when_0.setTest( (categorySubscriptionClassPKs != null) && categorySubscriptionClassPKs.contains(categorySubscriptionClassPK) );
              ...
              if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_portlet_param_8.setName("mbCategoryId");
                  _jspx_th_portlet_param_8.setValue( String.valueOf(category.getCategoryId()) );
              ...
              if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                if (_jspx_eval_portlet_actionURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_portlet_param_11.setValue( String.valueOf(category.getCategoryId()) );
          ...
          _jspx_th_c_if_3.setTest( showPermissionsURL );
          ...
          if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_icon_4.setUrl( permissionsURL );
          ...
          _jspx_th_c_if_4.setTest( !defaultParentCategory && MBCategoryPermission.contains(permissionChecker, category, ActionKeys.DELETE) );
          ...
          if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_portlet_actionURL_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_12.setValue( trashHelper.isTrashEnabled(scopeGroupId) ? Constants.MOVE_TO_TRASH : Constants.DELETE );
              ...
              _jspx_th_portlet_param_14.setValue( String.valueOf(category.getCategoryId()) );
  ...
  private boolean _jspx_meth_portlet_param_3(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_3.setValue("/message_boards/move_category");
