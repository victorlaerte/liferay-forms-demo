...
public final class view_005fthread_005fshortcut_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (threadFlag != null) {
	...
	threadFlagModifiedTime = threadFlagModifiedDate.getTime();
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t<tr>\n\t\t<td class=\"table-cell\" style=\"padding-left: ");
        out.print( (depth > 0) ? depth * 10 : 5 );
        out.write("px; width: 90%;\" valign=\"middle\">\n\t\t\t");
        //  c:if
        com.liferay.taglib.core.IfTag _jspx_th_c_if_1 = (com.liferay.taglib.core.IfTag) _jspx_tagPool_c_if_test.get(com.liferay.taglib.core.IfTag.class);
        _jspx_th_c_if_1.setPageContext(_jspx_page_context);
        _jspx_th_c_if_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        _jspx_th_c_if_1.setTest( !message.isRoot() );
        ...
        if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_when_0.setTest( !lastNode );
            int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
            if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t\t\t\t<img alt=\"\" src=\"");
              out.print( themeDisplay.getPathThemeImages() );
              out.write("/message_boards/t.png\" />\n\t\t\t\t\t");
            }
            ...
            if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              out.write("\n\t\t\t\t\t\t<img alt=\"\" src=\"");
              out.print( themeDisplay.getPathThemeImages() );
              out.write("/message_boards/l.png\" />\n\t\t\t\t\t");
            }
        ...
        _jspx_th_c_if_2.setTest( !readThread );
        ...
        _jspx_th_c_if_3.setTest( !readThread );
        ...
        _jspx_th_c_if_4.setTest( !readThread );
        ...
        if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_when_1.setTest( message.isAnonymous() );
          ...
          if (_jspx_eval_c_otherwise_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t\t\t\t");
            out.print( HtmlUtil.escape(PortalUtil.getUserName(message)) );
            out.write("\n\t\t\t\t\t");
          }
        ...
        _jspx_th_c_if_5.setTest( !readThread );
...
for (int i = range[0]; i < range[1]; i++) {
	...
	request.setAttribute(WebKeys.MESSAGE_BOARDS_TREE_WALKER_THREAD_FLAG, threadFlag);
      ...
      _jspx_th_liferay$1util_include_0.setPage("/message_boards/view_thread_shortcut.jsp");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("anonymous");
