...
MBBreadcrumbUtil.addPortletBreadcrumbEntries(message, request, renderResponse);
      ...
      _jspx_tagPool_c_if_test.reuse(_jspx_th_c_if_0);
      out.write("\n\n\t<div ");
      out.print( !portletTitleBasedNavigation ? "class=\"main-content-body\"" : StringPool.BLANK );
      out.write(">\n\t\t");
      //  c:if
      ...
      _jspx_th_liferay$1util_include_1.setPage("/message_boards/view_message_content.jsp");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("addReplyToMessage(messageId, quote) {\n\t\tvar addQuickReplyContainer = AUI.$('#");
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("addReplyToMessage' + messageId);\n\n\t\taddQuickReplyContainer.removeClass('hide');\n\n\t\taddQuickReplyContainer.find('#");
          ...
          if (_jspx_meth_portlet_namespace_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("addReplyToMessage' + messageId).addClass('hide');\n\n\t\tvar editorName = '");
          ...
          _jspx_th_c_if_2.setTest( thread.getRootMessageId() != message.getMessageId() );
          int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\tdocument.getElementById('");
            if (_jspx_meth_portlet_namespace_8((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_2, _jspx_page_context))
              return;
            out.write("message_' + ");
...
PortalUtil.setPageKeywords(ListUtil.toString(assetTags, AssetTag.NAME_ACCESSOR), request);
  ...
  private boolean _jspx_meth_portlet_namespace_8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_8.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_2);
