package org.apache.jsp.template_005frenderer;
...
private static HashMap<String, Object> _toHashMap(Object obj) {
  ...
  static {
    ...
    _jspx_dependants.add("/template_renderer/init.jsp");
    _jspx_dependants.add("/init.jsp");
    _jspx_dependants.add("/init-ext.jspf");
    _jspx_dependants.add("/template_renderer/init-ext.jspf");
  }
...
DDMTemplate portletDisplayDDMTemplate = (DDMTemplate)request.getAttribute("liferay-ddm:template-renderer:portletDisplayDDMTemplate");
      ...
      _jspx_th_c_if_0.setTest( portletDisplayDDMTemplate != null );
      int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write('\n');
        out.write('	');
        out.print( PortletDisplayTemplateUtil.renderDDMTemplate(request, response, portletDisplayDDMTemplate.getTemplateId(), entries, contextObjects) );
        out.write('\n');
      }
