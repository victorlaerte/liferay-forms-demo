...
public final class small_005fimage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody;
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody;
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_name_label_id_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    ...
    _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    ...
    _jspx_tagPool_aui_input_name_label_id_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _jspx_tagPool_liferay$1trash_defineObjects_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  }

  public void _jspDestroy() {
    _jspx_tagPool_portlet_namespace_nobody.release();
    _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody.release();
    ...
    _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.release();
    ...
    _jspx_tagPool_aui_input_name_label_id_nobody.release();
...
boolean changeStructure = GetterUtil.getBoolean(request.getAttribute("edit_article.jsp-changeStructure"));
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("small_image");
...
JournalFileUploadsConfiguration journalFileUploadsConfiguration = (JournalFileUploadsConfiguration)request.getAttribute(JournalFileUploadsConfiguration.class.getName());
      ...
      _jspx_th_liferay$1ui_error_0.setException( ArticleSmallImageNameException.class );
	...
	String[] imageExtensions = journalFileUploadsConfiguration.imageExtensions();
          ...
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_error_0, _jspx_page_context))
            return;
          out.write(' ');
          out.print( HtmlUtil.escape(StringUtil.merge(imageExtensions, ", ")) );
          out.write('.');
          out.write('\n');
      ...
      _jspx_th_liferay$1ui_error_1.setException( ArticleSmallImageSizeException.class );
	...
	long imageMaxSize = journalFileUploadsConfiguration.smallImageMaxSize();
      ...
      if (_jspx_eval_aui_row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_if_0.setTest( smallImage && (article != null) );
        ...
        if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_aui_col_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_0);
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_2);
            out.write("\" class=\"img-responsive lfr-journal-small-image-preview\" src=\"");
            out.print( HtmlUtil.escapeAttribute(article.getArticleImageURL(themeDisplay)) );
            out.write("\" />\n\t\t\t\t");
          }
        ...
        _jspx_th_aui_col_1.setWidth( (smallImage && (article != null)) ? 50 : 100 );
        ...
        if (_jspx_eval_aui_col_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1frontend_fieldset_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_1);
          ...
          if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_1 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_1.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
            _jspx_th_aui_input_1.setCssClass("lfr-journal-small-image-type");
            _jspx_th_aui_input_1.setIgnoreRequestValue( changeStructure );
            _jspx_th_aui_input_1.setInlineField( true );
            _jspx_th_aui_input_1.setLabel("small-image-url");
            _jspx_th_aui_input_1.setName("smallImageType");
            _jspx_th_aui_input_1.setType("radio");
            int _jspx_eval_aui_input_1 = _jspx_th_aui_input_1.doStartTag();
            if (_jspx_th_aui_input_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_1);
              return;
            }
            _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_1);
            out.write("\n\n\t\t\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_2 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_2.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
            _jspx_th_aui_input_2.setCssClass("lfr-journal-small-image-value");
            _jspx_th_aui_input_2.setIgnoreRequestValue( changeStructure );
            _jspx_th_aui_input_2.setInlineField( true );
            _jspx_th_aui_input_2.setLabel("");
            _jspx_th_aui_input_2.setName("smallImageURL");
            _jspx_th_aui_input_2.setTitle("small-image-url");
            int _jspx_eval_aui_input_2 = _jspx_th_aui_input_2.doStartTag();
            if (_jspx_th_aui_input_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_2);
              return;
            }
            _jspx_tagPool_aui_input_title_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_2);
            out.write("\n\t\t\t\t");
          ...
          _jspx_th_liferay$1frontend_fieldset_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_1);
          ...
          if (_jspx_eval_liferay$1frontend_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_3 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_3.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_1);
            _jspx_th_aui_input_3.setCssClass("lfr-journal-small-image-type");
            _jspx_th_aui_input_3.setIgnoreRequestValue( changeStructure );
            _jspx_th_aui_input_3.setInlineField( true );
            _jspx_th_aui_input_3.setLabel("small-image");
            _jspx_th_aui_input_3.setName("smallImageType");
            _jspx_th_aui_input_3.setType("radio");
            int _jspx_eval_aui_input_3 = _jspx_th_aui_input_3.doStartTag();
            if (_jspx_th_aui_input_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_3);
              return;
            }
            _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_3);
            out.write("\n\n\t\t\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_1);
            _jspx_th_aui_input_4.setCssClass("lfr-journal-small-image-value");
            _jspx_th_aui_input_4.setIgnoreRequestValue( changeStructure );
            _jspx_th_aui_input_4.setInlineField( true );
            _jspx_th_aui_input_4.setLabel("");
            _jspx_th_aui_input_4.setName("smallFile");
            _jspx_th_aui_input_4.setType("file");
            int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
            if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_4);
              return;
            }
            _jspx_tagPool_aui_input_type_name_label_inlineField_ignoreRequestValue_cssClass_nobody.reuse(_jspx_th_aui_input_4);
            out.write("\n\t\t\t\t");
      ...
      _jspx_th_aui_script_0.setUse("aui-toggler");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("smallImageContainer .lfr-journal-small-image-content',\n\t\t\texpanded: ");
          out.print( smallImage );
          out.write(",\n\t\t\theader: '#");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("smallImageContainer .lfr-journal-small-image-header',\n\t\t\ton: {\n\t\t\t\tanimatingChange: function(event) {\n\t\t\t\t\tvar instance = this;\n\n\t\t\t\t\tvar expanded = !instance.get('expanded');\n\n\t\t\t\t\tA.one('#");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("useSmallImage').attr('checked', expanded);\n\n\t\t\t\t\tif (expanded) {\n\t\t\t\t\t\ttypes.each(\n\t\t\t\t\t\t\tfunction(item, index) {\n\t\t\t\t\t\t\t\tif (item.get('checked')) {\n\t\t\t\t\t\t\t\t\tvalues.item(index).attr('disabled', false);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t);\n\t\t\t\t\t}\n\t\t\t\t\telse {\n\t\t\t\t\t\tvalues.attr('disabled', true);\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t);\n\n\t// LPS-51306\n\n\tsetTimeout(\n\t\tfunction() {\n\t\t\tselectSmallImageType('");
          out.print( ((article != null) && Validator.isNotNull(article.getSmallImageURL())) ? 0 : 1 );
          out.write("');\n\t\t},\n\t\t0\n\t);\n");
  ...
  private boolean _jspx_meth_aui_input_0(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  aui:input
    com.liferay.taglib.aui.InputTag _jspx_th_aui_input_0 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_name_label_id_nobody.get(com.liferay.taglib.aui.InputTag.class);
    _jspx_th_aui_input_0.setPageContext(_jspx_page_context);
    _jspx_th_aui_input_0.setParent(null);
    _jspx_th_aui_input_0.setId("useSmallImage");
    _jspx_th_aui_input_0.setLabel("use-small-image");
    _jspx_th_aui_input_0.setName("smallImage");
    int _jspx_eval_aui_input_0 = _jspx_th_aui_input_0.doStartTag();
    if (_jspx_th_aui_input_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_aui_input_name_label_id_nobody.reuse(_jspx_th_aui_input_0);
      return true;
    }
    _jspx_tagPool_aui_input_name_label_id_nobody.reuse(_jspx_th_aui_input_0);
    return false;
