...
JournalMoveEntriesDisplayContext journalMovesEntriesDisplayContext = new JournalMoveEntriesDisplayContext(liferayPortletRequest, liferayPortletResponse, currentURL);
      ...
      _jspx_th_portlet_actionURL_0.setName("moveEntries");
      _jspx_th_portlet_actionURL_0.setVar("moveArticleURL");
      ...
      _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String moveArticleURL = null;
      moveArticleURL = (java.lang.String) _jspx_page_context.findAttribute("moveArticleURL");
      out.write('\n');
      out.write('\n');
      ...
      _jspx_th_liferay$1frontend_edit$1form_0.setAction( moveArticleURL );
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setValue( journalMovesEntriesDisplayContext.getRedirect() );
        ...
        _jspx_th_aui_input_1.setName("newFolderId");
        _jspx_th_aui_input_1.setType("hidden");
        _jspx_th_aui_input_1.setValue( journalMovesEntriesDisplayContext.getNewFolderId() );
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_error_1.setException( InvalidDDMStructureException.class );
          _jspx_th_liferay$1ui_error_1.setMessage("the-folder-you-selected-does-not-allow-this-type-of-structure.-please-select-a-different-folder");
          ...
          _jspx_th_liferay$1ui_error_2.setException( NoSuchFolderException.class );
          _jspx_th_liferay$1ui_error_2.setMessage("please-enter-a-valid-folder");
          ...
          if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_c_if_0.setTest( !validMoveFolders.isEmpty() );
              ...
              if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_liferay$1ui_message_0.setArguments( validMoveFolders.size() );
                _jspx_th_liferay$1ui_message_0.setKey("x-folders-are-ready-to-be-moved");
              ...
              _jspx_th_c_if_1.setTest( !invalidMoveFolders.isEmpty() );
              ...
              if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_liferay$1ui_message_1.setArguments( invalidMoveFolders.size() );
                _jspx_th_liferay$1ui_message_1.setKey("x-folders-cannot-be-moved");
              ...
              _jspx_th_aui_input_2.setName("rowIdsJournalFolder");
              _jspx_th_aui_input_2.setType("hidden");
              _jspx_th_aui_input_2.setValue( ListUtil.toString(validMoveFolders, JournalFolder.FOLDER_ID_ACCESSOR) );
              ...
              _jspx_th_c_if_2.setTest( !validMoveArticles.isEmpty() );
              ...
              if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_liferay$1ui_message_3.setArguments( validMoveArticles.size() );
                _jspx_th_liferay$1ui_message_3.setKey("x-web-content-instances-are-ready-to-be-moved");
                ...
                out.print( HtmlUtil.escapeAttribute(validMoveArticle.getTitle(locale)) );
                out.write("\">\n\t\t\t\t\t\t\t\t\t");
                out.print( HtmlUtil.escape(validMoveArticle.getTitle(locale)) );
                out.write("\n\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t</li>\n\n\t\t\t\t\t\t");
              ...
              _jspx_th_c_if_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
              _jspx_th_c_if_3.setTest( !invalidMoveArticles.isEmpty() );
              ...
              if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_liferay$1ui_message_4.setArguments( invalidMoveArticles.size() );
                _jspx_th_liferay$1ui_message_4.setKey("x-web-content-instances-cannot-be-moved");
                ...
                out.print( HtmlUtil.escapeAttribute(invalidMoveArticle.getTitle()) );
                out.write("\">\n\t\t\t\t\t\t\t\t\t");
                out.print( HtmlUtil.escape(invalidMoveArticle.getTitle()) );
                out.write("\n\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t\t<span class=\"error-message\">\n\t\t\t\t\t\t\t\t\t");
              ...
              _jspx_th_aui_input_3.setName("rowIdsJournalArticle");
              _jspx_th_aui_input_3.setType("hidden");
              _jspx_th_aui_input_3.setValue( ListUtil.toString(validMoveArticles, JournalArticle.ARTICLE_ID_ACCESSOR) );
              ...
              out.write("\n\n\t\t\t\t");
              //  aui:input
              com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_title_name_label_nobody.get(com.liferay.taglib.aui.InputTag.class);
              _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
              _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
              _jspx_th_aui_input_4.setLabel("new-folder");
              _jspx_th_aui_input_4.setName("folderName");
              _jspx_th_aui_input_4.setTitle("new-folder");
              _jspx_th_aui_input_4.setType("resource");
              _jspx_th_aui_input_4.setValue( journalMovesEntriesDisplayContext.getNewFolderName() );
              int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
              if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
                _jspx_tagPool_aui_input_value_type_title_name_label_nobody.reuse(_jspx_th_aui_input_4);
                return;
              }
              _jspx_tagPool_aui_input_value_type_title_name_label_nobody.reuse(_jspx_th_aui_input_4);
              out.write("\n\n\t\t\t\t");
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1footer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_button_2.setHref( journalMovesEntriesDisplayContext.getRedirect() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_2.setValue( String.valueOf(journalMovesEntriesDisplayContext.getNewFolderId()) );
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("/move_entries.jsp");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("you-do-not-have-the-required-permissions");
  ...
  private boolean _jspx_meth_liferay$1ui_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_5.setKey("you-do-not-have-the-required-permissions");
  ...
  private boolean _jspx_meth_liferay$1ui_message_6(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_6.setKey("done");
  ...
  private boolean _jspx_meth_liferay$1ui_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_7.setArguments(new String("folder"));
    _jspx_th_liferay$1ui_message_7.setKey("select-x");
