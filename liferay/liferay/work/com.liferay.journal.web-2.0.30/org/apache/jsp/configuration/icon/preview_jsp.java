...
JournalArticle article = ActionUtil.getArticle(renderRequest);
      ...
      if (_jspx_eval_liferay$1portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_param_4.setName("ddmTemplateKey");
        _jspx_th_portlet_param_4.setValue( article.getDDMTemplateKey() );
      ...
      _jspx_th_c_if_0.setTest( SessionMessages.contains(renderRequest, "previewRequested") );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n\t\tLiferay.fire(\n\t\t\t'previewArticle',\n\t\t\t{\n\t\t\t\ttitle: '");
            out.print( HtmlUtil.escapeJS(article.getTitle(locale)) );
            out.write("',\n\t\t\t\turi: '");
            out.print( HtmlUtil.escapeJS(previewArticleContentURL.toString()) );
            out.write("'\n\t\t\t}\n\t\t);\n\t");
  ...
  private boolean _jspx_meth_liferay$1ui_icon_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_icon_0.setId("basicPreviewButton");
