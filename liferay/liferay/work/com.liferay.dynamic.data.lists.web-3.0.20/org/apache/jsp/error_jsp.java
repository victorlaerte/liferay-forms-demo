...
DDLDisplayContext ddlDisplayContext = (DDLDisplayContext)request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT);
      ...
      _jspx_th_liferay$1ui_header_0.setTitle("error");
      ...
      _jspx_th_liferay$1ui_error_0.setException( NoSuchRecordException.class );
      _jspx_th_liferay$1ui_error_0.setMessage("the-record-could-not-be-found");
      ...
      _jspx_th_liferay$1ui_error_1.setException( NoSuchRecordSetException.class );
      _jspx_th_liferay$1ui_error_1.setMessage("the-recordSet-could-not-be-found");
      ...
      _jspx_th_liferay$1ui_error_2.setException( PortletPreferencesException.MustBeStrict.class );
      _jspx_th_liferay$1ui_error_2.setMessage("portlet-preferences-are-not-configured-properly");
