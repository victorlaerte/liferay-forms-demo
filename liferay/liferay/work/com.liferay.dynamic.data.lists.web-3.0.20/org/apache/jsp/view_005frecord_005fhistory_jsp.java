...
public final class view_005frecord_005fhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (DDLRecordVersion recordVersion : recordVersions) {
	...
	request.setAttribute(DDLWebKeys.DYNAMIC_DATA_LISTS_RECORD_VERSION, recordVersion);
      ...
      _jspx_th_liferay$1util_include_0.setPage("/record_version_action.jsp");
      ...
      _jspx_th_liferay$1ui_message_0.setArguments( recordVersion.getVersion() );
      ...
      out.write(':');
      out.write(' ');
      out.print( HtmlUtil.escape(recordVersion.getUserName()) );
      out.write("\n\t\t\t</small>\n\t\t</p>\n\n\t\t<p>\n\t\t\t<small class=\"text-muted\">\n\t\t\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("create-date");
