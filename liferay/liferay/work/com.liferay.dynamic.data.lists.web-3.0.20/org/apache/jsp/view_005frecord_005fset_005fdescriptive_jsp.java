...
public final class view_005frecord_005fset_005fdescriptive_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String href = (String)request.getAttribute(WebKeys.SEARCH_ENTRY_HREF);
      ...
      _jspx_th_aui_a_0.setCssClass("record-set-name");
      _jspx_th_aui_a_0.setHref( href );
      int _jspx_eval_aui_a_0 = _jspx_th_aui_a_0.doStartTag();
      if (_jspx_eval_aui_a_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t\t");
        out.print( HtmlUtil.escape(ddlRecordSet.getName(locale)) );
        out.write('\n');
        out.write('	');
      }
      ...
      out.print( HtmlUtil.escape(ddlRecordSet.getDescription(locale)) );
      out.write("\n\t</div>\n</h5>\n\n<h5 class=\"text-default\">\n\t<span class=\"record-set-id\">\n\t\t");
      if (_jspx_meth_liferay$1ui_message_0(_jspx_page_context))
        return;
      out.write(':');
      out.write(' ');
      out.print( ddlRecordSet.getRecordSetId() );
