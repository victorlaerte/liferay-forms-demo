...
PortletURL portletURL = renderResponse.createRenderURL();
      ...
      _jspx_th_clay_management$1toolbar_0.setActionDropdownItems( ddlDisplayContext.getActionItemsDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( ddlDisplayContext.getClearResultsURL() );
      _jspx_th_clay_management$1toolbar_0.setComponentId("ddlManagementToolbar");
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( ddlDisplayContext.getCreationMenu() );
      _jspx_th_clay_management$1toolbar_0.setDisabled( ddlDisplayContext.isDisabledManagementBar() );
      _jspx_th_clay_management$1toolbar_0.setFilterDropdownItems( ddlDisplayContext.getFilterItemsDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setItemsTotal( ddlDisplayContext.getTotalItems() );
      ...
      _jspx_th_clay_management$1toolbar_0.setSearchContainerId( ddlDisplayContext.getSearchContainerId() );
      _jspx_th_clay_management$1toolbar_0.setSearchFormName("fm1");
      _jspx_th_clay_management$1toolbar_0.setSortingOrder( ddlDisplayContext.getOrderByType() );
      _jspx_th_clay_management$1toolbar_0.setSortingURL( ddlDisplayContext.getSortingURL() );
      _jspx_th_clay_management$1toolbar_0.setViewTypeItems( ddlDisplayContext.getViewTypesItems() );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( ddlDisplayContext.getSearchContainerId() );
          out.write("');\n\n\t\t\t\tif (searchContainer) {\n\t\t\t\t\tform.setAttribute('method', 'post');\n\n\t\t\t\t\tvar recordSetIds = form.querySelector('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("recordSetIds');\n\n\t\t\t\t\tif (recordSetIds) {\n\t\t\t\t\t\trecordSetIds.setAttribute('value', Liferay.Util.listCheckedExcept(searchContainer, '");
          ...
          _jspx_th_portlet_actionURL_0.setName("deleteRecordSet");
