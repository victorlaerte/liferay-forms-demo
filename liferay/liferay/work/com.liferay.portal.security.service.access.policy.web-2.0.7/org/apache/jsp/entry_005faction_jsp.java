...
SAPEntry sapEntry = (SAPEntry)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( SAPEntryPermission.contains(permissionChecker, sapEntry, ActionKeys.UPDATE) );
          ...
          _jspx_th_c_if_1.setTest( SAPEntryPermission.contains(permissionChecker, sapEntry, ActionKeys.PERMISSIONS) );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1security_permissionsURL_0.setModelResource( SAPEntry.class.getName() );
            _jspx_th_liferay$1security_permissionsURL_0.setModelResourceDescription( sapEntry.getTitle(locale) );
            _jspx_th_liferay$1security_permissionsURL_0.setResourcePrimKey( String.valueOf(sapEntry.getSapEntryId()) );
          ...
          _jspx_th_c_if_2.setTest( !sapEntry.isSystem() && SAPEntryPermission.contains(permissionChecker, sapEntry, ActionKeys.DELETE) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_actionURL_0.setName("deleteSAPEntry");
            ...
            if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_portlet_param_4.setName("sapEntryId");
              _jspx_th_portlet_param_4.setValue( String.valueOf(sapEntry.getSapEntryId()) );
