...
public final class edit_005flayout_005fbranch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (layoutRevisionId <= 0) {
	layoutRevisionId = ParamUtil.getLong(request, "copyLayoutRevisionId");
      ...
      _jspx_th_liferay$1ui_error_0.setException( LayoutBranchNameException.class );
	...
	LayoutBranchNameException lbne = (LayoutBranchNameException)errorException;
          ...
          _jspx_th_c_if_0.setTest( lbne.getType() == LayoutBranchNameException.DUPLICATE );
          ...
          _jspx_th_c_if_1.setTest( lbne.getType() == LayoutBranchNameException.TOO_LONG );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_1.setArguments( new Object[] {4, 75} );
            _jspx_th_liferay$1ui_message_1.setKey("please-enter-a-value-between-x-and-x-characters-long");
          ...
          _jspx_th_c_if_2.setTest( lbne.getType() == LayoutBranchNameException.TOO_SHORT );
...
if (layoutBranch != null) {
	title = "update-page-variation";
      ...
      _jspx_th_aui_model$1context_0.setBean( layoutBranch );
      _jspx_th_aui_model$1context_0.setModel( LayoutBranch.class );
      ...
      _jspx_th_portlet_actionURL_0.setName("editLayoutBranch");
      _jspx_th_portlet_actionURL_0.setVar("editLayoutBranchURL");
      ...
      _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String editLayoutBranchURL = null;
      editLayoutBranchURL = (java.lang.String) _jspx_page_context.findAttribute("editLayoutBranchURL");
      out.write("\n\n\t");
      //  aui:form
      ...
      _jspx_th_aui_form_0.setAction( editLayoutBranchURL );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_1.setValue( String.valueOf(scopeGroupId) );
        ...
        _jspx_th_aui_input_2.setName("layoutBranchId");
        _jspx_th_aui_input_2.setType("hidden");
        _jspx_th_aui_input_2.setValue( layoutBranchId );
        ...
        _jspx_th_aui_input_3.setName("copyLayoutRevisionId");
        _jspx_th_aui_input_3.setType("hidden");
        _jspx_th_aui_input_3.setValue( String.valueOf(layoutRevisionId) );
        ...
        _jspx_th_aui_input_4.setValue( String.valueOf(WorkflowConstants.ACTION_SAVE_DRAFT) );
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_button_0.setValue( (layoutBranch != null) ? "update" : "add" );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("a-page-variation-with-that-name-already-exists");
