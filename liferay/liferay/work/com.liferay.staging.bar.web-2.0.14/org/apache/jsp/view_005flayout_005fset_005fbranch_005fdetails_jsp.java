...
public final class view_005flayout_005fset_005fbranch_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String stagingURL = (String)request.getAttribute(StagingProcessesWebKeys.STAGING_URL);
      ...
      _jspx_th_c_if_0.setTest( (layoutSetBranches != null) && (layoutSetBranches.size() >= 1) );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        //  liferay-ui:message
        com.liferay.taglib.ui.MessageTag _jspx_th_liferay$1ui_message_1 = (com.liferay.taglib.ui.MessageTag) _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.get(com.liferay.taglib.ui.MessageTag.class);
        _jspx_th_liferay$1ui_message_1.setPageContext(_jspx_page_context);
        _jspx_th_liferay$1ui_message_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        _jspx_th_liferay$1ui_message_1.setKey( HtmlUtil.escape(layoutSetBranchDisplayContext.getLayoutSetBranchDisplayName(layoutSetBranch)) );
        _jspx_th_liferay$1ui_message_1.setLocalizeKey( false );
        int _jspx_eval_liferay$1ui_message_1 = _jspx_th_liferay$1ui_message_1.doStartTag();
        if (_jspx_th_liferay$1ui_message_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.reuse(_jspx_th_liferay$1ui_message_1);
          return;
        }
        _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.reuse(_jspx_th_liferay$1ui_message_1);
        out.write("\n\n\t\t\t");
        ...
        _jspx_th_portlet_actionURL_0.setName("selectLayoutSetBranch");
        _jspx_th_portlet_actionURL_0.setVar("curLayoutSetBranchURL");
        ...
        if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_param_0.setValue( stagingURL );
          ...
          _jspx_th_portlet_param_1.setValue( String.valueOf(curLayoutSetBranch.getGroupId()) );
          ...
          _jspx_th_portlet_param_2.setValue( String.valueOf(layout.isPrivateLayout()) );
          ...
          _jspx_th_portlet_param_3.setValue( String.valueOf(curLayoutSetBranch.getLayoutSetBranchId()) );
        ...
        _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
        java.lang.String curLayoutSetBranchURL = null;
        curLayoutSetBranchURL = (java.lang.String) _jspx_page_context.findAttribute("curLayoutSetBranchURL");
        out.write("\n\n\t\t\t\t<li>\n\t\t\t\t\t<a class=\"");
        out.print( selected ? "disabled" : StringPool.BLANK );
        out.write("\" href=\"");
        out.print( selected ? "javascript:;" : "javascript:submitForm(document.hrefFm, '" + HtmlUtil.escapeJS(curLayoutSetBranchURL) + "');" );
        out.write("\">\n\t\t\t\t\t\t");
        //  liferay-ui:message
        com.liferay.taglib.ui.MessageTag _jspx_th_liferay$1ui_message_2 = (com.liferay.taglib.ui.MessageTag) _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.get(com.liferay.taglib.ui.MessageTag.class);
        _jspx_th_liferay$1ui_message_2.setPageContext(_jspx_page_context);
        _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        _jspx_th_liferay$1ui_message_2.setKey( HtmlUtil.escape(layoutSetBranchDisplayContext.getLayoutSetBranchDisplayName(curLayoutSetBranch)) );
        _jspx_th_liferay$1ui_message_2.setLocalizeKey( false );
        int _jspx_eval_liferay$1ui_message_2 = _jspx_th_liferay$1ui_message_2.doStartTag();
        if (_jspx_th_liferay$1ui_message_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.reuse(_jspx_th_liferay$1ui_message_2);
          return;
        }
        _jspx_tagPool_liferay$1ui_message_localizeKey_key_nobody.reuse(_jspx_th_liferay$1ui_message_2);
        out.write("\n\t\t\t\t\t</a>\n\t\t\t\t</li>\n\n\t\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("site-pages-variation");
