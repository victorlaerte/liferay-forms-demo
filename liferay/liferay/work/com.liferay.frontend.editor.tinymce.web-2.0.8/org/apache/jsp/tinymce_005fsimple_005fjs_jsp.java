...
public final class tinymce_005fsimple_005fjs_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String editorName = (String)request.getAttribute(TinyMCEEditorConstants.ATTRIBUTE_NAMESPACE + ":editorName");
      ...
      _jspx_th_liferay$1util_html$1top_0.setOutputKey("js_editor_tinymce");
	...
	long javaScriptLastModified = PortalWebResourcesUtil.getLastModified(PortalWebResourceConstants.RESOURCE_TYPE_EDITOR_TINYMCEEDITOR);
          ...
          out.print( HtmlUtil.escape(PortalUtil.getStaticResourceURL(request, themeDisplay.getCDNHost() + PortalWebResourcesUtil.getContextPath(PortalWebResourceConstants.RESOURCE_TYPE_EDITOR_TINYMCEEDITOR) + "/tiny_mce/tinymce.min.js", javaScriptLastModified)) );
          ...
          _jspx_th_liferay$1util_dynamic$1include_0.setKey( "com.liferay.frontend.editor.tinymce.web#" + editorName + "#additionalResources" );
