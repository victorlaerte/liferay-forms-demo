...
public final class opensso_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/dynamic_include/com.liferay.portal.settings.web/opensso_user_name.jspf");
  }
...
String version = openSSOConfiguration.version();
      ...
      if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setId( PortalUtil.generateRandomKey(request, "portal_settings_authentication_opensso") );
        _jspx_th_aui_input_0.setName( ActionRequest.ACTION_NAME );
        _jspx_th_aui_input_0.setType("hidden");
        _jspx_th_aui_input_0.setValue(new String("/portal_settings/opensso"));
        ...
        _jspx_th_aui_input_1.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "enabled" );
        ...
        _jspx_th_aui_select_0.setLabel("version");
        _jspx_th_aui_select_0.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "version" );
        _jspx_th_aui_select_0.setValue( version );
        ...
        if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_aui_option_0.setLabel(new String("openam-12"));
            _jspx_th_aui_option_0.setValue( OpenSSOConfigurationKeys.VERSION_OPENAM_12 );
            ...
            _jspx_th_aui_option_1.setLabel(new String("openam-13"));
            _jspx_th_aui_option_1.setValue( OpenSSOConfigurationKeys.VERSION_OPENAM_13 );
        ...
        _jspx_th_aui_input_2.setHelpMessage("import-opensso-users-from-ldap-help");
        _jspx_th_aui_input_2.setLabel("import-opensso-users-from-ldap");
        _jspx_th_aui_input_2.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "importFromLDAP" );
        _jspx_th_aui_input_2.setType("checkbox");
        _jspx_th_aui_input_2.setValue( importFromLDAP );
        ...
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_3 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        ...
        _jspx_th_aui_input_3.setHelpMessage("login-url-for-opensso-help");
        _jspx_th_aui_input_3.setLabel("login-url");
        _jspx_th_aui_input_3.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "loginURL" );
        _jspx_th_aui_input_3.setType("text");
        _jspx_th_aui_input_3.setValue( loginURL );
        int _jspx_eval_aui_input_3 = _jspx_th_aui_input_3.doStartTag();
        if (_jspx_th_aui_input_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_3);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_3);
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_4.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
        _jspx_th_aui_input_4.setCssClass("lfr-input-text-container");
        _jspx_th_aui_input_4.setHelpMessage("logout-url-for-opensso-help");
        _jspx_th_aui_input_4.setLabel("logout-url");
        _jspx_th_aui_input_4.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "logoutURL" );
        _jspx_th_aui_input_4.setType("text");
        _jspx_th_aui_input_4.setValue( logoutURL );
        int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
        if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_4);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_4);
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_5 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        ...
        _jspx_th_aui_input_5.setHelpMessage("service-url-for-opensso-help");
        _jspx_th_aui_input_5.setLabel("service-url");
        _jspx_th_aui_input_5.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "serviceURL" );
        _jspx_th_aui_input_5.setType("text");
        _jspx_th_aui_input_5.setValue( serviceURL );
        int _jspx_eval_aui_input_5 = _jspx_th_aui_input_5.doStartTag();
        if (_jspx_th_aui_input_5.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_5);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_5);
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_6 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        ...
        _jspx_th_aui_input_6.setHelpMessage("mappings-for-opensso-help");
        _jspx_th_aui_input_6.setLabel("screen-name-attribute");
        _jspx_th_aui_input_6.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "screenNameAttr" );
        _jspx_th_aui_input_6.setType("text");
        _jspx_th_aui_input_6.setValue( screenNameAttr );
        int _jspx_eval_aui_input_6 = _jspx_th_aui_input_6.doStartTag();
        if (_jspx_th_aui_input_6.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_6);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_helpMessage_cssClass_nobody.reuse(_jspx_th_aui_input_6);
        out.write("\n\n\t");
        ...
        _jspx_th_aui_input_7.setLabel("email-address-attribute");
        _jspx_th_aui_input_7.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "emailAddressAttr" );
        _jspx_th_aui_input_7.setType("text");
        _jspx_th_aui_input_7.setValue( emailAddressAttr );
        ...
        _jspx_th_aui_input_8.setLabel("first-name-attribute");
        _jspx_th_aui_input_8.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "firstNameAttr" );
        _jspx_th_aui_input_8.setType("text");
        _jspx_th_aui_input_8.setValue( firstNameAttr );
        ...
        out.write('\n');
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_9 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        ...
        _jspx_th_aui_input_9.setLabel("last-name-attribute");
        _jspx_th_aui_input_9.setName( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE + "lastNameAttr" );
        _jspx_th_aui_input_9.setType("text");
        _jspx_th_aui_input_9.setValue( lastNameAttr );
        ...
        if (_jspx_th_aui_input_9.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.reuse(_jspx_th_aui_input_9);
          return;
        }
        _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.reuse(_jspx_th_aui_input_9);
        out.write("\n\n\t");
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_button_0.setOnClick( renderResponse.getNamespace() + "testOpenSSOSettings();" );
          _jspx_th_aui_button_0.setValue("test-opensso-configuration");
          ...
          _jspx_th_portlet_actionURL_0.setName("/portal_settings/opensso_delete");
          _jspx_th_portlet_actionURL_0.setVar("resetValuesURL");
		...
		String taglibOnClick = "if (confirm('" + UnicodeLanguageUtil.get(request, "are-you-sure-you-want-to-reset-the-configured-values") + "')) {submitForm(document.hrefFm, '" + resetValuesURL.toString() + "');}";
          ...
          _jspx_th_aui_button_1.setValue("reset-values");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE );
          out.write("loginURL'].value;\n\t\t\tdata.");
          ...
          if (_jspx_meth_portlet_namespace_12((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE );
          out.write("screenNameAttr'].value;\n\t\t\tdata.");
          ...
          if (_jspx_meth_portlet_namespace_15((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( PortalSettingsOpenSSOConstants.FORM_PARAMETER_NAMESPACE );
          out.write("emailAddressAttr'].value;\n\t\t\tdata.");
          ...
          out.print( UnicodeLanguageUtil.get(request, "opensso") );
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("opensso");
  ...
  private boolean _jspx_meth_portlet_param_1(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_1.setValue("/portal_settings/test_opensso");
