package org.apache.jsp.fragment_005fentry_005frenderer;
...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/fragment_entry_renderer/init.jsp");
  }
...
FragmentEntry fragmentEntry = (FragmentEntry)request.getAttribute("liferay-fragment:fragment-entry-renderer:fragmentEntry");
      ...
      out.write("\"\n>\n\t<style type=\"text/css\">\n\t\t");
      out.print( fragmentEntry.getCss() );
      out.write("\n\t</style>\n</liferay-util:html-top>\n\n<div id=\"");
      out.print( randomNamespace );
      out.write("\">\n\t");
      out.print( fragmentEntry.getHtml() );
      out.write("\n</div>\n\n");
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\t(function() {\n\t\tvar fragment = document.getElementById(\"");
          out.print( randomNamespace );
          out.write("\");\n\n\t\t");
          out.print( fragmentEntry.getJs() );
          out.write("\n\t}());\n");
