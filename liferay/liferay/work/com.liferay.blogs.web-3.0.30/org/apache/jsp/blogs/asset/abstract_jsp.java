...
BlogsEntry entry = (BlogsEntry)request.getAttribute(WebKeys.BLOGS_ENTRY);
      ...
      _jspx_th_c_if_1.setTest( blogsPortletInstanceConfiguration.enableViewCount() );
      ...
      _jspx_th_c_if_2.setTest( Validator.isNotNull(coverImageURL) );
      ...
      out.write("\n\n\t\t\t\t");
      out.print( HtmlUtil.stripHtml(assetRenderer.getSummary(renderRequest, renderResponse)) );
      out.write("\n\t\t\t</p>\n\t\t</div>\n\t</div>\n</div>");
    } catch (Throwable t) {
