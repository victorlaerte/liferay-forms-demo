...
String productMenuState = SessionClicks.get(request, ProductNavigationProductMenuWebKeys.PRODUCT_NAVIGATION_PRODUCT_MENU_STATE, "closed");
      ...
      out.print( themeDisplay.getRealCompanyLogo() );
      ...
      _jspx_th_c_if_0.setTest( Objects.equals(productMenuState, "open") );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_1.setTest( productMenuDisplayContext.hasUserPanelCategory() );
          int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\tLiferay.on(\n\t\t\t'ProductMenu:openUserMenu',\n\t\t\tfunction(event) {\n\t\t\t\tvar userCollapseSelector = '#");
            if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_1, _jspx_page_context))
              return;
            out.print( AUIUtil.normalizeId(PanelCategoryKeys.USER) );
  ...
  private boolean _jspx_meth_aui_icon_0(PageContext _jspx_page_context)
    ...
    _jspx_th_aui_icon_0.setCssClass("d-inline-block d-md-none icon-monospaced sidenav-close");
