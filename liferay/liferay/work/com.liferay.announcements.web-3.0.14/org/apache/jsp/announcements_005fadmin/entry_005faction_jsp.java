...
AnnouncementsEntry entry = (AnnouncementsEntry)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_0.setTest( AnnouncementsEntryPermission.contains(permissionChecker, entry, ActionKeys.UPDATE) );
          ...
          _jspx_th_c_if_1.setTest( AnnouncementsEntryPermission.contains(permissionChecker, entry, ActionKeys.DELETE) );
