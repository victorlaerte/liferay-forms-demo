...
UADDisplay uadDisplay = (UADDisplay)request.getAttribute(UADWebKeys.INFO_PANEL_UAD_DISPLAY);
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( ListUtil.isEmpty(uadEntities) );
        int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t<div class=\"sidebar-header\">\n\t\t\t\t<h3 class=\"sidebar-title\">");
          out.print( uadDisplay.getTypeName(locale) );
          out.write("</h3>\n\t\t\t\t<h5 class=\"sidebar-subtitle\">");
          out.print( UADLanguageUtil.getApplicationName(uadDisplay, locale) );
          out.write("</h5>\n\t\t\t</div>\n\t\t");
        }
        ...
        _jspx_th_c_when_1.setTest( ListUtil.isNotEmpty(uadEntities) && (uadEntities.size() == 1) );
        ...
        if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_icon$1menu_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_1);
          ...
          _jspx_tagPool_liferay$1ui_icon$1menu_triggerCssClass_showWhenSingleIcon_message_markupView_icon_direction.reuse(_jspx_th_liferay$1ui_icon$1menu_0);
          out.write("\n\t\t\t\t\t</li>\n\t\t\t\t</ul>\n\n\t\t\t\t<h3 class=\"sidebar-title\">");
          out.print( SafeDisplayValueUtil.get(displayValues.get(identifierFieldName)) );
          out.write("</h3>\n\n\t\t\t\t<h5 class=\"sidebar-subtitle\">");
          out.print( uadDisplay.getTypeName(locale) );
          out.write("</h5>\n\t\t\t</div>\n\n\t\t\t<div class=\"sidebar-body\">\n\t\t\t\t<dl class=\"sidebar-block sidebar-dl sidebar-section\">\n\t\t\t\t\t<dt class=\"sidebar-dt\">");
          out.print( LanguageUtil.get(request, "primary-key") );
          out.write("</dt>\n\t\t\t\t\t<dd class=\"sidebar-dd\">");
          ...
          out.write("</dt>\n\t\t\t\t\t\t<dd class=\"sidebar-dd\">");
          out.print( SafeDisplayValueUtil.get(entry.getValue()) );
          out.write("</dd>\n\n\t\t\t\t\t");
        ...
        _jspx_th_c_when_2.setTest( ListUtil.isNotEmpty(uadEntities) && (uadEntities.size() > 1) );
        ...
        if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_0.setArguments( uadEntities.size() );
          _jspx_th_liferay$1ui_message_0.setKey("x-items-are-selected");
