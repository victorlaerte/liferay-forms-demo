...
public final class subscription_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
AssetRenderer assetRenderer = MySubscriptionsUtil.getAssetRenderer(subscription.getClassName(), subscription.getClassPK());
	...
	if (assetRenderer != null) {
		...
		viewURL = MySubscriptionsUtil.getAssetURLViewInContext(themeDisplay, subscription.getClassName(), subscription.getClassPK());
          ...
          _jspx_th_c_if_0.setTest( viewURL != null );
	...
	if (assetRenderer != null) {
		...
		if (Validator.isNotNull(displayPopupURL)) {
          ...
          _jspx_th_c_if_1.setTest( displayPopupHREF != null );
          ...
          if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_icon_1.setIconCssClass("icon-list-alt");
            _jspx_th_liferay$1ui_icon_1.setMessage("view-in-popup");
            _jspx_th_liferay$1ui_icon_1.setUrl( displayPopupHREF );
          ...
          if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_1.setName("subscriptionIds");
            _jspx_th_portlet_param_1.setValue( String.valueOf(subscription.getSubscriptionId()) );
          ...
          _jspx_th_liferay$1ui_icon_2.setIconCssClass("icon-remove-sign");
