...
if (classPK > 0) {
	websites = WebsiteServiceUtil.getWebsites(className, classPK);
      ...
      _jspx_th_c_if_0.setTest( !websites.isEmpty() );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n\n\t\t\t<li class=\"");
        out.print( (website.isPrimary() && !websites.isEmpty()) ? "icon-star" : StringPool.BLANK );
        out.write("\">\n\t\t\t\t<a href=\"");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("websites");
