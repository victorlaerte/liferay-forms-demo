...
for (int i = 0; i < organizations.size(); i++) {
	try {
      ...
      _jspx_th_c_if_0.setTest( !personalPhones.isEmpty() || !organizationPhones.isEmpty() );
      int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n\t<h3 class=\"icon-phone-sign\">");
        ...
        _jspx_th_c_if_1.setTest( !organizationPhones.isEmpty() );
        ...
        if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\n\n\t\t\t\t<li class=\"");
          out.print( (phone.isPrimary() && !organizationPhones.isEmpty()) ? "icon-star" : StringPool.BLANK );
          out.write("\">\n\t\t\t\t\t");
        ...
        _jspx_th_c_if_2.setTest( !personalPhones.isEmpty() );
        ...
        if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\n\n\t\t\t\t<li class=\"");
          out.print( (phone.isPrimary() && !personalPhones.isEmpty()) ? "icon-star" : StringPool.BLANK );
          out.write("\">\n\t\t\t\t\t");
          out.print( HtmlUtil.escape(phone.getNumber()) );
          out.write(' ');
          out.print( phone.getExtension() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("phones");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("organization-phones");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("personal-phones");
