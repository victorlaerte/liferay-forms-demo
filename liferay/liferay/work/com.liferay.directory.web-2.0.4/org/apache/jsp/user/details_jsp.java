...
for (int i = 1; i<organizations.size(); i++) {
	organizationsHTML += ", "+ organizations.get(i).getName();
      ...
      _jspx_th_liferay$1ui_user$1portrait_0.setUser( selUser );
      ...
      _jspx_th_c_if_0.setTest( Validator.isNotNull(selUser.getDisplayEmailAddress()) );
      ...
      _jspx_th_c_if_1.setTest( PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.FIELD_ENABLE_COM_LIFERAY_PORTAL_KERNEL_MODEL_CONTACT_BIRTHDAY) );
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_meth_liferay$1ui_message_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_1, _jspx_page_context))
          return;
        out.write("\n\t\t\t</dt>\n\t\t\t<dd>\n\t\t\t\t");
        out.print( dateFormatDate.format(selUser.getBirthday()) );
        out.write("\n\t\t\t</dd>\n\t\t");
      }
      ...
      _jspx_th_c_if_2.setTest( Validator.isNotNull(selContact.getJobTitle()) );
      ...
      if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_meth_liferay$1ui_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_2, _jspx_page_context))
          return;
        out.write("\n\t\t\t</dt>\n\t\t\t<dd>\n\t\t\t\t");
        out.print( HtmlUtil.escape(selContact.getJobTitle()) );
        out.write("\n\t\t\t</dd>\n\t\t");
      }
      ...
      _jspx_th_c_if_3.setTest( PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.FIELD_ENABLE_COM_LIFERAY_PORTAL_KERNEL_MODEL_CONTACT_MALE) );
      ...
      if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_3, _jspx_page_context))
          return;
        out.write("\n\t\t\t</dt>\n\t\t\t<dd>\n\t\t\t\t");
        out.print( LanguageUtil.get(request, selUser.isMale() ? "male" : "female") );
        out.write("\n\t\t\t</dd>\n\t\t");
      }
      ...
      _jspx_th_c_if_4.setTest( !organizations.isEmpty() );
      ...
      if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_when_0.setTest( organizations.size() > 1 );
        ...
        _jspx_tagPool_c_choose.reuse(_jspx_th_c_choose_0);
        out.write("\n\t\t\t</dt>\n\t\t\t<dd>\n\t\t\t\t");
        out.print( HtmlUtil.escape(organizationsHTML) );
        out.write("\n\t\t\t</dd>\n\t\t");
      }
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("email-address");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("birthday");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("job-title");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("gender");
  ...
  private boolean _jspx_meth_liferay$1ui_message_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_4.setKey("organizations");
  ...
  private boolean _jspx_meth_liferay$1ui_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_5.setKey("organization");
