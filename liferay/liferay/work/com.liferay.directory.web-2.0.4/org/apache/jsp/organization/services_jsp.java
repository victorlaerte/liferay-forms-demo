...
Format timeFormat = FastDateFormatFactoryUtil.getSimpleDateFormat("HH:mm", locale);
      ...
      _jspx_th_c_if_0.setTest( !orgLabors.isEmpty() );
	...
	for (int i = 0; i < orgLabors.size(); i++) {
        ...
        out.print( LanguageUtil.get(request, ListTypeServiceUtil.getListType(orgLabor.getTypeId()).getName()) );
        ...
        out.write("\n\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t");
        out.print( (curOpen != -1) ? timeFormat.format(cal.getTime()) : "" );
        out.write("\n\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t");
        ...
        out.write("\n\n\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t");
        out.print( (curClose != -1) ? timeFormat.format(cal.getTime()) : "" );
        out.write("\n\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("services");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("open");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("close[status]");
