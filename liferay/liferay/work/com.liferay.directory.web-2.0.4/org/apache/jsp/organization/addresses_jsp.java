...
if (classPK > 0) {
	addresses = AddressServiceUtil.getAddresses(className, classPK);
      ...
      _jspx_th_c_if_0.setTest( !addresses.isEmpty() );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n\n\t\t\t<li class=\"");
        out.print( (address.isPrimary() && !addresses.isEmpty()) ? "icon-star" : StringPool.BLANK );
        out.write("\">\n\t\t\t\t");
        out.write('\n');
        out.write('\n');
...
String mailingName = LanguageUtil.get(request, addressListType.getName());
        ...
        _jspx_th_liferay$1text$1localizer_address$1display_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        ...
        _jspx_th_c_if_1.setTest( address.isMailing() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("mailing");
