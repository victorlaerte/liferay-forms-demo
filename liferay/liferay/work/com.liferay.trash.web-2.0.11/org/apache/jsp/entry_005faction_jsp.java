...
if (row != null) {
	...
	TrashHandler trashHandler = TrashHandlerRegistryUtil.getTrashHandler(trashEntry.getClassName());
          ...
          if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_c_when_0.setTest( trashHandler.isRestorable(trashEntry.getClassPK()) && !trashHandler.isInTrashContainer(trashEntry.getClassPK()) );
            ...
            _jspx_th_c_when_1.setTest( !trashHandler.isRestorable(trashEntry.getClassPK()) && trashHandler.isMovable() );
            ...
            if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                _jspx_th_portlet_param_5.setValue( String.valueOf(PortalUtil.getClassNameId(trashHandler.getContainerModelClassName(trashEntry.getClassPK()))) );
