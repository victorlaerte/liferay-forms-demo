...
FileEntry fileEntry = (FileEntry)request.getAttribute(WebKeys.DOCUMENT_LIBRARY_FILE_ENTRY);
      ...
      out.write("isViewFileEntry = true;\n\t}\n</script>\n\n");
      //  aui:script
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("',\n\t\t\t\tgroupId: '");
          out.print( fileEntry.getGroupId() );
          out.write("',\n\t\t\t\tfileEntryUUID: '");
          out.print( fileEntry.getUuid() );
          out.write("',\n\t\t\t\ttitle: '");
          out.print( HtmlUtil.escapeJS(fileEntry.getTitle()) );
          out.write("',\n\t\t\t\tversion: '");
          out.print( fileEntry.getVersion() );
          out.write("'\n\t\t\t}\n\t\t);\n\n\t}\n");
