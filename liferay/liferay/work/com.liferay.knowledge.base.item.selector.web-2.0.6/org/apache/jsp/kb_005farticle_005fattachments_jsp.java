...
public final class kb_005farticle_005fattachments_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (kbAttachmentItemSelectorViewDisplayContext.isSearch()) {
	...
	portletFileEntriesCount = PortletFileRepositoryUtil.getPortletFileEntriesCount(scopeGroupId, folderId, WorkflowConstants.STATUS_APPROVED);
      ...
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setEmptyResultsMessage( LanguageUtil.get(resourceBundle, "there-are-no-attachments") );
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setItemSelectedEventName( kbAttachmentItemSelectorViewDisplayContext.getItemSelectedEventName() );
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setItemSelectorReturnTypeResolver( kbAttachmentItemSelectorViewDisplayContext.getItemSelectorReturnTypeResolver() );
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setPortletURL( kbAttachmentItemSelectorViewDisplayContext.getPortletURL(request, liferayPortletResponse) );
      ...
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setTabName( kbAttachmentItemSelectorViewDisplayContext.getTitle(locale) );
      _jspx_th_liferay$1item$1selector_repository$1entry$1browser_0.setUploadURL( kbAttachmentItemSelectorViewDisplayContext.getUploadURL(liferayPortletResponse) );
