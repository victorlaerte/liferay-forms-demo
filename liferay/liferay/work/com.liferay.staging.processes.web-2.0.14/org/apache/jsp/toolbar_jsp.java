...
public final class toolbar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody;
  ...
  public void _jspInit() {
    _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody.release();
...
portletURL.setParameter("searchContainerId", String.valueOf(searchContainerId));
      ...
      com.liferay.frontend.taglib.clay.servlet.taglib.soy.ManagementToolbarTag _jspx_th_clay_management$1toolbar_0 = (com.liferay.frontend.taglib.clay.servlet.taglib.soy.ManagementToolbarTag) _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody.get(com.liferay.frontend.taglib.clay.servlet.taglib.soy.ManagementToolbarTag.class);
      _jspx_th_clay_management$1toolbar_0.setPageContext(_jspx_page_context);
      _jspx_th_clay_management$1toolbar_0.setParent(null);
      _jspx_th_clay_management$1toolbar_0.setActionDropdownItems( stagingProcessesWebToolbarDisplayContext.getActionDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( stagingProcessesWebToolbarDisplayContext.getCreationMenu(GroupPermissionUtil.contains(permissionChecker, stagingGroupId, ActionKeys.PUBLISH_STAGING)) );
      _jspx_th_clay_management$1toolbar_0.setFilterDropdownItems( stagingProcessesWebToolbarDisplayContext.getFilterDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setSearchContainerId( searchContainerId );
      _jspx_th_clay_management$1toolbar_0.setShowCreationMenu( tabs1.equals("processes") );
      _jspx_th_clay_management$1toolbar_0.setShowSearch( false );
      _jspx_th_clay_management$1toolbar_0.setSortingOrder( stagingProcessesWebToolbarDisplayContext.getSortingOrder() );
      _jspx_th_clay_management$1toolbar_0.setSortingURL( stagingProcessesWebToolbarDisplayContext.getSortingURL() );
      _jspx_th_clay_management$1toolbar_0.setViewTypeItems( stagingProcessesWebToolbarDisplayContext.getViewTypeItems() );
      ...
      if (_jspx_th_clay_management$1toolbar_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody.reuse(_jspx_th_clay_management$1toolbar_0);
        return;
      }
      _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showCreationMenu_searchContainerId_filterDropdownItems_creationMenu_actionDropdownItems_nobody.reuse(_jspx_th_clay_management$1toolbar_0);
    } catch (Throwable t) {
