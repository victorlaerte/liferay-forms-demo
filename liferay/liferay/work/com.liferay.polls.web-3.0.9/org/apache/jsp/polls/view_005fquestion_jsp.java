...
public final class view_005fquestion_jsp extends org.apache.jasper.runtime.HttpJspBase
...
portletDisplay.setURLBack(redirect);
      ...
      _jspx_th_portlet_actionURL_0.setName("/polls/view_question");
      _jspx_th_portlet_actionURL_0.setVar("viewQuestionActionURL");
      ...
      _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String viewQuestionActionURL = null;
      viewQuestionActionURL = (java.lang.String) _jspx_page_context.findAttribute("viewQuestionActionURL");
      out.write('\n');
      out.write('\n');
      //  aui:form
      ...
      _jspx_th_aui_form_0.setAction( viewQuestionActionURL );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_renderURL_0.setVar("viewQuestionRenderURL");
        ...
        if (_jspx_eval_portlet_renderURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_portlet_param_3.setName("questionId");
          _jspx_th_portlet_param_3.setValue( String.valueOf(question.getQuestionId()) );
        ...
        _jspx_tagPool_portlet_renderURL_var.reuse(_jspx_th_portlet_renderURL_0);
        java.lang.String viewQuestionRenderURL = null;
        viewQuestionRenderURL = (java.lang.String) _jspx_page_context.findAttribute("viewQuestionRenderURL");
        out.write("\n\n\t");
        //  aui:input
        ...
        _jspx_th_aui_input_1.setValue( viewQuestionRenderURL );
        ...
        if (_jspx_eval_aui_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              _jspx_th_c_when_0.setTest( !viewResults && !question.isExpired() && !hasVoted && PollsQuestionPermission.contains(permissionChecker, question, ActionKeys.ADD_VOTE) );
              ...
              if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_aui_input_3.setLabel( choice.getName() + ". " + choice.getDescription(locale) );
                  _jspx_th_aui_input_3.setName("choiceId");
                  _jspx_th_aui_input_3.setType("radio");
                  _jspx_th_aui_input_3.setValue( choice.getChoiceId() );
                ...
                _jspx_th_c_if_0.setTest( PollsQuestionPermission.contains(permissionChecker, question, ActionKeys.UPDATE) );
                ...
                if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_portlet_renderURL_1.setVar("viewResultsURL");
                  ...
                  if (_jspx_eval_portlet_renderURL_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_portlet_param_6.setName("questionId");
                    _jspx_th_portlet_param_6.setValue( String.valueOf(question.getQuestionId()) );
                  ...
                  _jspx_tagPool_portlet_renderURL_var.reuse(_jspx_th_portlet_renderURL_1);
                  java.lang.String viewResultsURL = null;
                  viewResultsURL = (java.lang.String) _jspx_page_context.findAttribute("viewResultsURL");
                  out.write("\n\n\t\t\t\t\t\t");
                  //  liferay-ui:icon
                  ...
                  _jspx_th_liferay$1ui_icon_0.setMessage("view-results");
                  _jspx_th_liferay$1ui_icon_0.setUrl( viewResultsURL );
...
NumberFormat percentFormat = NumberFormat.getPercentInstance(locale);
			...
			for (int i = 0; i < choices.size(); i++) {
                ...
                _jspx_th_c_if_1.setTest( PollsPortletKeys.POLLS.equals(portletDisplay.getId()) );
		...
		for (int i = 0; i < _CHARTS.length; i++) {
			...
			String taglibHREF = "javascript:var viewChartWindow = window.open('" + resourceURL + "', 'viewChart', 'directories=no,height=430,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no,width=420'); void(''); viewChartWindow.focus();";
                  ...
                  if (_jspx_eval_aui_a_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_liferay$1ui_message_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_a_0);
                    _jspx_th_liferay$1ui_message_3.setKey( chart );
                  ...
                  _jspx_th_c_if_2.setTest( PollsQuestionPermission.contains(permissionChecker, question, ActionKeys.UPDATE) );
		...
		for (int i = 0; i < results.size(); i++) {
			...
			resultRows.add(row);
                    ...
                    _jspx_th_liferay$1ui_search$1iterator_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_2);
                ...
                _jspx_th_c_if_3.setTest( question.isExpired() );
                ...
                if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_liferay$1ui_message_4.setArguments( dateFormatDateTime.format(question.getExpirationDate()) );
                  _jspx_th_liferay$1ui_message_4.setKey("voting-is-disabled-because-this-poll-expired-on-x");
                ...
                _jspx_th_portlet_renderURL_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_0);
                _jspx_th_portlet_renderURL_2.setVar("viewQuestionURL");
                ...
                if (_jspx_eval_portlet_renderURL_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_portlet_param_10.setName("questionId");
                  _jspx_th_portlet_param_10.setValue( String.valueOf(question.getQuestionId()) );
                ...
                _jspx_tagPool_portlet_renderURL_var.reuse(_jspx_th_portlet_renderURL_2);
                java.lang.String viewQuestionURL = null;
                viewQuestionURL = (java.lang.String) _jspx_page_context.findAttribute("viewQuestionURL");
                ...
                if (_jspx_eval_c_choose_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  _jspx_th_c_when_1.setTest( !question.isExpired() && !hasVoted && PollsQuestionPermission.contains(permissionChecker, question, ActionKeys.ADD_VOTE) );
                  ...
                  if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    _jspx_th_aui_button_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_1);
                    _jspx_th_aui_button_2.setHref( viewQuestionURL );
                    _jspx_th_aui_button_2.setValue("back-to-vote");
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("/polls/view_question");
  ...
  private boolean _jspx_meth_portlet_param_1(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_1.setValue("/polls/view_question");
  ...
  private boolean _jspx_meth_portlet_param_4(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_4.setValue("/polls/view_question");
  ...
  private boolean _jspx_meth_portlet_param_7(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_7.setName("viewResults");
    _jspx_th_portlet_param_7.setValue("1");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("votes");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("total-votes");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("charts");
  ...
  private boolean _jspx_meth_portlet_param_8(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_2, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_8.setValue("/polls/view_question");
