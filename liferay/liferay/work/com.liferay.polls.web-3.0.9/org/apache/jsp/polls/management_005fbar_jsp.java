...
PollsDisplayContext pollsDisplayContext = new PollsDisplayContext(renderRequest, renderResponse);
      ...
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( pollsDisplayContext.getClearResultsURL() );
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( pollsDisplayContext.getCreationMenu() );
      _jspx_th_clay_management$1toolbar_0.setDisabled( pollsDisplayContext.isDisabledManagementBar() );
      _jspx_th_clay_management$1toolbar_0.setFilterDropdownItems( pollsDisplayContext.getFilterItemsDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setItemsTotal( pollsDisplayContext.getTotalItems() );
      _jspx_th_clay_management$1toolbar_0.setNamespace( renderResponse.getNamespace() );
      _jspx_th_clay_management$1toolbar_0.setSearchActionURL( pollsDisplayContext.getSearchActionURL() );
      _jspx_th_clay_management$1toolbar_0.setSearchContainerId( pollsDisplayContext.getSearchContainerId() );
      ...
      _jspx_th_clay_management$1toolbar_0.setSortingOrder( pollsDisplayContext.getOrderByType() );
      _jspx_th_clay_management$1toolbar_0.setSortingURL( pollsDisplayContext.getSortingURL() );
