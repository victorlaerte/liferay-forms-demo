...
String termsOfUseArticleId = PrefsPropsUtil.getString(themeDisplay.getCompanyId(), JournalServiceConfigurationKeys.TERMS_OF_USE_JOURNAL_ARTICLE_ID, JournalServiceConfigurationValues.TERMS_OF_USE_JOURNAL_ARTICLE_ID);
      ...
      _jspx_th_aui_field$1wrapper_0.setHelpMessage( LanguageUtil.get(resourceBundle, "terms-of-use-web-content-help") );
      _jspx_th_aui_field$1wrapper_0.setLabel( LanguageUtil.get(resourceBundle, "terms-of-use-web-content") );
      ...
      if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_fieldset_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_0);
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setLabel( LanguageUtil.get(resourceBundle, "group-id") );
          _jspx_th_aui_input_0.setName( "settings--" + JournalServiceConfigurationKeys.TERMS_OF_USE_JOURNAL_ARTICLE_GROUP_ID + "--" );
          _jspx_th_aui_input_0.setType("text");
          _jspx_th_aui_input_0.setValue( termsOfUseGroupId );
          ...
          _jspx_th_aui_input_1.setLabel( LanguageUtil.get(resourceBundle, "article-id") );
          _jspx_th_aui_input_1.setName( "settings--" + JournalServiceConfigurationKeys.TERMS_OF_USE_JOURNAL_ARTICLE_ID + "--" );
          _jspx_th_aui_input_1.setType("text");
          _jspx_th_aui_input_1.setValue( termsOfUseArticleId );
