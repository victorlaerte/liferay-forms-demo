...
public final class view_005fnode_005fdeleted_005fattachments_jsp extends org.apache.jasper.runtime.HttpJspBase
...
renderResponse.setTitle(LanguageUtil.get(request, "removed-attachments"));
      ...
      _jspx_th_portlet_actionURL_0.setName("/wiki/edit_node_attachment");
      ...
      if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_param_0.setValue( String.valueOf(node.getPrimaryKey()) );
	...
	String trashEntriesMaxAgeTimeDescription = LanguageUtil.getTimeDescription(locale, trashHelper.getMaxAge(themeDisplay.getScopeGroup()) * Time.MINUTE, true);
      ...
      _jspx_th_liferay$1trash_empty_0.setConfirmMessage("are-you-sure-you-want-to-remove-the-attachments-for-this-wiki-node");
      _jspx_th_liferay$1trash_empty_0.setEmptyMessage("remove-the-attachments-for-this-wiki-node");
      ...
      _jspx_th_liferay$1trash_empty_0.setTotalEntries( attachmentsFileEntries.size() );
	...
	int status = WorkflowConstants.STATUS_IN_TRASH;
      ...
      if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		String rowURL = PortletFileRepositoryUtil.getDownloadPortletFileEntryURL(themeDisplay, fileEntry, "status=" + status);
            ...
            _jspx_th_c_if_0.setTest( showPageAttachmentAction );
