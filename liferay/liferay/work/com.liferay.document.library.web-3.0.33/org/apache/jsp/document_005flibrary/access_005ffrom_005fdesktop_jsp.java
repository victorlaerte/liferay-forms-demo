...
public final class access_005ffrom_005fdesktop_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (row != null) {
	...
	if (folder == null) {
      ...
      out.write('\n');
      //  liferay-ui:icon
      com.liferay.taglib.ui.IconTag _jspx_th_liferay$1ui_icon_0 = (com.liferay.taglib.ui.IconTag) _jspx_tagPool_liferay$1ui_icon_url_message_cssClass_nobody.get(com.liferay.taglib.ui.IconTag.class);
      _jspx_th_liferay$1ui_icon_0.setPageContext(_jspx_page_context);
      _jspx_th_liferay$1ui_icon_0.setParent(null);
      _jspx_th_liferay$1ui_icon_0.setCssClass( randomNamespace + "-webdav-action" );
      _jspx_th_liferay$1ui_icon_0.setMessage("access-from-desktop");
      _jspx_th_liferay$1ui_icon_0.setUrl("javascript:;");
      int _jspx_eval_liferay$1ui_icon_0 = _jspx_th_liferay$1ui_icon_0.doStartTag();
      if (_jspx_th_liferay$1ui_icon_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        _jspx_tagPool_liferay$1ui_icon_url_message_cssClass_nobody.reuse(_jspx_th_liferay$1ui_icon_0);
        return;
      }
      _jspx_tagPool_liferay$1ui_icon_url_message_cssClass_nobody.reuse(_jspx_th_liferay$1ui_icon_0);
      out.write("\n\n<div id=\"");
      ...
      _jspx_th_liferay$1ui_message_0.setKey( webDavHelpMessage );
      ...
      _jspx_th_aui_input_0.setCssClass("webdav-url-resource");
      _jspx_th_aui_input_0.setName("webDavURL");
      _jspx_th_aui_input_0.setType("resource");
      _jspx_th_aui_input_0.setValue( DLUtil.getWebDavURL(themeDisplay, folder, null) );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n\tvar webdavAction = A.one('.");
          out.print( randomNamespace );
          out.write("-webdav-action');\n\n\tif (webdavAction) {\n\t\twebdavAction.on(\n\t\t\t'click',\n\t\t\tfunction(event) {\n\t\t\t\tevent.preventDefault();\n\n\t\t\t\tvar webdavDialog = Liferay.Util.Window.getWindow(\n\t\t\t\t\t{\n\t\t\t\t\t\tdialog: {\n\t\t\t\t\t\t\tbodyContent: A.one('#");
          out.print( randomNamespace );
          out.write("webDav').html(),\n\t\t\t\t\t\t\tdestroyOnHide: true\n\t\t\t\t\t\t},\n\t\t\t\t\t\ttitle: '");
          out.print( UnicodeLanguageUtil.get(request, "access-from-desktop") );
          out.write("'\n\t\t\t\t\t}\n\t\t\t\t);\n\n\t\t\t\twebdavDialog.after(\n\t\t\t\t\t'render',\n\t\t\t\t\tfunction(event) {\n\t\t\t\t\t\tvar webdavURLInput = webdavDialog.get('boundingBox').one('#");
