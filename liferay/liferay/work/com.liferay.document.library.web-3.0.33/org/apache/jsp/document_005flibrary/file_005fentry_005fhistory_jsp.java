...
public final class file_005fentry_005fhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
...
StagingGroupHelper stagingGroupHelper = StagingGroupHelperUtil.getStagingGroupHelper();
	...
	for (FileVersion fileVersion : fileVersions) {
      ...
      _jspx_th_liferay$1ui_message_0.setArguments( fileVersion.getVersion() );
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( Validator.isNull(fileVersion.getChangeLog()) );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          out.write("\n\t\t\t\t\t\t");
          out.print( fileVersion.getChangeLog() );
          out.write("\n\t\t\t\t\t");
        }
      ...
      _jspx_th_liferay$1ui_message_2.setArguments( new Object[] {HtmlUtil.escape(fileVersion.getUserName()), dateFormatDateTime.format(fileVersion.getCreateDate())} );
      ...
      _jspx_th_liferay$1util_include_0.setPage("/document_library/file_entry_history_action.jsp");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("no-change-log");
