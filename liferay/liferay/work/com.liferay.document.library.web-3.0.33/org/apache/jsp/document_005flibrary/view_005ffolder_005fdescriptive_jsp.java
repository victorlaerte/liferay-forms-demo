...
rowURL.setParameter("folderId", String.valueOf(folder.getFolderId()));
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( Validator.isNull(folder.getUserName()) );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_0.setArguments( new String[] {modifiedDateDescription} );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_message_1.setArguments( new String[] {folder.getUserName(), modifiedDateDescription} );
