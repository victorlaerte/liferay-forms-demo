package org.apache.jsp.document_005flibrary.asset;
...
public final class file_005fentry_005fabstract_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (fileEntry.getVersion().equals(fileVersion.getVersion())) {
	showThumbnail = true;
      ...
      _jspx_th_c_if_0.setTest( fileVersion.isApproved() );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_c_when_0.setTest( showThumbnail && ImageProcessorUtil.hasImages(fileVersion) );
          ...
          if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_0.setKey("image");
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_0);
            out.write("\" class=\"img-thumbnail\" src=\"");
            out.print( DLUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&imageThumbnail=1") );
            out.write("\" style=\"");
            out.print( DLUtil.getThumbnailStyle(true, 0, 128, 128) );
            out.write("\" />\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"asset-description\">\n\t\t\t\t\t");
            out.print( HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength)) );
            out.write("\n\t\t\t\t</p>\n\t\t\t");
          }
          ...
          _jspx_th_c_when_1.setTest( showThumbnail && PDFProcessorUtil.hasImages(fileVersion) );
          ...
          if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_1.setKey("document");
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_1);
            out.write("\" class=\"img-thumbnail\" src=\"");
            out.print( DLUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&documentThumbnail=1") );
            out.write("\" style=\"");
            out.print( DLUtil.getThumbnailStyle(true, 0, 128, 128) );
            out.write("\" />\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"asset-description\">\n\t\t\t\t\t");
            out.print( HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength)) );
          ...
          _jspx_th_c_when_2.setTest( showThumbnail && VideoProcessorUtil.hasVideo(fileVersion) );
          ...
          if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_2.setKey("video");
            ...
            _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_2);
            out.write("\" class=\"img-thumbnail\" src=\"");
            out.print( DLUtil.getPreviewURL(fileEntry, fileVersion, themeDisplay, "&videoThumbnail=1") );
            out.write("\" style=\"");
            out.print( DLUtil.getThumbnailStyle(true, 0, 128, 128) );
            out.write("\" />\n\t\t\t\t</div>\n\n\t\t\t\t<p class=\"asset-description\">\n\t\t\t\t\t");
            out.print( HtmlUtil.escape(StringUtil.shorten(fileEntry.getDescription(), abstractLength)) );
          ...
          if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_icon_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_0);
            _jspx_th_liferay$1ui_icon_0.setIconCssClass("icon-download");
            _jspx_th_liferay$1ui_icon_0.setLabel( true );
            _jspx_th_liferay$1ui_icon_0.setMessage( LanguageUtil.format(request, "download-x", taglibFileEntryTitle, false) + " (" + TextFormatter.formatStorageSize(fileVersion.getSize(), locale) + ")" );
            _jspx_th_liferay$1ui_icon_0.setMethod("get");
            _jspx_th_liferay$1ui_icon_0.setUrl( assetRenderer.getURLDownload(themeDisplay) );
