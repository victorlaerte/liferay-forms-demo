...
public final class toolbar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showInfoButton_selectable_searchContainerId_searchActionURL_itemsTotal_infoPanelId_filterDropdownItems_disabled_creationMenu_clearResultsURL_actionHandler_actionDropdownItems_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showInfoButton_selectable_searchContainerId_searchActionURL_itemsTotal_infoPanelId_filterDropdownItems_disabled_creationMenu_clearResultsURL_actionHandler_actionDropdownItems_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_clay_management$1toolbar_viewTypeItems_sortingURL_sortingOrder_showSearch_showInfoButton_selectable_searchContainerId_searchActionURL_itemsTotal_infoPanelId_filterDropdownItems_disabled_creationMenu_clearResultsURL_actionHandler_actionDropdownItems_nobody.release();
...
DLAdminManagementToolbarDisplayContext dlAdminManagementToolbarDisplayContext = new DLAdminManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletResponse, request, dlAdminDisplayContext);
      ...
      _jspx_th_clay_management$1toolbar_0.setActionDropdownItems( dlAdminManagementToolbarDisplayContext.getActionDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setActionHandler( renderResponse.getNamespace() + "DocumentLibrary" );
      _jspx_th_clay_management$1toolbar_0.setClearResultsURL( dlAdminManagementToolbarDisplayContext.getClearResultsURL() );
      _jspx_th_clay_management$1toolbar_0.setCreationMenu( dlAdminManagementToolbarDisplayContext.getCreationMenu() );
      _jspx_th_clay_management$1toolbar_0.setDisabled( dlAdminManagementToolbarDisplayContext.isDisabled() );
      _jspx_th_clay_management$1toolbar_0.setFilterDropdownItems( dlAdminManagementToolbarDisplayContext.getFilterDropdownItems() );
      _jspx_th_clay_management$1toolbar_0.setInfoPanelId("infoPanelId");
      _jspx_th_clay_management$1toolbar_0.setItemsTotal( dlAdminManagementToolbarDisplayContext.getTotalItems() );
      _jspx_th_clay_management$1toolbar_0.setSearchActionURL( String.valueOf(dlAdminManagementToolbarDisplayContext.getSearchURL()) );
      _jspx_th_clay_management$1toolbar_0.setSearchContainerId("entries");
      _jspx_th_clay_management$1toolbar_0.setSelectable( dlAdminManagementToolbarDisplayContext.isSelectable() );
      _jspx_th_clay_management$1toolbar_0.setShowInfoButton( true );
      _jspx_th_clay_management$1toolbar_0.setShowSearch( dlAdminManagementToolbarDisplayContext.isShowSearch() );
      _jspx_th_clay_management$1toolbar_0.setSortingOrder( dlAdminManagementToolbarDisplayContext.getSortingOrder() );
      _jspx_th_clay_management$1toolbar_0.setSortingURL( String.valueOf(dlAdminManagementToolbarDisplayContext.getSortingURL()) );
      _jspx_th_clay_management$1toolbar_0.setViewTypeItems( dlAdminManagementToolbarDisplayContext.getViewTypes() );
