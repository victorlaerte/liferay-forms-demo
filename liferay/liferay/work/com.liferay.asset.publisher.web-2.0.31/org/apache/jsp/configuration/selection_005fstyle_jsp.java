...
public final class selection_005fstyle_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Format dateFormatDate = FastDateFormatFactoryUtil.getDate(locale, timeZone);
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( !assetPublisherDisplayContext.isSelectionStyleEnabled() );
        ...
        if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_fieldset_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_otherwise_0);
          _jspx_th_aui_fieldset_0.setMarkupView("lexicon");
          int _jspx_eval_aui_fieldset_0 = _jspx_th_aui_fieldset_0.doStartTag();
          if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n\t\t\t");
            //  aui:input
            com.liferay.taglib.aui.InputTag _jspx_th_aui_input_1 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.get(com.liferay.taglib.aui.InputTag.class);
            _jspx_th_aui_input_1.setPageContext(_jspx_page_context);
            _jspx_th_aui_input_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
            _jspx_th_aui_input_1.setChecked( assetPublisherDisplayContext.isSelectionStyleDynamic() );
            _jspx_th_aui_input_1.setId("selectionStyleDynamic");
            _jspx_th_aui_input_1.setLabel("dynamic");
            _jspx_th_aui_input_1.setName("preferences--selectionStyle--");
            _jspx_th_aui_input_1.setOnChange( renderResponse.getNamespace() + "chooseSelectionStyle();" );
            _jspx_th_aui_input_1.setType("radio");
            _jspx_th_aui_input_1.setValue(new String("dynamic"));
            int _jspx_eval_aui_input_1 = _jspx_th_aui_input_1.doStartTag();
            if (_jspx_th_aui_input_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.reuse(_jspx_th_aui_input_1);
              return;
            }
            _jspx_tagPool_aui_input_value_type_onChange_name_label_id_checked_nobody.reuse(_jspx_th_aui_input_1);
            out.write("\n\n\t\t\t");
            ...
            _jspx_th_aui_input_2.setChecked( assetPublisherDisplayContext.isSelectionStyleManual() );
            _jspx_th_aui_input_2.setId("selectionStyleManual");
            _jspx_th_aui_input_2.setLabel("manual");
            _jspx_th_aui_input_2.setName("preferences--selectionStyle--");
            _jspx_th_aui_input_2.setOnChange( renderResponse.getNamespace() + "chooseSelectionStyle();" );
            _jspx_th_aui_input_2.setType("radio");
            _jspx_th_aui_input_2.setValue(new String("manual"));
  ...
  private boolean _jspx_meth_aui_input_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_input_0.setName("preferences--selectionStyle--");
    _jspx_th_aui_input_0.setType("hidden");
    _jspx_th_aui_input_0.setValue(new String("dynamic"));
