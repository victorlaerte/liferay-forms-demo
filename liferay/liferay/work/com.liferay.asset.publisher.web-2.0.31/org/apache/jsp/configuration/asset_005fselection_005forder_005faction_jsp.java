...
public final class asset_005fselection_005forder_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean last = (assetEntryOrder == (searchContainer.getTotal() - 1));
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( (assetEntryOrder == 0) && last );
        ...
        _jspx_th_c_when_1.setTest( (assetEntryOrder > 0) && !last );
		...
		String taglibDownURL = "javascript:" + renderResponse.getNamespace() + "moveSelectionDown('" + assetEntryOrder + "')";
          ...
          _jspx_th_liferay$1ui_icon_0.setIcon("angle-down");
          _jspx_th_liferay$1ui_icon_0.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_0.setMessage("down");
          _jspx_th_liferay$1ui_icon_0.setUrl( taglibDownURL );
		...
		String taglibUpURL = "javascript:" + renderResponse.getNamespace() + "moveSelectionUp('" + assetEntryOrder + "')";
          ...
          out.write("\n\n\t\t");
          //  liferay-ui:icon
          com.liferay.taglib.ui.IconTag _jspx_th_liferay$1ui_icon_1 = (com.liferay.taglib.ui.IconTag) _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.get(com.liferay.taglib.ui.IconTag.class);
          _jspx_th_liferay$1ui_icon_1.setPageContext(_jspx_page_context);
          _jspx_th_liferay$1ui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_1);
          _jspx_th_liferay$1ui_icon_1.setIcon("angle-up");
          _jspx_th_liferay$1ui_icon_1.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_1.setMessage("up");
          _jspx_th_liferay$1ui_icon_1.setUrl( taglibUpURL );
          int _jspx_eval_liferay$1ui_icon_1 = _jspx_th_liferay$1ui_icon_1.doStartTag();
          if (_jspx_th_liferay$1ui_icon_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.reuse(_jspx_th_liferay$1ui_icon_1);
            return;
          }
          _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.reuse(_jspx_th_liferay$1ui_icon_1);
          out.write('\n');
        ...
        _jspx_th_c_when_2.setTest( assetEntryOrder == 0 );
		...
		String taglibDownURL = "javascript:" + renderResponse.getNamespace() + "moveSelectionDown('" + assetEntryOrder + "')";
          ...
          _jspx_th_liferay$1ui_icon_2.setIcon("angle-down");
          _jspx_th_liferay$1ui_icon_2.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_2.setMessage("down");
          _jspx_th_liferay$1ui_icon_2.setUrl( taglibDownURL );
        ...
        _jspx_th_c_when_3.setTest( last );
		...
		String taglibUpURL = "javascript:" + renderResponse.getNamespace() + "moveSelectionUp('" + assetEntryOrder + "')";
          ...
          out.write("\n\n\t\t");
          //  liferay-ui:icon
          com.liferay.taglib.ui.IconTag _jspx_th_liferay$1ui_icon_3 = (com.liferay.taglib.ui.IconTag) _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.get(com.liferay.taglib.ui.IconTag.class);
          ...
          _jspx_th_liferay$1ui_icon_3.setIcon("angle-up");
          _jspx_th_liferay$1ui_icon_3.setMarkupView("lexicon");
          _jspx_th_liferay$1ui_icon_3.setMessage("up");
          _jspx_th_liferay$1ui_icon_3.setUrl( taglibUpURL );
          ...
          if (_jspx_th_liferay$1ui_icon_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.reuse(_jspx_th_liferay$1ui_icon_3);
            return;
          }
          _jspx_tagPool_liferay$1ui_icon_url_message_markupView_icon_nobody.reuse(_jspx_th_liferay$1ui_icon_3);
          out.write('\n');
