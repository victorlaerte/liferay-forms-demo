...
String tabs2 = ParamUtil.getString(request, "tabs2");
      ...
      if (_jspx_eval_aui_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setLabel("incoming-pop-server");
          _jspx_th_aui_input_0.setName("pop3Host");
          _jspx_th_aui_input_0.setType("text");
          _jspx_th_aui_input_0.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_POP3_HOST) );
          ...
          _jspx_th_aui_input_1.setLabel("incoming-port");
          _jspx_th_aui_input_1.setName("pop3Port");
          _jspx_th_aui_input_1.setType("text");
          _jspx_th_aui_input_1.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_POP3_PORT) );
          ...
          _jspx_th_aui_input_2.setLabel("use-a-secure-network-connection");
          _jspx_th_aui_input_2.setName("pop3Secure");
          _jspx_th_aui_input_2.setType("checkbox");
          _jspx_th_aui_input_2.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_STORE_PROTOCOL).equals("pop3s") );
          ...
          _jspx_th_aui_input_3.setLabel("user-name");
          _jspx_th_aui_input_3.setName("pop3User");
          _jspx_th_aui_input_3.setType("text");
          _jspx_th_aui_input_3.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_POP3_USER) );
		...
		if (Validator.isNotNull(pop3Password)) {
          ...
          out.write("\n\n\t\t");
          //  aui:input
          com.liferay.taglib.aui.InputTag _jspx_th_aui_input_4 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
          ...
          _jspx_th_aui_input_4.setLabel("password");
          _jspx_th_aui_input_4.setName("pop3Password");
          _jspx_th_aui_input_4.setType("password");
          _jspx_th_aui_input_4.setValue( pop3Password );
          int _jspx_eval_aui_input_4 = _jspx_th_aui_input_4.doStartTag();
          if (_jspx_th_aui_input_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.reuse(_jspx_th_aui_input_4);
            return;
          }
          _jspx_tagPool_aui_input_value_type_name_label_cssClass_nobody.reuse(_jspx_th_aui_input_4);
          out.write("\n\n\t\t");
          ...
          _jspx_th_aui_input_5.setLabel("outgoing-smtp-server");
          _jspx_th_aui_input_5.setName("smtpHost");
          _jspx_th_aui_input_5.setType("text");
          _jspx_th_aui_input_5.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_SMTP_HOST) );
          ...
          _jspx_th_aui_input_6.setLabel("outgoing-port");
          _jspx_th_aui_input_6.setName("smtpPort");
          _jspx_th_aui_input_6.setType("text");
          _jspx_th_aui_input_6.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_SMTP_PORT) );
          ...
          _jspx_th_aui_input_7.setLabel("use-a-secure-network-connection");
          _jspx_th_aui_input_7.setName("smtpSecure");
          _jspx_th_aui_input_7.setType("checkbox");
          _jspx_th_aui_input_7.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_TRANSPORT_PROTOCOL).equals("smtps") );
          ...
          _jspx_th_aui_input_8.setLabel("user-name");
          _jspx_th_aui_input_8.setName("smtpUser");
          _jspx_th_aui_input_8.setType("text");
          _jspx_th_aui_input_8.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_SMTP_USER) );
		...
		if (Validator.isNotNull(smtpPassword)) {
          ...
          _jspx_th_aui_input_9.setLabel("password");
          _jspx_th_aui_input_9.setName("smtpPassword");
          _jspx_th_aui_input_9.setType("password");
          _jspx_th_aui_input_9.setValue( smtpPassword );
          ...
          _jspx_th_aui_input_10.setLabel("manually-specify-additional-javamail-properties-to-override-the-above-configuration");
          _jspx_th_aui_input_10.setName("advancedProperties");
          _jspx_th_aui_input_10.setType("textarea");
          _jspx_th_aui_input_10.setValue( PrefsPropsUtil.getString(PropsKeys.MAIL_SESSION_MAIL_ADVANCED_PROPERTIES, StringPool.BLANK) );
  ...
  private boolean _jspx_meth_aui_button_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_button$1row_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_button_0.setDynamicAttribute(null, "data-cmd", new String("updateMail"));
