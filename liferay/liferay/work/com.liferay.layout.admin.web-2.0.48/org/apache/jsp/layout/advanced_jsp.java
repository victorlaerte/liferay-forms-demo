...
public final class advanced_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody;
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage;
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody;
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    ...
    _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody.release();
    _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage.release();
    _jspx_tagPool_aui_script.release();
    _jspx_tagPool_portlet_defineObjects_nobody.release();
    _jspx_tagPool_liferay$1ui_error_message_exception_nobody.release();
    _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody.release();
    _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody.release();
...
UnicodeProperties layoutTypeSettings = selLayout.getTypeSettingsProperties();
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("advanced");
      ...
      _jspx_th_liferay$1ui_error_0.setException( ImageTypeException.class );
      _jspx_th_liferay$1ui_error_0.setMessage("please-enter-a-file-with-a-valid-file-type");
...
Group group = layoutsAdminDisplayContext.getGroup();
      ...
      _jspx_th_c_if_0.setTest( !group.isLayoutPrototype() );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_message_0.setArguments( new String[] {LanguageUtil.get(request, "inherit-changes"), "General"} );
        _jspx_th_liferay$1ui_message_0.setKey("some-page-settings-are-unavailable-because-x-is-enabled");
	...
	String queryString = GetterUtil.getString(layoutTypeSettings.getProperty("query-string"));
        ...
        out.write("\n\n\t");
        //  aui:input
        com.liferay.taglib.aui.InputTag _jspx_th_aui_input_0 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
        _jspx_th_aui_input_0.setPageContext(_jspx_page_context);
        _jspx_th_aui_input_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_0);
        _jspx_th_aui_input_0.setCssClass("propagatable-field");
        _jspx_th_aui_input_0.setDisabled( selLayout.isLayoutPrototypeLinkActive() );
        _jspx_th_aui_input_0.setHelpMessage("query-string-help");
        _jspx_th_aui_input_0.setLabel("query-string");
        _jspx_th_aui_input_0.setName("TypeSettingsProperties--query-string--");
        _jspx_th_aui_input_0.setDynamicAttribute(null, "size", new String("30"));
        _jspx_th_aui_input_0.setType("text");
        _jspx_th_aui_input_0.setValue( queryString );
        int _jspx_eval_aui_input_0 = _jspx_th_aui_input_0.doStartTag();
        if (_jspx_th_aui_input_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody.reuse(_jspx_th_aui_input_0);
          return;
        }
        _jspx_tagPool_aui_input_value_type_size_name_label_helpMessage_disabled_cssClass_nobody.reuse(_jspx_th_aui_input_0);
        out.write('\n');
...
String curTarget = GetterUtil.getString(layoutTypeSettings.getProperty("target"));
      ...
      out.write('\n');
      //  aui:input
      com.liferay.taglib.aui.InputTag _jspx_th_aui_input_1 = (com.liferay.taglib.aui.InputTag) _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody.get(com.liferay.taglib.aui.InputTag.class);
      _jspx_th_aui_input_1.setPageContext(_jspx_page_context);
      _jspx_th_aui_input_1.setParent(null);
      _jspx_th_aui_input_1.setCssClass("propagatable-field");
      _jspx_th_aui_input_1.setDisabled( selLayout.isLayoutPrototypeLinkActive() );
      _jspx_th_aui_input_1.setLabel("target");
      _jspx_th_aui_input_1.setName("TypeSettingsProperties--target--");
      _jspx_th_aui_input_1.setDynamicAttribute(null, "size", new String("15"));
      _jspx_th_aui_input_1.setType("text");
      _jspx_th_aui_input_1.setValue( curTarget );
      int _jspx_eval_aui_input_1 = _jspx_th_aui_input_1.doStartTag();
      if (_jspx_th_aui_input_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody.reuse(_jspx_th_aui_input_1);
        return;
      }
      _jspx_tagPool_aui_input_value_type_size_name_label_disabled_cssClass_nobody.reuse(_jspx_th_aui_input_1);
      out.write('\n');
      out.write('\n');
      //  aui:field-wrapper
      com.liferay.taglib.aui.FieldWrapperTag _jspx_th_aui_field$1wrapper_0 = (com.liferay.taglib.aui.FieldWrapperTag) _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage.get(com.liferay.taglib.aui.FieldWrapperTag.class);
      _jspx_th_aui_field$1wrapper_0.setPageContext(_jspx_page_context);
      _jspx_th_aui_field$1wrapper_0.setParent(null);
      _jspx_th_aui_field$1wrapper_0.setHelpMessage("this-icon-will-be-shown-in-the-navigation-menu");
      _jspx_th_aui_field$1wrapper_0.setLabel("icon");
      _jspx_th_aui_field$1wrapper_0.setName("iconFileName");
      ...
      if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        com.liferay.taglib.ui.LogoSelectorTag _jspx_th_liferay$1ui_logo$1selector_0 = (com.liferay.taglib.ui.LogoSelectorTag) _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody.get(com.liferay.taglib.ui.LogoSelectorTag.class);
        _jspx_th_liferay$1ui_logo$1selector_0.setPageContext(_jspx_page_context);
        _jspx_th_liferay$1ui_logo$1selector_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_0);
        _jspx_th_liferay$1ui_logo$1selector_0.setCurrentLogoURL( (selLayout.getIconImageId() == 0) ? themeDisplay.getPathThemeImages() + "/spacer.png" : themeDisplay.getPathImage() + "/logo?img_id=" + selLayout.getIconImageId() + "&t=" + WebServerServletTokenUtil.getToken(selLayout.getIconImageId()) );
        _jspx_th_liferay$1ui_logo$1selector_0.setDefaultLogo( selLayout.getIconImageId() == 0 );
        _jspx_th_liferay$1ui_logo$1selector_0.setDefaultLogoURL( themeDisplay.getPathThemeImages() + "/spacer.png" );
        _jspx_th_liferay$1ui_logo$1selector_0.setEditLogoFn( liferayPortletResponse.getNamespace() + "editLayoutLogo" );
        _jspx_th_liferay$1ui_logo$1selector_0.setLogoDisplaySelector( ".layout-logo-" + selLayout.getPlid() );
        _jspx_th_liferay$1ui_logo$1selector_0.setTempImageFileName( String.valueOf(selLayout.getPlid()) );
        ...
        if (_jspx_th_liferay$1ui_logo$1selector_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody.reuse(_jspx_th_liferay$1ui_logo$1selector_0);
          return;
        }
        _jspx_tagPool_liferay$1ui_logo$1selector_tempImageFileName_logoDisplaySelector_editLogoFn_defaultLogoURL_defaultLogo_currentLogoURL_nobody.reuse(_jspx_th_liferay$1ui_logo$1selector_0);
        out.write('\n');
      ...
      if (_jspx_th_aui_field$1wrapper_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage.reuse(_jspx_th_aui_field$1wrapper_0);
        return;
      }
      _jspx_tagPool_aui_field$1wrapper_name_label_helpMessage.reuse(_jspx_th_aui_field$1wrapper_0);
      out.write('\n');
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("editLayoutLogo(logoURL, deleteLogo) {\n\t\tvar $ = AUI.$;\n\n\t\tvar layoutLogo = $('.layout-logo-");
          out.print( selLayout.getPlid() );
          ...
          _jspx_th_liferay$1ui_message_1.setKey("logo");
          ...
          _jspx_tagPool_liferay$1ui_message_key_escapeAttribute_nobody.reuse(_jspx_th_liferay$1ui_message_1);
          out.write("\" class=\"layout-logo-");
          out.print( selLayout.getPlid() );
          out.write("\" src=\"' + logoURL + '\" />');\n\n\t\t\t$('#layout_");
          out.print( selLayout.getLayoutId() );
          out.write(" span').prepend(layoutLogo);\n\t\t}\n\n\t\tlayoutLogo.toggleClass('hide', deleteLogo);\n\t}\n");
