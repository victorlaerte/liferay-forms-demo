...
if (LayoutBranchConstants.MASTER_BRANCH_NAME.equals(layoutBranchName)) {
	layoutBranchName = LanguageUtil.get(request, layoutBranchName);
      ...
      out.print( HtmlUtil.escapeHREF(layoutFriendlyURL) + "?layoutSetBranchId=" + layoutRevision.getLayoutSetBranchId() + "&layoutRevisionId=" + layoutRevision.getLayoutRevisionId() );
      out.write('"');
      out.write('>');
      out.print( HtmlUtil.escape(targetLayout.getHTMLTitle(locale)) );
      out.write("</a><br />\n\n<strong>");
      if (_jspx_meth_liferay$1ui_message_1(_jspx_page_context))
        return;
      out.write(":</strong> ");
      out.print( HtmlUtil.escape(layoutSetBranchName) );
      out.write("<br />\n\n<strong>");
      if (_jspx_meth_liferay$1ui_message_2(_jspx_page_context))
        return;
      out.write(":</strong> ");
      out.print( HtmlUtil.escape(layoutBranchName) );
      out.write("<br />\n\n<strong>");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("site-pages-variation");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("page-variation");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("revision-id");
