...
public final class merge_005falert_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int mergeFailCount = SitesUtil.getMergeFailCount(layoutPrototype);
      ...
      _jspx_th_c_if_0.setTest( mergeFailCount > PropsValues.LAYOUT_PROTOTYPE_MERGE_FAIL_THRESHOLD );
	...
	String randomNamespace = PortalUtil.generateRandomKey(request, "portlet_layout_prototypes_merge_alert") + StringPool.UNDERLINE;
        ...
        _jspx_th_liferay$1ui_message_0.setArguments( new Object[] {mergeFailCount, LanguageUtil.get(request, "page-template")} );
        ...
        _jspx_th_aui_button_0.setValue("reset");
        ...
        if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_portlet_actionURL_0.setName("/layout_prototype/reset_merge_fail_count_and_merge");
            _jspx_th_portlet_actionURL_0.setVar("resetMergeFailCountURL");
            ...
            _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
            java.lang.String resetMergeFailCountURL = null;
            resetMergeFailCountURL = (java.lang.String) _jspx_page_context.findAttribute("resetMergeFailCountURL");
            out.write("\n\n\t\t\t\tsubmitForm(document.hrefFm, '");
            out.print( resetMergeFailCountURL.toString() );
            out.write("');\n\t\t\t}\n\t\t);\n\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setArguments(new String("page-template"));
    _jspx_th_liferay$1ui_message_1.setKey("click-reset-to-reset-the-failure-count-and-reenable-propagation");
