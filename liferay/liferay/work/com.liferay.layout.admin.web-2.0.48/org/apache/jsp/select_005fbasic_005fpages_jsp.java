...
public final class select_005fbasic_005fpages_jsp extends org.apache.jasper.runtime.HttpJspBase
...
SelectLayoutPageTemplateEntryDisplayContext selectLayoutPageTemplateEntryDisplayContext = new SelectLayoutPageTemplateEntryDisplayContext(request);
      ...
      _jspx_th_c_if_0.setTest( selectLayoutPageTemplateEntryDisplayContext.getPrimaryTypesCount() > 0 );
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.print( PortalUtil.getPathContext(request) );
        out.write("/images/");
        out.print( primaryType );
        out.write(".svg\" />\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"card-body\">\n\t\t\t\t\t\t\t<div class=\"card-row\">\n\t\t\t\t\t\t\t\t<div class=\"autofit-col autofit-col-expand\">\n\t\t\t\t\t\t\t\t\t<section class=\"autofit-section\">\n\t\t\t\t\t\t\t\t\t\t<h3 class=\"card-title\">\n\t\t\t\t\t\t\t\t\t\t\t<span class=\"text-truncate-inline\">\n\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"add-layout-action-option\" data-type=\"");
        out.print( primaryType );
        out.write("\" href=\"javascript:;\">");
        out.print( LanguageUtil.get(request, layoutTypeResourceBundle, "layout.types." + primaryType) );
        out.write("</a>\n\t\t\t\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t\t\t\t</h3>\n\n\t\t\t\t\t\t\t\t\t\t<p class=\"card-subtitle\">\n\t\t\t\t\t\t\t\t\t\t\t<span class=\"text-truncate-inline\">\n\t\t\t\t\t\t\t\t\t\t\t\t");
        out.print( LanguageUtil.get(request, layoutTypeResourceBundle, "layout.types." + primaryType + ".description") );
        out.write("\n\t\t\t\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t\t\t\t</p>\n\t\t\t\t\t\t\t\t\t</section>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t");
      ...
      _jspx_th_c_if_1.setTest( selectLayoutPageTemplateEntryDisplayContext.getTypesCount() > 0 );
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("/lexicon/icons.svg#page\" />\n\t\t\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t<div class=\"autofit-col autofit-col-expand autofit-col-gutters\">\n\t\t\t\t\t\t\t\t\t<section class=\"autofit-section\">\n\t\t\t\t\t\t\t\t\t\t<h3 class=\"card-title\">\n\t\t\t\t\t\t\t\t\t\t\t<span class=\"text-truncate-inline\">\n\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"add-layout-action-option text-truncate\" data-type=\"");
        out.print( type );
        out.write("\" href=\"javascript:;\" title=\"");
        out.print( LanguageUtil.get(request, layoutTypeResourceBundle, "layout.types." + type) );
        out.write('"');
        out.write('>');
        out.print( LanguageUtil.get(request, layoutTypeResourceBundle, "layout.types." + type) );
        out.write("</a>\n\t\t\t\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t\t\t\t</h3>\n\t\t\t\t\t\t\t\t\t</section>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t");
      ...
      _jspx_th_portlet_actionURL_0.setName("/layout/add_simple_layout");
      _jspx_th_portlet_actionURL_0.setVar("addLayoutURL");
      ...
      if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_portlet_param_1.setValue( layoutsAdminDisplayContext.getPortletResource() );
        ...
        _jspx_th_portlet_param_2.setValue( String.valueOf(layoutsAdminDisplayContext.getGroupId()) );
        ...
        _jspx_th_portlet_param_3.setName("liveGroupId");
        _jspx_th_portlet_param_3.setValue( String.valueOf(layoutsAdminDisplayContext.getLiveGroupId()) );
        ...
        _jspx_th_portlet_param_4.setName("stagingGroupId");
        _jspx_th_portlet_param_4.setValue( String.valueOf(layoutsAdminDisplayContext.getStagingGroupId()) );
        ...
        _jspx_th_portlet_param_5.setName("parentLayoutId");
        _jspx_th_portlet_param_5.setValue( String.valueOf(layoutsAdminDisplayContext.getParentLayoutId()) );
        ...
        _jspx_th_portlet_param_6.setValue( String.valueOf(layoutsAdminDisplayContext.isPrivateLayout()) );
        ...
        _jspx_th_portlet_param_7.setName("explicitCreation");
      ...
      _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String addLayoutURL = null;
      addLayoutURL = (java.lang.String) _jspx_page_context.findAttribute("addLayoutURL");
      out.write('\n');
      out.write('\n');
...
String autoSiteNavigationMenuNames = layoutsAdminDisplayContext.getAutoSiteNavigationMenuNames();
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_c_if_2.setTest( Validator.isNotNull(autoSiteNavigationMenuNames) );
          ...
          if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_liferay$1ui_message_2.setArguments( autoSiteNavigationMenuNames );
            _jspx_th_liferay$1ui_message_2.setKey("add-this-page-to-the-following-menus-x");
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("main-types");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("other");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("add-page");
