...
String robots = ParamUtil.getString(request, "robots", defaultRobots);
      ...
      _jspx_th_liferay$1ui_error$1marker_0.setValue("robots");
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( Validator.isNotNull(virtualHostName) );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setLabel("set-the-robots-txt");
          _jspx_th_aui_input_0.setName( "TypeSettingsProperties--" + layoutSet.isPrivateLayout() + "-robots.txt--" );
          _jspx_th_aui_input_0.setPlaceholder("robots");
          _jspx_th_aui_input_0.setType("textarea");
          _jspx_th_aui_input_0.setValue( robots );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("please-set-the-virtual-host-before-you-set-the-robots-txt");
