...
boolean mergeGuestPublicPages = PropertiesParamUtil.getBoolean(layoutsAdminDisplayContext.getGroupTypeSettings(), request, "mergeGuestPublicPages");
      ...
      if (_jspx_eval_c_choose_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_c_when_0.setTest( !layoutsAdminDisplayContext.isPrivateLayout() && (layoutsAdminDisplayContext.getLiveGroupId() != guestGroup.getGroupId()) );
        ...
        if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setHelpMessage( LanguageUtil.format(request, "you-can-configure-the-top-level-pages-of-this-public-site-to-merge-with-the-top-level-pages-of-the-public-x-site", HtmlUtil.escape(guestGroup.getDescriptiveName(locale)), false) );
          _jspx_th_aui_input_0.setLabel( LanguageUtil.format(request, "merge-x-public-pages", HtmlUtil.escape(guestGroup.getDescriptiveName(locale)), false) );
          _jspx_th_aui_input_0.setName("mergeGuestPublicPages");
          _jspx_th_aui_input_0.setType("checkbox");
          _jspx_th_aui_input_0.setValue( mergeGuestPublicPages );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("there-are-no-available-advanced-settings-for-these-pages");
